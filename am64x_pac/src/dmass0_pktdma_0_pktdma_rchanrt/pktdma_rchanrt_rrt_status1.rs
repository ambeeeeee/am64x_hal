#[doc = "Register `PKTDMA_RCHANRT_RRT_STATUS1` reader"]
pub type R = crate::R<PktdmaRchanrtRrtStatus1Spec>;
#[doc = "Register `PKTDMA_RCHANRT_RRT_STATUS1` writer"]
pub type W = crate::W<PktdmaRchanrtRrtStatus1Spec>;
...
The channel is in a packet"]
    #[inline(always)]
    #[must_use]
    pub fn in_packet_array(&mut self) -> InPacketArrayW<PktdmaRchanrtRrtStatus1Spec> {
...
The channel has active work"]
    #[inline(always)]
    #[must_use]
    pub fn channel_busy(&mut self) -> ChannelBusyW<PktdmaRchanrtRrtStatus1Spec> {
...
The channel is trying to schedule work"]
    #[inline(always)]
    #[must_use]
    pub fn channel_ok(&mut self) -> ChannelOkW<PktdmaRchanrtRrtStatus1Spec> {
...
The fifo has data"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_busy(&mut self) -> FifoBusyW<PktdmaRchanrtRrtStatus1Spec> {
...
The FIFO has enough data for a burst"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_pend(&mut self) -> FifoPendW<PktdmaRchanrtRrtStatus1Spec> {
...
The channel is sending a schedule request"]
    #[inline(always)]
    #[must_use]
    pub fn rx_reqs(&mut self) -> RxReqsW<PktdmaRchanrtRrtStatus1Spec> {
        RxReqsW::new(self, 31)
    }
}
#[doc = "The Status Register provides a read only view of channel status bits.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pktdma_rchanrt_rrt_status1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pktdma_rchanrt_rrt_status1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PktdmaRchanrtRrtStatus1Spec;
impl crate::RegisterSpec for PktdmaRchanrtRrtStatus1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pktdma_rchanrt_rrt_status1::R`](R) reader structure"]
impl crate::Readable for PktdmaRchanrtRrtStatus1Spec {}
#[doc = "`write(|w| ..)` method takes [`pktdma_rchanrt_rrt_status1::W`](W) writer structure"]
impl crate::Writable for PktdmaRchanrtRrtStatus1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PKTDMA_RCHANRT_RRT_STATUS1 to value 0"]
impl crate::Resettable for PktdmaRchanrtRrtStatus1Spec {
