#[doc = "Register `APBADDR_ETM_CPU0_TRCVISSCTLR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcvissctlrSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCVISSCTLR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcvissctlrSpec>;
...
is: 0 The single address comparator n is not selected as a start resource. 1 The single address comparator n is selected as a start resource. The implemented width of the field, n, is IMPLEMENTATION DEFINED and is set by the value of 2 x TRCIDR4.NUMACPAIRS. Unimplemented bits are RAZ/WI."]
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> StartW<ApbaddrEtmCpu0TrcvissctlrSpec> {
        StartW::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Selects which single address comparators are in use with ViewInst start-stop control, for the purpose of stopping trace. Each bit represents a single address comparator, so bit\\[m\\]
...
is: 0 The single address comparator m-16 is not selected as a stop resource. 1 The single address comparator m-16 is selected as a stop resource. The implemented width of the field, n, is IMPLEMENTATION DEFINED and is set by the value of 2 x TRCIDR4.NUMACPAIRS. Unimplemented bits are RAZ/WI."]
    #[inline(always)]
    #[must_use]
    pub fn stop(&mut self) -> StopW<ApbaddrEtmCpu0TrcvissctlrSpec> {
        StopW::new(self, 16)
    }
}
#[doc = "ViewInst Start-Stop Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcvissctlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcvissctlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcvissctlrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcvissctlrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcvissctlr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcvissctlrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcvissctlr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcvissctlrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCVISSCTLR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0TrcvissctlrSpec {
