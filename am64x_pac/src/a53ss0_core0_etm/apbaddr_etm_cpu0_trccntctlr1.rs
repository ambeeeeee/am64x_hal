#[doc = "Register `APBADDR_ETM_CPU0_TRCCNTCTLR1` reader"]
pub type R = crate::R<ApbaddrEtmCpu0Trccntctlr1Spec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCCNTCTLR1` writer"]
pub type W = crate::W<ApbaddrEtmCpu0Trccntctlr1Spec>;
...
Selects an event, that when it occurs causes counter &lt;n> to decrement."]
    #[inline(always)]
    #[must_use]
    pub fn cntevent_n(&mut self) -> CnteventNW<ApbaddrEtmCpu0Trccntctlr1Spec> {
...
Selects an event, that when it occurs causes a reload event for counter &lt;n>."]
    #[inline(always)]
    #[must_use]
    pub fn rldevent_n(&mut self) -> RldeventNW<ApbaddrEtmCpu0Trccntctlr1Spec> {
...
Controls whether a reload event occurs for counter &lt;n>, when counter &lt;n> reaches zero: 0 The trace unit does not generate a reload event. 1 The trace unit generates a reload event for counter &lt;n>, provided that the event resource that CNTEVENT&lt;n> specifies is active."]
    #[inline(always)]
    #[must_use]
    pub fn rldself_n(&mut self) -> RldselfNW<ApbaddrEtmCpu0Trccntctlr1Spec> {
...
For TRCCNTCTLR3 and TRCCNTCTLR1, controls whether counter &lt;n> decrements when a reload event occurs for counter &lt;n-1>: 0 1 For TRCCNTCTLR2 and TRCCNTCTLR0, this bit is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn cntchain_n(&mut self) -> CntchainNW<ApbaddrEtmCpu0Trccntctlr1Spec> {
...
Reserved, RES0."]
    ...
    pub fn res0_trccntctlr1_31_18(
        &mut self,
    ) -> Res0Trccntctlr1_31_18W<ApbaddrEtmCpu0Trccntctlr1Spec> {
...
pub struct ApbaddrEtmCpu0Trccntctlr1Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu0Trccntctlr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trccntctlr1::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0Trccntctlr1Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trccntctlr1::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0Trccntctlr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCCNTCTLR1 to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0Trccntctlr1Spec {
