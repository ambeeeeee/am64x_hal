#[doc = "Register `APBADDR_ETM_CPU0_TRCIDR1` reader"]
pub type R = crate::R<ApbaddrEtmCpu0Trcidr1Spec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCIDR1` writer"]
pub type W = crate::W<ApbaddrEtmCpu0Trcidr1Spec>;
...
Returns an IMPLEMENTATION DEFINED value that identifies the revision of the trace registers and the OS Save and Restore registers.ARM recommends:That the initial implementation sets REVISION==0x0 and the field then increments for any subsequent implementations. However, it is acceptable to omit some values or use another scheme to identify the revision number.That TRCPIDR2.REVISION==TRCIDR1.REVISION. However, in situations where it is difficult to align these fields, such as with a metal layer fix, then it is acceptable to change the REVISION fields independently."]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrEtmCpu0Trcidr1Spec> {
...
Indicates the minor version of the ETM architecture. The permitted value is: 0 ETMv4 minor version 0. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn trcarchmin(&mut self) -> TrcarchminW<ApbaddrEtmCpu0Trcidr1Spec> {
...
Indicates the major version of the ETM architecture. The permitted value is: 100 ETMv4. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn trcarchmaj(&mut self) -> TrcarchmajW<ApbaddrEtmCpu0Trcidr1Spec> {
...
Reserved, RES1."]
    #[inline(always)]
    #[must_use]
    pub fn res1_trcidr1_15_12(&mut self) -> Res1Trcidr1_15_12W<ApbaddrEtmCpu0Trcidr1Spec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcidr1_23_16(&mut self) -> Res0Trcidr1_23_16W<ApbaddrEtmCpu0Trcidr1Spec> {
...
Indicates which company designed the trace unit. The permitted values are: 01000001 ARM Limited. 01000100 Digital Equipment Corporation. 01001101 Motorola, Freescale Semiconductor Inc. 01010001 QUALCOMM Inc. 01010110 Marvell Semiconductor Inc. 01101001 Intel Corporation. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn designer(&mut self) -> DesignerW<ApbaddrEtmCpu0Trcidr1Spec> {
        DesignerW::new(self, 24)
    }
}
#[doc = "ID Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcidr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcidr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0Trcidr1Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu0Trcidr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcidr1::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0Trcidr1Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcidr1::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0Trcidr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCIDR1 to value 0x6501_5404"]
impl crate::Resettable for ApbaddrEtmCpu0Trcidr1Spec {
