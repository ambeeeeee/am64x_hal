#[doc = "Register `APBADDR_ETM_CPU0_TRCIMSPEC0` reader"]
pub type R = crate::R<ApbaddrEtmCpu0Trcimspec0Spec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCIMSPEC0` writer"]
pub type W = crate::W<ApbaddrEtmCpu0Trcimspec0Spec>;
...
Indicates whether the implementation supports IMPLEMENTATION DEFINED features. The permitted values are: 0000 No IMPLEMENTATION DEFINED features are supported. The EN field is RES0. and any other value, which indicates that IMPLEMENTATION DEFINED features are supported. Use of these values requires written permission from ARM."]
    #[inline(always)]
    #[must_use]
    pub fn support(&mut self) -> SupportW<ApbaddrEtmCpu0Trcimspec0Spec> {
        SupportW::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
If SUPPORT is not 0b0000, controls whether the IMPLEMENTATION DEFINED features are enabled. The permitted values are: 0000 The IMPLEMENTATION DEFINED features are not enabled. The trace unit must behave as if the IMPLEMENTATION DEFINED features are not supported. and any other value, which indicates that the trace unit behavior is IMPLEMENTATION DEFINED.If SUPPORT is 0b0000, this field is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<ApbaddrEtmCpu0Trcimspec0Spec> {
        EnW::new(self, 4)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcimspec0_31_8(&mut self) -> Res0Trcimspec0_31_8W<ApbaddrEtmCpu0Trcimspec0Spec> {
        Res0Trcimspec0_31_8W::new(self, 8)
    }
}
#[doc = "Implementation Specific Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcimspec0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcimspec0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0Trcimspec0Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu0Trcimspec0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcimspec0::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0Trcimspec0Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcimspec0::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0Trcimspec0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCIMSPEC0 to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0Trcimspec0Spec {
