#[doc = "Register `APBADDR_ETM_CPU0_TRCOSLSR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcoslsrSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCOSLSR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcoslsrSpec>;
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcoslsr_0_0(&mut self) -> Res0Trcoslsr0_0W<ApbaddrEtmCpu0TrcoslsrSpec> {
...
OS Lock status bit: 0 The OS Lock is unlocked. 1 The OS Lock is locked. When the trace unit core power domain is powered down the value is UNKNOWN. The TRCPDSR indicates if the trace unit core power domain is powered down."]
    #[inline(always)]
    #[must_use]
    pub fn locked(&mut self) -> LockedW<ApbaddrEtmCpu0TrcoslsrSpec> {
        LockedW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
This bit is RES0, which indicates that software must perform a 32-bit write to update the TRCOSLAR."]
    #[inline(always)]
    #[must_use]
    pub fn bit32(&mut self) -> Bit32W<ApbaddrEtmCpu0TrcoslsrSpec> {
        Bit32W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Indicates whether the OS Lock is implemented.This bit is RES1, which indicates that the OS Lock is always implemented."]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PresentW<ApbaddrEtmCpu0TrcoslsrSpec> {
        PresentW::new(self, 3)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcoslsr_31_4(&mut self) -> Res0Trcoslsr31_4W<ApbaddrEtmCpu0TrcoslsrSpec> {
        Res0Trcoslsr31_4W::new(self, 4)
    }
}
#[doc = "OS Lock Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcoslsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcoslsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcoslsrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcoslsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcoslsr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcoslsrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcoslsr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcoslsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCOSLSR to value 0x0a"]
impl crate::Resettable for ApbaddrEtmCpu0TrcoslsrSpec {
