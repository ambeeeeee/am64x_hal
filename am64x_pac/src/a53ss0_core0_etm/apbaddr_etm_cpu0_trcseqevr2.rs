#[doc = "Register `APBADDR_ETM_CPU0_TRCSEQEVR2` reader"]
pub type R = crate::R<ApbaddrEtmCpu0Trcseqevr2Spec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCSEQEVR2` writer"]
pub type W = crate::W<ApbaddrEtmCpu0Trcseqevr2Spec>;
...
Forward field. Contains an event number. When the event occurs then the sequencer state moves from state n to state n+1.For example, for TRCSEQEVR1, if F1==0x12 then when event 0x12 occurs, the sequencer moves from state 1 to state 2."]
    #[inline(always)]
    #[must_use]
    pub fn f_n(&mut self) -> FNW<ApbaddrEtmCpu0Trcseqevr2Spec> {
        FNW::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Backward field. Contains an event number. When the event occurs then the sequencer state moves from state n+1 to state n.For example, for TRCSEQEVR2, if B2==0x14 then when event 0x14 occurs, the sequencer moves from state 3 to state 2."]
    #[inline(always)]
    #[must_use]
    pub fn b_n(&mut self) -> BNW<ApbaddrEtmCpu0Trcseqevr2Spec> {
        BNW::new(self, 8)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcseqevr2_31_16(&mut self) -> Res0Trcseqevr2_31_16W<ApbaddrEtmCpu0Trcseqevr2Spec> {
        Res0Trcseqevr2_31_16W::new(self, 16)
    }
}
#[doc = "Sequencer State Transition Control Registers 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcseqevr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcseqevr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0Trcseqevr2Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu0Trcseqevr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcseqevr2::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0Trcseqevr2Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcseqevr2::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0Trcseqevr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCSEQEVR2 to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0Trcseqevr2Spec {
