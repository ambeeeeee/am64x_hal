#[doc = "Register `APBADDR_ETM_CPU0_TRCPDCR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcpdcrSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCPDCR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcpdcrSpec>;
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcpdcr_2_0(&mut self) -> Res0Trcpdcr2_0W<ApbaddrEtmCpu0TrcpdcrSpec> {
...
Powerup request bit: 0 The system can remove power from the trace unit. The TRCPDSR indicates if the trace unit is powered down. 1 The system must provide power to the trace unit. Typically, a trace unit drives a signal representing the value of this bit to a power controller to request that the trace unit core power domain is powered up. However, if the trace unit and the processor are in the same power domain then the implementation might combine the PU status with a signal from the processor."]
    #[inline(always)]
    #[must_use]
    pub fn pu(&mut self) -> PuW<ApbaddrEtmCpu0TrcpdcrSpec> {
        PuW::new(self, 3)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcpdcr_31_4(&mut self) -> Res0Trcpdcr31_4W<ApbaddrEtmCpu0TrcpdcrSpec> {
        Res0Trcpdcr31_4W::new(self, 4)
    }
}
#[doc = "Power Down Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcpdcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcpdcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcpdcrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcpdcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcpdcr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcpdcrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcpdcr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcpdcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCPDCR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0TrcpdcrSpec {
