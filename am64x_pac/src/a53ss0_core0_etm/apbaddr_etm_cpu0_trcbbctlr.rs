#[doc = "Register `APBADDR_ETM_CPU0_TRCBBCTLR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcbbctlrSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCBBCTLR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcbbctlrSpec>;
...
is: 0 The address range that address range comparator pair n defines is not selected. 1 The address range that address range comparator pair n defines is selected."]
    #[inline(always)]
    #[must_use]
    pub fn range(&mut self) -> RangeW<ApbaddrEtmCpu0TrcbbctlrSpec> {
        RangeW::new(self, 0)
    }
    #[doc = "Bit 8 - 8:8\\]
Mode bit: 0 Exclude mode. Branch broadcasting is not enabled in the address range that RANGE defines. If RANGE==0 then branch broadcasting is enabled for the entire memory map. 1 Include mode. Branch broadcasting is enabled in the address range that RANGE defines. If RANGE==0 then the branch broadcasting behavior is UNPREDICTABLE."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<ApbaddrEtmCpu0TrcbbctlrSpec> {
        ModeW::new(self, 8)
    }
    #[doc = "Bits 9:31 - 31:9\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcbbctlr_31_9(&mut self) -> Res0Trcbbctlr31_9W<ApbaddrEtmCpu0TrcbbctlrSpec> {
...
pub struct ApbaddrEtmCpu0TrcbbctlrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcbbctlrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcbbctlr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcbbctlrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcbbctlr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcbbctlrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCBBCTLR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0TrcbbctlrSpec {
