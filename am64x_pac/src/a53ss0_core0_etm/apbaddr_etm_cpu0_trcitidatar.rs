#[doc = "Register `APBADDR_ETM_CPU0_TRCITIDATAR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcitidatarSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCITIDATAR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcitidatarSpec>;
...
output"]
    #[inline(always)]
    #[must_use]
    pub fn atdatam_0(&mut self) -> Atdatam0W<ApbaddrEtmCpu0TrcitidatarSpec> {
...
output"]
    #[inline(always)]
    #[must_use]
    pub fn atdatam_7(&mut self) -> Atdatam7W<ApbaddrEtmCpu0TrcitidatarSpec> {
...
output"]
    #[inline(always)]
    #[must_use]
    pub fn atdatam_15(&mut self) -> Atdatam15W<ApbaddrEtmCpu0TrcitidatarSpec> {
...
output"]
    #[inline(always)]
    #[must_use]
    pub fn atdatam_23(&mut self) -> Atdatam23W<ApbaddrEtmCpu0TrcitidatarSpec> {
...
output"]
    #[inline(always)]
    #[must_use]
    pub fn atdatam_31(&mut self) -> Atdatam31W<ApbaddrEtmCpu0TrcitidatarSpec> {
...
Reserved RES0"]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcitidatar_31_5(&mut self) -> Res0Trcitidatar31_5W<ApbaddrEtmCpu0TrcitidatarSpec> {
        Res0Trcitidatar31_5W::new(self, 5)
    }
}
#[doc = "Integration Instruction ATB Data Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcitidatar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcitidatar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcitidatarSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcitidatarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcitidatar::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcitidatarSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcitidatar::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcitidatarSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCITIDATAR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0TrcitidatarSpec {
