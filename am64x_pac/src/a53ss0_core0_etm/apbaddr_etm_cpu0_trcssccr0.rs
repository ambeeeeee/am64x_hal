#[doc = "Register `APBADDR_ETM_CPU0_TRCSSCCR0` reader"]
pub type R = crate::R<ApbaddrEtmCpu0Trcssccr0Spec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCSSCCR0` writer"]
pub type W = crate::W<ApbaddrEtmCpu0Trcssccr0Spec>;
...
is: 0 The single address comparator n, is not selected for single-shot control. 1 The single address comparator n, is selected for single-shot control. The width of this field is IMPLEMENTATION DEFINED. The field contains a number of implemented bits equal to 2 x TRCIDR4.NUMACPAIRS. Unimplemented bits are RAZ/WI."]
    #[inline(always)]
    #[must_use]
    pub fn sac(&mut self) -> SacW<ApbaddrEtmCpu0Trcssccr0Spec> {
        SacW::new(self, 0)
    }
    #[doc = "Bits 16:23 - 23:16\\]
Selects one or more address range comparators for single-shot control.Each bit represents an address range comparator pair, so bit\\[n-16\\]
...
is: 0 The address range comparator pair n-16 is not selected for single-shot control. 1 The address range comparator pair n-16 is selected for single-shot control. The width of this field is IMPLEMENTATION DEFINED. The field contains a number of implemented bits equal to TRCIDR4.NUMACPAIRS. Unimplemented bits are RAZ/WI."]
    #[inline(always)]
    #[must_use]
    pub fn arc(&mut self) -> ArcW<ApbaddrEtmCpu0Trcssccr0Spec> {
        ArcW::new(self, 16)
    }
    #[doc = "Bit 24 - 24:24\\]
Controls whether the single-shot comparator resource is reset when it fires. 0 When the single-shot comparator resource fires, it is not reset. 1 When the single-shot comparator resource fires, it is reset. This enables the single-shot comparator resource to fire multiple times."]
    #[inline(always)]
    #[must_use]
    pub fn rst(&mut self) -> RstW<ApbaddrEtmCpu0Trcssccr0Spec> {
        RstW::new(self, 24)
    }
    #[doc = "Bits 25:31 - 31:25\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcssccr0_31_25(&mut self) -> Res0Trcssccr0_31_25W<ApbaddrEtmCpu0Trcssccr0Spec> {
        Res0Trcssccr0_31_25W::new(self, 25)
    }
}
#[doc = "Single-Shot Comparator Control Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcssccr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcssccr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0Trcssccr0Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu0Trcssccr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcssccr0::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0Trcssccr0Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcssccr0::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0Trcssccr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCSSCCR0 to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0Trcssccr0Spec {
