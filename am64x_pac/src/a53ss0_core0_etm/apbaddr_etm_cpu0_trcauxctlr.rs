#[doc = "Register `APBADDR_ETM_CPU0_TRCAUXCTLR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcauxctlrSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCAUXCTLR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcauxctlrSpec>;
...
Always respond to AFREADY immediately. Does not have any interaction with FIFO draining even in WFI state."]
    #[inline(always)]
    #[must_use]
    pub fn afready(&mut self) -> AfreadyW<ApbaddrEtmCpu0TrcauxctlrSpec> {
        AfreadyW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Force idle-drain acknowledge high CPU does not wait for trace to drain before entering WFX state. When this bit is set to 1 trace unit behavior deviates from architecturally-specified behavior."]
    #[inline(always)]
    #[must_use]
    pub fn idleack(&mut self) -> IdleackW<ApbaddrEtmCpu0TrcauxctlrSpec> {
        IdleackW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Force an overflow if synchronization is not completed when second synchronization becomes due. When this bit is set to 1 the trace unit behavior deviates from architecturally-specified behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ovflw(&mut self) -> OvflwW<ApbaddrEtmCpu0TrcauxctlrSpec> {
        OvflwW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Delay periodic synchronization if FIFO is more than half-full."]
    #[inline(always)]
    #[must_use]
    pub fn syncdelay(&mut self) -> SyncdelayW<ApbaddrEtmCpu0TrcauxctlrSpec> {
...
Do not delay timestamp insertion based on FIFO depth."]
    #[inline(always)]
    #[must_use]
    pub fn tsnodelay(&mut self) -> TsnodelayW<ApbaddrEtmCpu0TrcauxctlrSpec> {
...
Do not flush trace on de-assertion of authentication inputs. When this bit is set to 1 the trace unit behavior deviates from architecturally-specified behavior."]
    #[inline(always)]
    #[must_use]
    pub fn authnoflush(&mut self) -> AuthnoflushW<ApbaddrEtmCpu0TrcauxctlrSpec> {
...
Reserved RES0"]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcauxctlr_6_6(&mut self) -> Res0Trcauxctlr6_6W<ApbaddrEtmCpu0TrcauxctlrSpec> {
...
Keep core interface enabled regardless of trace enable register state"]
    #[inline(always)]
    #[must_use]
    pub fn coreifen(&mut self) -> CoreifenW<ApbaddrEtmCpu0TrcauxctlrSpec> {
...
Reserved RES0"]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcauxctlr_31_8(&mut self) -> Res0Trcauxctlr31_8W<ApbaddrEtmCpu0TrcauxctlrSpec> {
        Res0Trcauxctlr31_8W::new(self, 8)
    }
}
#[doc = "Auxiliary Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcauxctlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcauxctlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcauxctlrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcauxctlrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcauxctlr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcauxctlrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcauxctlr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcauxctlrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCAUXCTLR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0TrcauxctlrSpec {
