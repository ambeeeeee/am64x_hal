#[doc = "Register `APBADDR_ETM_CPU0_TRCIDR3` reader"]
pub type R = crate::R<ApbaddrEtmCpu0Trcidr3Spec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCIDR3` writer"]
pub type W = crate::W<ApbaddrEtmCpu0Trcidr3Spec>;
...
Indicates the minimum value that can be programmed in TRCCCCTLR.THRESHOLD.When cycle counting in the instruction trace is supported, that is TRCIDR0.TRCCCI==1, then the minimum value of this field is 0x001, otherwise it is 0x000."]
    #[inline(always)]
    #[must_use]
    pub fn ccitmin(&mut self) -> CcitminW<ApbaddrEtmCpu0Trcidr3Spec> {
        CcitminW::new(self, 0)
    }
    #[doc = "Bits 12:15 - 15:12\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcidr3_15_12(&mut self) -> Res0Trcidr3_15_12W<ApbaddrEtmCpu0Trcidr3Spec> {
...
is never implemented.Bit\\[19\\]Exception level 3."]
    #[inline(always)]
    #[must_use]
    pub fn exlevel_s(&mut self) -> ExlevelSW<ApbaddrEtmCpu0Trcidr3Spec> {
...
is never implemented."]
    #[inline(always)]
    #[must_use]
    pub fn exlevel_ns(&mut self) -> ExlevelNsW<ApbaddrEtmCpu0Trcidr3Spec> {
...
Indicates if TRCVICTLR.TRCERR is supported: 0 TRCVICTLR.TRCERR is not supported 1 TRCVICTLR.TRCERR is supported."]
    #[inline(always)]
    #[must_use]
    pub fn trcerr(&mut self) -> TrcerrW<ApbaddrEtmCpu0Trcidr3Spec> {
        TrcerrW::new(self, 24)
    }
    #[doc = "Bit 25 - 25:25\\]
Indicates if an implementation has a fixed synchronization period: 0 TRCSYNCPR is read-write so software can change the synchronization period. 1 TRCSYNCPR is read-only so the synchronization period is fixed."]
    #[inline(always)]
    #[must_use]
    pub fn syncpr(&mut self) -> SyncprW<ApbaddrEtmCpu0Trcidr3Spec> {
        SyncprW::new(self, 25)
    }
    #[doc = "Bit 26 - 26:26\\]
Indicates if TRCSTALLCTLR is supported: 0 TRCSTALLCTLR is not supported. 1 TRCSTALLCTLR is supported."]
    #[inline(always)]
    #[must_use]
    pub fn stallctl(&mut self) -> StallctlW<ApbaddrEtmCpu0Trcidr3Spec> {
...
Indicates if the implementation can support stall control: 0 The system does not support stall control of the processor. 1 The system can support stall control of the processor. The system supports stalling of the processor only when SYSSTALL==1 and STALLCTL==1."]
    #[inline(always)]
    #[must_use]
    pub fn sysstall(&mut self) -> SysstallW<ApbaddrEtmCpu0Trcidr3Spec> {
...
Indicates the number of processors available for tracing. The possible values are: 000 The trace unit can trace one processor. 001 The trace unit can trace two processors. 010 The trace unit can trace three processors. and so on up to 0b111, which indicates the trace unit can trace eight processors.This field sets the maximum value of TRCPROCSELR.PROCSEL."]
    #[inline(always)]
    #[must_use]
    pub fn numproc(&mut self) -> NumprocW<ApbaddrEtmCpu0Trcidr3Spec> {
...
Indicates if TRCSTALLCTLR.NOOVERFLOW is supported: 0 TRCSTALLCTLR.NOOVERFLOW is not supported, or STALLCTL==0. 1 TRCSTALLCTLR.NOOVERFLOW is supported."]
    #[inline(always)]
    #[must_use]
    pub fn nooverflow(&mut self) -> NooverflowW<ApbaddrEtmCpu0Trcidr3Spec> {
        NooverflowW::new(self, 31)
    }
}
#[doc = "ID Register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcidr3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcidr3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0Trcidr3Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu0Trcidr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcidr3::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0Trcidr3Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcidr3::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0Trcidr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCIDR3 to value 0x0d71_0004"]
impl crate::Resettable for ApbaddrEtmCpu0Trcidr3Spec {
