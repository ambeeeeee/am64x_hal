#[doc = "Register `APBADDR_ETM_CPU0_TRCDEVARCH` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcdevarchSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCDEVARCH` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcdevarchSpec>;
...
are the architecture part number, 0xA13.This corresponds to trace architecture version ETMv4."]
    #[inline(always)]
    #[must_use]
    pub fn archid(&mut self) -> ArchidW<ApbaddrEtmCpu0TrcdevarchSpec> {
        ArchidW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Defines the architecture revision. For architectures defined by ARM this is the minor revision.For trace, the revision defined by ETMv4 is 0x0.All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrEtmCpu0TrcdevarchSpec> {
...
When set to 1, indicates that the DEVARCH is present.This field is RAO."]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PresentW<ApbaddrEtmCpu0TrcdevarchSpec> {
...
are the JEP 106 ID code, 0x3B."]
    #[inline(always)]
    #[must_use]
    pub fn architect(&mut self) -> ArchitectW<ApbaddrEtmCpu0TrcdevarchSpec> {
        ArchitectW::new(self, 21)
    }
}
#[doc = "Device Architecture Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcdevarch::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcdevarch::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcdevarchSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcdevarchSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcdevarch::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcdevarchSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcdevarch::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcdevarchSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCDEVARCH to value 0xae31_8963"]
impl crate::Resettable for ApbaddrEtmCpu0TrcdevarchSpec {
