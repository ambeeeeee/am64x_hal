#[doc = "Register `APBADDR_ETM_CPU0_TRCVIIECTLR` reader"]
pub type R = crate::R<ApbaddrEtmCpu0TrcviiectlrSpec>;
#[doc = "Register `APBADDR_ETM_CPU0_TRCVIIECTLR` writer"]
pub type W = crate::W<ApbaddrEtmCpu0TrcviiectlrSpec>;
...
is: 0 The address range that address range comparator pair m defines is not selected for ViewInst include control. 1 The address range that address range comparator pair m defines is selected for ViewInst include control. The implemented width of the field, n, is IMPLEMENTATION DEFINED and is set by the value of TRCIDR4.NUMACPAIRS. Unimplemented bits are RAZ/WI.Selecting no include comparators indicates that all instructions are included by default. The exclude control then indicates which ranges are excluded."]
    #[inline(always)]
    #[must_use]
    pub fn include(&mut self) -> IncludeW<ApbaddrEtmCpu0TrcviiectlrSpec> {
        IncludeW::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcviiectlr_15_8(&mut self) -> Res0Trcviiectlr15_8W<ApbaddrEtmCpu0TrcviiectlrSpec> {
...
0 1 The implemented width of the field, n, is IMPLEMENTATION DEFINED and is set by the value of TRCIDR4.NUMACPAIRS. Unimplemented bits are RAZ/WI."]
    #[inline(always)]
    #[must_use]
    pub fn exclude(&mut self) -> ExcludeW<ApbaddrEtmCpu0TrcviiectlrSpec> {
...
Reserved, RES0."]
    ...
    pub fn res0_trcviiectlr_31_24(
        &mut self,
    ) -> Res0Trcviiectlr31_24W<ApbaddrEtmCpu0TrcviiectlrSpec> {
        Res0Trcviiectlr31_24W::new(self, 24)
    }
}
#[doc = "ViewInst Include-Exclude Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu0_trcviiectlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu0_trcviiectlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu0TrcviiectlrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu0TrcviiectlrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu0_trcviiectlr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu0TrcviiectlrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu0_trcviiectlr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu0TrcviiectlrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU0_TRCVIIECTLR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu0TrcviiectlrSpec {
