#[doc = "Register `BCDMA_TCHANRT_TRT_STATUS1` reader"]
pub type R = crate::R<BcdmaTchanrtTrtStatus1Spec>;
#[doc = "Register `BCDMA_TCHANRT_TRT_STATUS1` writer"]
pub type W = crate::W<BcdmaTchanrtTrtStatus1Spec>;
...
Channel has outstanding work to do"]
...
Channel is trying to schedule work"]
...
The channel has met the conditions to do teardown"]
...
The channel is in a packet"]
    #[inline(always)]
    #[must_use]
    pub fn in_packet_array(&mut self) -> InPacketArrayW<BcdmaTchanrtTrtStatus1Spec> {
...
Channel has outstanding work to do"]
    #[inline(always)]
    #[must_use]
    pub fn channel_busy(&mut self) -> ChannelBusyW<BcdmaTchanrtTrtStatus1Spec> {
...
Channel is trying to schedule work"]
    #[inline(always)]
    #[must_use]
    pub fn channel_ok(&mut self) -> ChannelOkW<BcdmaTchanrtTrtStatus1Spec> {
...
The channel has met the conditions to do teardown"]
    #[inline(always)]
    #[must_use]
    pub fn tdnull(&mut self) -> TdnullW<BcdmaTchanrtTrtStatus1Spec> {
        TdnullW::new(self, 8)
    }
    #[doc = "Bit 24 - 24:24\\]
The fifo has space for a burst size"]
    #[inline(always)]
    #[must_use]
    pub fn wavail(&mut self) -> WavailW<BcdmaTchanrtTrtStatus1Spec> {
        WavailW::new(self, 24)
    }
    #[doc = "Bit 31 - 31:31\\]
The channel is sending a schedule request"]
    #[inline(always)]
    #[must_use]
    pub fn tx_reqs(&mut self) -> TxReqsW<BcdmaTchanrtTrtStatus1Spec> {
        TxReqsW::new(self, 31)
    }
}
#[doc = "The Status Register provides a read only view of channel status bits.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bcdma_tchanrt_trt_status1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bcdma_tchanrt_trt_status1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BcdmaTchanrtTrtStatus1Spec;
impl crate::RegisterSpec for BcdmaTchanrtTrtStatus1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bcdma_tchanrt_trt_status1::R`](R) reader structure"]
impl crate::Readable for BcdmaTchanrtTrtStatus1Spec {}
#[doc = "`write(|w| ..)` method takes [`bcdma_tchanrt_trt_status1::W`](W) writer structure"]
impl crate::Writable for BcdmaTchanrtTrtStatus1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BCDMA_TCHANRT_TRT_STATUS1 to value 0"]
impl crate::Resettable for BcdmaTchanrtTrtStatus1Spec {
