...
Interrupt Enable Set Register for icb_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn icb_ramecc_enable_set(&mut self) -> IcbRameccEnableSetW<RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for ite_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn ite_ramecc_enable_set(&mut self) -> IteRameccEnableSetW<RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for lpi_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn lpi_ramecc_enable_set(&mut self) -> LpiRameccEnableSetW<RegsSecEnableSetReg0Spec> {
