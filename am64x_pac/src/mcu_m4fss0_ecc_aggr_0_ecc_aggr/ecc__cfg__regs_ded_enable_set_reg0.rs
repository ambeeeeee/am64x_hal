#[doc = "Register `ECC__CFG__REGS_ded_enable_set_reg0` reader"]
pub type R = crate::R<Ecc_Cfg_RegsDedEnableSetReg0Spec>;
#[doc = "Register `ECC__CFG__REGS_ded_enable_set_reg0` writer"]
pub type W = crate::W<Ecc_Cfg_RegsDedEnableSetReg0Spec>;
...
Interrupt Enable Set Register for iram_ramecc_pend"]
    ...
    pub fn iram_ramecc_enable_set(
        &mut self,
    ) -> IramRameccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for dram_ramecc_pend"]
    ...
    pub fn dram_ramecc_enable_set(
        &mut self,
    ) -> DramRameccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for iram_busecc_pend"]
    ...
    pub fn iram_busecc_enable_set(
        &mut self,
    ) -> IramBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for dram_busecc_pend"]
    ...
    pub fn dram_busecc_enable_set(
        &mut self,
    ) -> DramBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for blazar_rat_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_rat_edc_ctrl_busecc_enable_set(
        &mut self,
    ) -> BlazarRatEdcCtrlBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for blazar_cbass_vbusp_s_p2p_bridge_vbusp_s_bridge_busecc_pend"]
    ...
    pub fn blazar_cbass_vbusp_s_p2p_bridge_vbusp_s_bridge_busecc_enable_set(
        &mut self,
    ) -> BlazarCbassVbuspSP2pBridgeVbuspSBridgeBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec>
    {
...
Interrupt Enable Set Register for blazar_cbass_Iecc_s_p2p_bridge_Iecc_s_bridge_busecc_pend"]
    ...
    pub fn blazar_cbass_iecc_s_p2p_bridge_iecc_s_bridge_busecc_enable_set(
        &mut self,
    ) -> BlazarCbassIeccSP2pBridgeIeccSBridgeBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec>
    {
...
Interrupt Enable Set Register for blazar_cbass_blazar_scr_scr_blazar_cbass_blazar_scr_scr_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_cbass_blazar_scr_scr_blazar_cbass_blazar_scr_scr_edc_ctrl_busecc_enable_set(
        ...
        Ecc_Cfg_RegsDedEnableSetReg0Spec,
    > {
...
Interrupt Enable Set Register for blazar_cbass_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_pend"]
    ...
    pub fn blazar_cbass_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_enable_set(
        &mut self,
    ) -> BlazarCbassVbusClkEdcCtrlCbassIntVbusBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec>
    {
...
Interrupt Enable Set Register for blazar_sys_scr_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_pend"]
    ...
    pub fn blazar_sys_scr_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_enable_set(
        &mut self,
    ) -> BlazarSysScrVbusClkEdcCtrlCbassIntVbusBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec>
    {
...
Interrupt Enable Set Register for blazar_Ia2v_i_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_ia2v_i_edc_ctrl_busecc_enable_set(
        &mut self,
    ) -> BlazarIa2vIEdcCtrlBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for blazar_Ia2v_d_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_ia2v_d_edc_ctrl_busecc_enable_set(
        &mut self,
    ) -> BlazarIa2vDEdcCtrlBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for blazar_Ia2v_s_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_ia2v_s_edc_ctrl_busecc_enable_set(
        &mut self,
    ) -> BlazarIa2vSEdcCtrlBuseccEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
...
Interrupt Enable Set Register for eccagg_pend"]
    #[inline(always)]
    #[must_use]
    pub fn eccagg_enable_set(&mut self) -> EccaggEnableSetW<Ecc_Cfg_RegsDedEnableSetReg0Spec> {
        EccaggEnableSetW::new(self, 13)
    }
}
#[doc = "Interrupt Enable Set Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ecc__cfg__regs_ded_enable_set_reg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ecc__cfg__regs_ded_enable_set_reg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ecc_Cfg_RegsDedEnableSetReg0Spec;
impl crate::RegisterSpec for Ecc_Cfg_RegsDedEnableSetReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc__cfg__regs_ded_enable_set_reg0::R`](R) reader structure"]
impl crate::Readable for Ecc_Cfg_RegsDedEnableSetReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`ecc__cfg__regs_ded_enable_set_reg0::W`](W) writer structure"]
impl crate::Writable for Ecc_Cfg_RegsDedEnableSetReg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ECC__CFG__REGS_ded_enable_set_reg0 to value 0"]
impl crate::Resettable for Ecc_Cfg_RegsDedEnableSetReg0Spec {
