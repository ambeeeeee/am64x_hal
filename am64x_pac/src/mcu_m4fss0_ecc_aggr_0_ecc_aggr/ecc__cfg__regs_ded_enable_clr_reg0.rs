#[doc = "Register `ECC__CFG__REGS_ded_enable_clr_reg0` reader"]
pub type R = crate::R<Ecc_Cfg_RegsDedEnableClrReg0Spec>;
#[doc = "Register `ECC__CFG__REGS_ded_enable_clr_reg0` writer"]
pub type W = crate::W<Ecc_Cfg_RegsDedEnableClrReg0Spec>;
...
Interrupt Enable Clear Register for iram_ramecc_pend"]
    ...
    pub fn iram_ramecc_enable_clr(
        &mut self,
    ) -> IramRameccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for dram_ramecc_pend"]
    ...
    pub fn dram_ramecc_enable_clr(
        &mut self,
    ) -> DramRameccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for iram_busecc_pend"]
    ...
    pub fn iram_busecc_enable_clr(
        &mut self,
    ) -> IramBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for dram_busecc_pend"]
    ...
    pub fn dram_busecc_enable_clr(
        &mut self,
    ) -> DramBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for blazar_rat_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_rat_edc_ctrl_busecc_enable_clr(
        &mut self,
    ) -> BlazarRatEdcCtrlBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for blazar_cbass_vbusp_s_p2p_bridge_vbusp_s_bridge_busecc_pend"]
    ...
    pub fn blazar_cbass_vbusp_s_p2p_bridge_vbusp_s_bridge_busecc_enable_clr(
        &mut self,
    ) -> BlazarCbassVbuspSP2pBridgeVbuspSBridgeBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec>
    {
...
Interrupt Enable Clear Register for blazar_cbass_Iecc_s_p2p_bridge_Iecc_s_bridge_busecc_pend"]
    ...
    pub fn blazar_cbass_iecc_s_p2p_bridge_iecc_s_bridge_busecc_enable_clr(
        &mut self,
    ) -> BlazarCbassIeccSP2pBridgeIeccSBridgeBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec>
    {
...
Interrupt Enable Clear Register for blazar_cbass_blazar_scr_scr_blazar_cbass_blazar_scr_scr_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_cbass_blazar_scr_scr_blazar_cbass_blazar_scr_scr_edc_ctrl_busecc_enable_clr(
        ...
        Ecc_Cfg_RegsDedEnableClrReg0Spec,
    > {
...
Interrupt Enable Clear Register for blazar_cbass_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_pend"]
    ...
    pub fn blazar_cbass_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_enable_clr(
        &mut self,
    ) -> BlazarCbassVbusClkEdcCtrlCbassIntVbusBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec>
    {
...
Interrupt Enable Clear Register for blazar_sys_scr_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_pend"]
    ...
    pub fn blazar_sys_scr_vbus_clk_edc_ctrl_cbass_int_vbus_busecc_enable_clr(
        &mut self,
    ) -> BlazarSysScrVbusClkEdcCtrlCbassIntVbusBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec>
    {
...
Interrupt Enable Clear Register for blazar_Ia2v_i_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_ia2v_i_edc_ctrl_busecc_enable_clr(
        &mut self,
    ) -> BlazarIa2vIEdcCtrlBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for blazar_Ia2v_d_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_ia2v_d_edc_ctrl_busecc_enable_clr(
        &mut self,
    ) -> BlazarIa2vDEdcCtrlBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for blazar_Ia2v_s_edc_ctrl_busecc_pend"]
    ...
    pub fn blazar_ia2v_s_edc_ctrl_busecc_enable_clr(
        &mut self,
    ) -> BlazarIa2vSEdcCtrlBuseccEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for eccagg_pend"]
    #[inline(always)]
    #[must_use]
    pub fn eccagg_enable_clr(&mut self) -> EccaggEnableClrW<Ecc_Cfg_RegsDedEnableClrReg0Spec> {
        EccaggEnableClrW::new(self, 13)
    }
}
#[doc = "Interrupt Enable Clear Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ecc__cfg__regs_ded_enable_clr_reg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ecc__cfg__regs_ded_enable_clr_reg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ecc_Cfg_RegsDedEnableClrReg0Spec;
impl crate::RegisterSpec for Ecc_Cfg_RegsDedEnableClrReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc__cfg__regs_ded_enable_clr_reg0::R`](R) reader structure"]
impl crate::Readable for Ecc_Cfg_RegsDedEnableClrReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`ecc__cfg__regs_ded_enable_clr_reg0::W`](W) writer structure"]
impl crate::Writable for Ecc_Cfg_RegsDedEnableClrReg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ECC__CFG__REGS_ded_enable_clr_reg0 to value 0"]
impl crate::Resettable for Ecc_Cfg_RegsDedEnableClrReg0Spec {
