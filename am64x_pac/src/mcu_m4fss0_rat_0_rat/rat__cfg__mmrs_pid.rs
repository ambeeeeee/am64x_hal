#[doc = "Register `RAT__CFG__MMRS_pid` reader"]
pub type R = crate::R<Rat_Cfg_MmrsPidSpec>;
#[doc = "Register `RAT__CFG__MMRS_pid` writer"]
pub type W = crate::W<Rat_Cfg_MmrsPidSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn minor(&mut self) -> MinorW<Rat_Cfg_MmrsPidSpec> {
        MinorW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<Rat_Cfg_MmrsPidSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn major(&mut self) -> MajorW<Rat_Cfg_MmrsPidSpec> {
        MajorW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release."]
    #[inline(always)]
    #[must_use]
    pub fn rtl(&mut self) -> RtlW<Rat_Cfg_MmrsPidSpec> {
        RtlW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<Rat_Cfg_MmrsPidSpec> {
        FuncW::new(self, 16)
    }
    #[doc = "Bits 28:29 - 29:28\\]
Business Unit: 10 = Processors"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<Rat_Cfg_MmrsPidSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
PID register scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<Rat_Cfg_MmrsPidSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "The Revision Register contains the major and minor revisions for the module.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rat__cfg__mmrs_pid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rat__cfg__mmrs_pid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rat_Cfg_MmrsPidSpec;
impl crate::RegisterSpec for Rat_Cfg_MmrsPidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rat__cfg__mmrs_pid::R`](R) reader structure"]
impl crate::Readable for Rat_Cfg_MmrsPidSpec {}
#[doc = "`write(|w| ..)` method takes [`rat__cfg__mmrs_pid::W`](W) writer structure"]
impl crate::Writable for Rat_Cfg_MmrsPidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAT__CFG__MMRS_pid to value 0x7664_4100"]
impl crate::Resettable for Rat_Cfg_MmrsPidSpec {
    const RESET_VALUE: u32 = 0x7664_4100;
}
