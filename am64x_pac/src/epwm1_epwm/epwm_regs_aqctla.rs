#[doc = "Register `EPWM_REGS_AQCTLA` reader"]
pub type R = crate::R<EpwmRegsAqctlaSpec>;
#[doc = "Register `EPWM_REGS_AQCTLA` writer"]
pub type W = crate::W<EpwmRegsAqctlaSpec>;
...
Action when counter equals zero Note: By definition, in count up-down mode when the counter equals 0 the direction is defined as 1 or counting up"]
    #[inline(always)]
    #[must_use]
    pub fn zro(&mut self) -> ZroW<EpwmRegsAqctlaSpec> {
        ZroW::new(self, 0)
    }
    #[doc = "Bits 2:3 - 3:2\\]
Action when the counter equals the period Note: By definition, in count up-down mode when the counter equals period the direction is defined as 0 or counting down"]
    #[inline(always)]
    #[must_use]
    pub fn prd(&mut self) -> PrdW<EpwmRegsAqctlaSpec> {
        PrdW::new(self, 2)
    }
    #[doc = "Bits 4:5 - 5:4\\]
Action when the counter equals the active CMPA register and the counter is incrementing"]
    #[inline(always)]
    #[must_use]
    pub fn cau(&mut self) -> CauW<EpwmRegsAqctlaSpec> {
        CauW::new(self, 4)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Action when the counter equals the active CMPA register and the counter is decrementing"]
    #[inline(always)]
    #[must_use]
    pub fn cad(&mut self) -> CadW<EpwmRegsAqctlaSpec> {
        CadW::new(self, 6)
    }
    #[doc = "Bits 8:9 - 9:8\\]
Action when the counter equals the active CMPB register and the counter is incrementing"]
    #[inline(always)]
    #[must_use]
    pub fn cbu(&mut self) -> CbuW<EpwmRegsAqctlaSpec> {
        CbuW::new(self, 8)
    }
    #[doc = "Bits 10:11 - 11:10\\]
Action when the time-base counter equals the active CMPB register and the counter is decrementing"]
    #[inline(always)]
    #[must_use]
    pub fn cbd(&mut self) -> CbdW<EpwmRegsAqctlaSpec> {
        CbdW::new(self, 10)
    }
}
#[doc = "Action Qualifier Control Register For Output A\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epwm_regs_aqctla::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epwm_regs_aqctla::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EpwmRegsAqctlaSpec;
impl crate::RegisterSpec for EpwmRegsAqctlaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`epwm_regs_aqctla::R`](R) reader structure"]
impl crate::Readable for EpwmRegsAqctlaSpec {}
#[doc = "`write(|w| ..)` method takes [`epwm_regs_aqctla::W`](W) writer structure"]
impl crate::Writable for EpwmRegsAqctlaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets EPWM_REGS_AQCTLA to value 0"]
impl crate::Resettable for EpwmRegsAqctlaSpec {
