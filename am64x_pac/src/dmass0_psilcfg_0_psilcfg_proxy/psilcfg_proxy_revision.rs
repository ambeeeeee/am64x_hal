#[doc = "Register `PSILCFG_PROXY_REVISION` reader"]
pub type R = crate::R<PsilcfgProxyRevisionSpec>;
#[doc = "Register `PSILCFG_PROXY_REVISION` writer"]
pub type W = crate::W<PsilcfgProxyRevisionSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn revmin(&mut self) -> RevminW<PsilcfgProxyRevisionSpec> {
        RevminW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<PsilcfgProxyRevisionSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn revmaj(&mut self) -> RevmajW<PsilcfgProxyRevisionSpec> {
        RevmajW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release."]
    #[inline(always)]
    #[must_use]
    pub fn revrtl(&mut self) -> RevrtlW<PsilcfgProxyRevisionSpec> {
        RevrtlW::new(self, 11)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Module ID field"]
    #[inline(always)]
    #[must_use]
    pub fn modid(&mut self) -> ModidW<PsilcfgProxyRevisionSpec> {
        ModidW::new(self, 16)
    }
}
#[doc = "The Revision Register contains the major and minor revisions for the module.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`psilcfg_proxy_revision::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`psilcfg_proxy_revision::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PsilcfgProxyRevisionSpec;
impl crate::RegisterSpec for PsilcfgProxyRevisionSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`psilcfg_proxy_revision::R`](R) reader structure"]
impl crate::Readable for PsilcfgProxyRevisionSpec {}
#[doc = "`write(|w| ..)` method takes [`psilcfg_proxy_revision::W`](W) writer structure"]
impl crate::Writable for PsilcfgProxyRevisionSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PSILCFG_PROXY_REVISION to value 0x0100"]
impl crate::Resettable for PsilcfgProxyRevisionSpec {
