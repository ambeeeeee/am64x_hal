#[doc = "Register `ECCAGGR_REGS_ecc_vector` reader"]
pub type R = crate::R<EccaggrRegsEccVectorSpec>;
#[doc = "Register `ECCAGGR_REGS_ecc_vector` writer"]
pub type W = crate::W<EccaggrRegsEccVectorSpec>;
...
Value written to select the corresponding ECC RAM for control or status"]
    #[inline(always)]
    #[must_use]
    pub fn ecc_vector(&mut self) -> EccVectorW<EccaggrRegsEccVectorSpec> {
...
Write 1 to trigger a read on the serial VBUS"]
    #[inline(always)]
    #[must_use]
    pub fn rd_svbus(&mut self) -> RdSvbusW<EccaggrRegsEccVectorSpec> {
...
Read address"]
    #[inline(always)]
    #[must_use]
    pub fn rd_svbus_address(&mut self) -> RdSvbusAddressW<EccaggrRegsEccVectorSpec> {
...
Status to indicate if read on serial VBUS is complete, write of any value will clear this bit."]
    #[inline(always)]
    #[must_use]
    pub fn rd_svbus_done(&mut self) -> RdSvbusDoneW<EccaggrRegsEccVectorSpec> {
        RdSvbusDoneW::new(self, 24)
    }
}
#[doc = "ECC Vector Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eccaggr_regs_ecc_vector::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`eccaggr_regs_ecc_vector::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EccaggrRegsEccVectorSpec;
impl crate::RegisterSpec for EccaggrRegsEccVectorSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eccaggr_regs_ecc_vector::R`](R) reader structure"]
impl crate::Readable for EccaggrRegsEccVectorSpec {}
#[doc = "`write(|w| ..)` method takes [`eccaggr_regs_ecc_vector::W`](W) writer structure"]
impl crate::Writable for EccaggrRegsEccVectorSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ECCAGGR_REGS_ecc_vector to value 0"]
impl crate::Resettable for EccaggrRegsEccVectorSpec {
