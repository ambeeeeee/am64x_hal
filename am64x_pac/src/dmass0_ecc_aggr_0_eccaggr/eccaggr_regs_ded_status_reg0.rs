#[doc = "Register `ECCAGGR_REGS_ded_status_reg0` reader"]
pub type R = crate::R<EccaggrRegsDedStatusReg0Spec>;
#[doc = "Register `ECCAGGR_REGS_ded_status_reg0` writer"]
pub type W = crate::W<EccaggrRegsDedStatusReg0Spec>;
...
Interrupt Pending Status for pktdma_cfg_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn pktdma_cfg_ramecc_pend(&mut self) -> PktdmaCfgRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_state_ramecc_pend"]
    ...
    pub fn pktdma_state_ramecc_pend(
        &mut self,
    ) -> PktdmaStateRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_tpcf0_ramecc_pend"]
    ...
    pub fn pktdma_tpcf0_ramecc_pend(
        &mut self,
    ) -> PktdmaTpcf0RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_tpcf1_ramecc_pend"]
    ...
    pub fn pktdma_tpcf1_ramecc_pend(
        &mut self,
    ) -> PktdmaTpcf1RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_rpcf0_ramecc_pend"]
    ...
    pub fn pktdma_rpcf0_ramecc_pend(
        &mut self,
    ) -> PktdmaRpcf0RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_rpcf1_ramecc_pend"]
    ...
    pub fn pktdma_rpcf1_ramecc_pend(
        &mut self,
    ) -> PktdmaRpcf1RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_rpcf2_ramecc_pend"]
    ...
    pub fn pktdma_rpcf2_ramecc_pend(
        &mut self,
    ) -> PktdmaRpcf2RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_sts_ramecc0_pend"]
    ...
    pub fn pktdma_sts_ramecc0_pend(
        &mut self,
    ) -> PktdmaStsRamecc0PendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_sts_ramecc1_pend"]
    ...
    pub fn pktdma_sts_ramecc1_pend(
        &mut self,
    ) -> PktdmaStsRamecc1PendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pktdma_rngocc_ramecc_pend"]
    ...
    pub fn pktdma_rngocc_ramecc_pend(
        &mut self,
    ) -> PktdmaRngoccRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_cfg_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn bcdma_cfg_ramecc_pend(&mut self) -> BcdmaCfgRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_state_ramecc_pend"]
    ...
    pub fn bcdma_state_ramecc_pend(
        &mut self,
    ) -> BcdmaStateRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pcfd0_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn pcfd0_ramecc_pend(&mut self) -> Pcfd0RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for pcfd1_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn pcfd1_ramecc_pend(&mut self) -> Pcfd1RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_tpcf0_ramecc_pend"]
    ...
    pub fn bcdma_tpcf0_ramecc_pend(
        &mut self,
    ) -> BcdmaTpcf0RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_tpcf1_ramecc_pend"]
    ...
    pub fn bcdma_tpcf1_ramecc_pend(
        &mut self,
    ) -> BcdmaTpcf1RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_rpcf0_ramecc_pend"]
    ...
    pub fn bcdma_rpcf0_ramecc_pend(
        &mut self,
    ) -> BcdmaRpcf0RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_rpcf1_ramecc_pend"]
    ...
    pub fn bcdma_rpcf1_ramecc_pend(
        &mut self,
    ) -> BcdmaRpcf1RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_rpcf2_ramecc_pend"]
    ...
    pub fn bcdma_rpcf2_ramecc_pend(
        &mut self,
    ) -> BcdmaRpcf2RameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_sts_ramecc0_pend"]
    #[inline(always)]
    #[must_use]
    pub fn bcdma_sts_ramecc0_pend(&mut self) -> BcdmaStsRamecc0PendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_sts_ramecc1_pend"]
    #[inline(always)]
    #[must_use]
    pub fn bcdma_sts_ramecc1_pend(&mut self) -> BcdmaStsRamecc1PendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for bcdma_rngocc_ramecc_pend"]
    ...
    pub fn bcdma_rngocc_ramecc_pend(
        &mut self,
    ) -> BcdmaRngoccRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for sr_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn sr_ramecc_pend(&mut self) -> SrRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for map_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn map_ramecc_pend(&mut self) -> MapRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for ringacc_stram_ramecc_pend"]
    ...
    pub fn ringacc_stram_ramecc_pend(
        &mut self,
    ) -> RingaccStramRameccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for sec_proxy_stram_rameccc_pend"]
    ...
    pub fn sec_proxy_stram_rameccc_pend(
        &mut self,
    ) -> SecProxyStramRamecccPendW<EccaggrRegsDedStatusReg0Spec> {
...
Interrupt Pending Status for sec_proxy_bufram_rameccc_pend"]
    ...
    pub fn sec_proxy_bufram_rameccc_pend(
        &mut self,
    ) -> SecProxyBuframRamecccPendW<EccaggrRegsDedStatusReg0Spec> {
        SecProxyBuframRamecccPendW::new(self, 26)
    }
}
#[doc = "Interrupt Status Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eccaggr_regs_ded_status_reg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`eccaggr_regs_ded_status_reg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EccaggrRegsDedStatusReg0Spec;
impl crate::RegisterSpec for EccaggrRegsDedStatusReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eccaggr_regs_ded_status_reg0::R`](R) reader structure"]
impl crate::Readable for EccaggrRegsDedStatusReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`eccaggr_regs_ded_status_reg0::W`](W) writer structure"]
impl crate::Writable for EccaggrRegsDedStatusReg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ECCAGGR_REGS_ded_status_reg0 to value 0"]
impl crate::Resettable for EccaggrRegsDedStatusReg0Spec {
