#[doc = "Register `APBADDR_PMU_CPU1_PMCCFILTR_EL0` reader"]
pub type R = crate::R<ApbaddrPmuCpu1PmccfiltrEl0Spec>;
#[doc = "Register `APBADDR_PMU_CPU1_PMCCFILTR_EL0` writer"]
pub type W = crate::W<ApbaddrPmuCpu1PmccfiltrEl0Spec>;
...
Reserved, RES0."]
    ...
    pub fn res0_pmccfiltr_el0_25_0(
        &mut self,
    ) -> Res0PmccfiltrEl0_25_0W<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
...
Secure EL3 filtering bit. Most applications can ignore this bit and set the value to zero. If EL3 is not implemented, this bit is RES0.If the value of this bit is equal to the value of P, cycles in Secure EL3 are counted.Otherwise, cycles in Secure EL3 are not counted."]
    #[inline(always)]
    #[must_use]
    pub fn m(&mut self) -> MW<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
        MW::new(self, 26)
    }
    #[doc = "Bit 27 - 27:27\\]
Non-secure Hyp modes filtering bit. Controls counting in Non-secure EL2. If EL2 is not implemented, this bit is RES0. 0 Do not count cycles in EL2. 1 Count cycles in EL2."]
    #[inline(always)]
    #[must_use]
    pub fn nsh(&mut self) -> NshW<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
        NshW::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
Non-secure user modes filtering bit. Controls counting in Non-secure EL0. If EL3 is not implemented, this bit is RES0.If the value of this bit is equal to the value of U, cycles in Non-secure EL0 are counted.Otherwise, cycles in Non-secure EL0 are not counted."]
    #[inline(always)]
    #[must_use]
    pub fn nsu(&mut self) -> NsuW<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
        NsuW::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Non-secure kernel modes filtering bit. Controls counting in Non-secure EL1. If EL3 is not implemented, this bit is RES0.If the value of this bit is equal to the value of P, cycles in Non-secure EL1 are counted.Otherwise, cycles in Non-secure EL1 are not counted."]
    #[inline(always)]
    #[must_use]
    pub fn nsk(&mut self) -> NskW<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
        NskW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
EL0 filtering bit. Controls counting in EL0. If EL3 is implemented, then counting in Non-secure EL0 is further controlled by the NSU bit. The possible values of this bit are: 0 Count cycles in EL0. 1 Do not count cycles in EL0."]
    #[inline(always)]
    #[must_use]
    pub fn u(&mut self) -> UW<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
        UW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
EL1 modes filtering bit. Controls counting in EL1. If EL3 is implemented, then counting in Non-secure EL1 is further controlled by the NSK bit. The possible values of this bit are: 0 Count cycles in EL1. 1 Do not count cycles in EL1."]
    #[inline(always)]
    #[must_use]
    pub fn p(&mut self) -> PW<ApbaddrPmuCpu1PmccfiltrEl0Spec> {
        PW::new(self, 31)
    }
}
#[doc = "Performance Monitors Cycle Counter Filter Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_pmu_cpu1_pmccfiltr_el0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_pmu_cpu1_pmccfiltr_el0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrPmuCpu1PmccfiltrEl0Spec;
impl crate::RegisterSpec for ApbaddrPmuCpu1PmccfiltrEl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu1_pmccfiltr_el0::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu1PmccfiltrEl0Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu1_pmccfiltr_el0::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu1PmccfiltrEl0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU1_PMCCFILTR_EL0 to value 0"]
impl crate::Resettable for ApbaddrPmuCpu1PmccfiltrEl0Spec {
