#[doc = "Register `APBADDR_PMU_CPU1_PMPIDR2` reader"]
pub type R = crate::R<ApbaddrPmuCpu1Pmpidr2Spec>;
#[doc = "Register `APBADDR_PMU_CPU1_PMPIDR2` writer"]
pub type W = crate::W<ApbaddrPmuCpu1Pmpidr2Spec>;
...
Designer, most significant bits of JEP106 ID code. For ARM Limited, this field is 0b011."]
    #[inline(always)]
    #[must_use]
    pub fn des_1(&mut self) -> Des1W<ApbaddrPmuCpu1Pmpidr2Spec> {
        Des1W::new(self, 0)
    }
    #[doc = "Bit 3 - 3:3\\]
RAO. Indicates a JEP106 identity code is used."]
    #[inline(always)]
    #[must_use]
    pub fn jedec(&mut self) -> JedecW<ApbaddrPmuCpu1Pmpidr2Spec> {
        JedecW::new(self, 3)
    }
    #[doc = "Bits 4:7 - 7:4\\]
Part major revision. Parts can also use this field to extend Part number to 16-bits."]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrPmuCpu1Pmpidr2Spec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_pmpidr2_31_8(&mut self) -> Res0Pmpidr2_31_8W<ApbaddrPmuCpu1Pmpidr2Spec> {
        Res0Pmpidr2_31_8W::new(self, 8)
    }
}
#[doc = "Performance Monitors Peripheral Identification Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_pmu_cpu1_pmpidr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_pmu_cpu1_pmpidr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrPmuCpu1Pmpidr2Spec;
impl crate::RegisterSpec for ApbaddrPmuCpu1Pmpidr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu1_pmpidr2::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu1Pmpidr2Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu1_pmpidr2::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu1Pmpidr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU1_PMPIDR2 to value 0x4b"]
impl crate::Resettable for ApbaddrPmuCpu1Pmpidr2Spec {
