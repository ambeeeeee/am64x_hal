#[doc = "Register `APBADDR_PMU_CPU1_PMCFGR` reader"]
pub type R = crate::R<ApbaddrPmuCpu1PmcfgrSpec>;
#[doc = "Register `APBADDR_PMU_CPU1_PMCFGR` writer"]
pub type W = crate::W<ApbaddrPmuCpu1PmcfgrSpec>;
...
are always RES0. 00000000 Only PMCCNTR_EL0 implemented. 00000001 PMCCNTR_EL0 plus one event counter implemented. and so on up to 0b00011111, which indicates PMCCNTR_EL0 and 31 event counters implemented."]
    #[inline(always)]
    #[must_use]
    pub fn n(&mut self) -> NW<ApbaddrPmuCpu1PmcfgrSpec> {
        NW::new(self, 0)
    }
    #[doc = "Bits 8:13 - 13:8\\]
Size of counters. This field determines the spacing of counters in the memory-map.In v8-A the counters are at doubleword-aligned addresses, and the largest counter is 64-bits, so this field is 0b111111."]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SizeW<ApbaddrPmuCpu1PmcfgrSpec> {
        SizeW::new(self, 8)
    }
    #[doc = "Bit 14 - 14:14\\]
Dedicated cycle counter \\[counter 31\\]
supported. This bit is RES1."]
    #[inline(always)]
    #[must_use]
    pub fn cc(&mut self) -> CcW<ApbaddrPmuCpu1PmcfgrSpec> {
        CcW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Cycle counter has prescale. This is RES1 if AArch32 is supported at any EL, and RES0 otherwise. 0 PMCR_EL0.D is RES0. 1 PMCR_EL0.D is read/write."]
    #[inline(always)]
    #[must_use]
    pub fn ccd(&mut self) -> CcdW<ApbaddrPmuCpu1PmcfgrSpec> {
        CcdW::new(self, 15)
    }
    #[doc = "Bit 16 - 16:16\\]
Export supported. Value is IMPLEMENTATION DEFINED. 0 PMCR_EL0.X is RES0. 1 PMCR_EL0.X is read/write."]
    #[inline(always)]
    #[must_use]
    pub fn ex(&mut self) -> ExW<ApbaddrPmuCpu1PmcfgrSpec> {
        ExW::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
This feature is not supported, so this bit is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn na(&mut self) -> NaW<ApbaddrPmuCpu1PmcfgrSpec> {
        NaW::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
This feature is not supported, so this bit is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn wt(&mut self) -> WtW<ApbaddrPmuCpu1PmcfgrSpec> {
        WtW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
User-mode Enable Register supported. PMUSERENR_EL0 is not visible in the external debug interface, so this bit is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn uen(&mut self) -> UenW<ApbaddrPmuCpu1PmcfgrSpec> {
        UenW::new(self, 19)
    }
    #[doc = "Bits 20:31 - 31:20\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_pmcfgr_31_20(&mut self) -> Res0Pmcfgr31_20W<ApbaddrPmuCpu1PmcfgrSpec> {
        Res0Pmcfgr31_20W::new(self, 20)
    }
}
#[doc = "Performance Monitors Configuration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_pmu_cpu1_pmcfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_pmu_cpu1_pmcfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrPmuCpu1PmcfgrSpec;
impl crate::RegisterSpec for ApbaddrPmuCpu1PmcfgrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu1_pmcfgr::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu1PmcfgrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu1_pmcfgr::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu1PmcfgrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU1_PMCFGR to value 0x0001_e306"]
impl crate::Resettable for ApbaddrPmuCpu1PmcfgrSpec {
