#[doc = "Register `QOS_REGS_Ipcie_g2x1_64_main_0_pcie_mst_wr_map3` reader"]
pub type R = crate::R<QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec>;
#[doc = "Register `QOS_REGS_Ipcie_g2x1_64_main_0_pcie_mst_wr_map3` writer"]
pub type W = crate::W<QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec>;
...
qos signal for channel N."]
    #[inline(always)]
    #[must_use]
    pub fn qos(&mut self) -> QosW<QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec> {
        QosW::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
orderid signal for channel N."]
    #[inline(always)]
    #[must_use]
    pub fn orderid(&mut self) -> OrderidW<QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec> {
        OrderidW::new(self, 4)
    }
    #[doc = "Bits 8:11 - 11:8\\]
asel signal for channel N. 0 = SOC address. 1-15 = peripheral address."]
    #[inline(always)]
    #[must_use]
    pub fn asel(&mut self) -> AselW<QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec> {
        AselW::new(self, 8)
    }
    #[doc = "Bits 12:14 - 14:12\\]
epriority signal for channel N."]
    #[inline(always)]
    #[must_use]
    pub fn epriority(&mut self) -> EpriorityW<QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec> {
...
pub struct QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec;
impl crate::RegisterSpec for QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qos_regs_ipcie_g2x1_64_main_0_pcie_mst_wr_map3::R`](R) reader structure"]
impl crate::Readable for QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec {}
#[doc = "`write(|w| ..)` method takes [`qos_regs_ipcie_g2x1_64_main_0_pcie_mst_wr_map3::W`](W) writer structure"]
impl crate::Writable for QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets QOS_REGS_Ipcie_g2x1_64_main_0_pcie_mst_wr_map3 to value 0x7000"]
impl crate::Resettable for QosRegsIpcieG2x1_64Main0PcieMstWrMap3Spec {
