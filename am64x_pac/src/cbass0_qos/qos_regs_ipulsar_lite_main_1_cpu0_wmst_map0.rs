#[doc = "Register `QOS_REGS_Ipulsar_lite_main_1_cpu0_wmst_map0` reader"]
pub type R = crate::R<QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec>;
#[doc = "Register `QOS_REGS_Ipulsar_lite_main_1_cpu0_wmst_map0` writer"]
pub type W = crate::W<QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec>;
...
qos signal for channel N."]
    #[inline(always)]
    #[must_use]
    pub fn qos(&mut self) -> QosW<QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec> {
        QosW::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
orderid signal for channel N."]
    #[inline(always)]
    #[must_use]
    pub fn orderid(&mut self) -> OrderidW<QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec> {
        OrderidW::new(self, 4)
    }
    #[doc = "Bits 8:11 - 11:8\\]
asel signal for channel N. 0 = SOC address. 1-15 = peripheral address."]
    #[inline(always)]
    #[must_use]
    pub fn asel(&mut self) -> AselW<QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec> {
        AselW::new(self, 8)
    }
    #[doc = "Bits 12:14 - 14:12\\]
epriority signal for channel N."]
    #[inline(always)]
    #[must_use]
    pub fn epriority(&mut self) -> EpriorityW<QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec> {
...
pub struct QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec;
impl crate::RegisterSpec for QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qos_regs_ipulsar_lite_main_1_cpu0_wmst_map0::R`](R) reader structure"]
impl crate::Readable for QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec {}
#[doc = "`write(|w| ..)` method takes [`qos_regs_ipulsar_lite_main_1_cpu0_wmst_map0::W`](W) writer structure"]
impl crate::Writable for QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets QOS_REGS_Ipulsar_lite_main_1_cpu0_wmst_map0 to value 0x7000"]
impl crate::Resettable for QosRegsIpulsarLiteMain1Cpu0WmstMap0Spec {
