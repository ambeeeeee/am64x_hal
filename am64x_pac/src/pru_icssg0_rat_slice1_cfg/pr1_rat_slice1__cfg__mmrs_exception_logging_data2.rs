#[doc = "Register `PR1_RAT_SLICE1__CFG__MMRS_exception_logging_data2` reader"]
pub type R = crate::R<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec>;
#[doc = "Register `PR1_RAT_SLICE1__CFG__MMRS_exception_logging_data2` writer"]
pub type W = crate::W<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec>;
...
Priv ID."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        PrivIdW::new(self, 0)
    }
    #[doc = "Bit 8 - 8:8\\]
Secure."]
    #[inline(always)]
    #[must_use]
    pub fn secure(&mut self) -> SecureW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        SecureW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Priv."]
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PrivW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        PrivW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Cacheable."]
    #[inline(always)]
    #[must_use]
    pub fn cacheable(&mut self) -> CacheableW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
...
Debug."]
    #[inline(always)]
    #[must_use]
    pub fn debug(&mut self) -> DebugW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        DebugW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Read."]
    #[inline(always)]
    #[must_use]
    pub fn read(&mut self) -> ReadW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        ReadW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Write."]
    #[inline(always)]
    #[must_use]
    pub fn write(&mut self) -> WriteW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        WriteW::new(self, 13)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Route ID."]
    #[inline(always)]
    #[must_use]
    pub fn routeid(&mut self) -> RouteidW<Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec> {
        RouteidW::new(self, 16)
    }
}
#[doc = "The Exception Logging Data 2 Register contains the third word of the data.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pr1_rat_slice1__cfg__mmrs_exception_logging_data2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pr1_rat_slice1__cfg__mmrs_exception_logging_data2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec;
impl crate::RegisterSpec for Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_rat_slice1__cfg__mmrs_exception_logging_data2::R`](R) reader structure"]
impl crate::Readable for Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_rat_slice1__cfg__mmrs_exception_logging_data2::W`](W) writer structure"]
impl crate::Writable for Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_RAT_SLICE1__CFG__MMRS_exception_logging_data2 to value 0"]
impl crate::Resettable for Pr1RatSlice1_Cfg_MmrsExceptionLoggingData2Spec {
