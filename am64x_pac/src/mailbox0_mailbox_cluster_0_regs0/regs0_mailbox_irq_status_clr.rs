#[doc = "Register `REGS0_MAILBOX_IRQ_STATUS_CLR` reader"]
pub type R = crate::R<Regs0MailboxIrqStatusClrSpec>;
#[doc = "Register `REGS0_MAILBOX_IRQ_STATUS_CLR` writer"]
pub type W = crate::W<Regs0MailboxIrqStatusClrSpec>;
...
1 if there are messages present in Mailbox 0 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb0(&mut self) -> Newmsgstatusmb0W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 0 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb0(&mut self) -> Notfullstatusmb0W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 1 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb1(&mut self) -> Newmsgstatusmb1W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 1 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb1(&mut self) -> Notfullstatusmb1W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 2 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb2(&mut self) -> Newmsgstatusmb2W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 2 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb2(&mut self) -> Notfullstatusmb2W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 3 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb3(&mut self) -> Newmsgstatusmb3W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 3 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb3(&mut self) -> Notfullstatusmb3W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 4 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb4(&mut self) -> Newmsgstatusmb4W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 4 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb4(&mut self) -> Notfullstatusmb4W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 5 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb5(&mut self) -> Newmsgstatusmb5W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 5 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb5(&mut self) -> Notfullstatusmb5W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 6 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb6(&mut self) -> Newmsgstatusmb6W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 6 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb6(&mut self) -> Notfullstatusmb6W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 7 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb7(&mut self) -> Newmsgstatusmb7W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 7 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb7(&mut self) -> Notfullstatusmb7W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 8 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb8(&mut self) -> Newmsgstatusmb8W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 8 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb8(&mut self) -> Notfullstatusmb8W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 9 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb9(&mut self) -> Newmsgstatusmb9W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 9 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb9(&mut self) -> Notfullstatusmb9W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 10 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb10(&mut self) -> Newmsgstatusmb10W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 10 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb10(&mut self) -> Notfullstatusmb10W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 11 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb11(&mut self) -> Newmsgstatusmb11W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 11 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb11(&mut self) -> Notfullstatusmb11W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 12 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb12(&mut self) -> Newmsgstatusmb12W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 12 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb12(&mut self) -> Notfullstatusmb12W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 13 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb13(&mut self) -> Newmsgstatusmb13W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 13 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb13(&mut self) -> Notfullstatusmb13W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 14 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb14(&mut self) -> Newmsgstatusmb14W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 14 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb14(&mut self) -> Notfullstatusmb14W<Regs0MailboxIrqStatusClrSpec> {
...
1 if there are messages present in Mailbox 15 and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn newmsgstatusmb15(&mut self) -> Newmsgstatusmb15W<Regs0MailboxIrqStatusClrSpec> {
...
1 if Mailbox 15 is not full and this interrupt bit is enabled"]
    #[inline(always)]
    #[must_use]
    pub fn notfullstatusmb15(&mut self) -> Notfullstatusmb15W<Regs0MailboxIrqStatusClrSpec> {
        Notfullstatusmb15W::new(self, 31)
    }
}
#[doc = "The interrupt status register has the status for each event that may be responsible for the generation of an interrupt to the corresponding user combined with the corresponding MASK information. Software may also write 1 to a given bit to clear this bit. However, if the hardware still has pending, enabled events, the interrupt will fire again in two cycles. Write 0 has no effect.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`regs0_mailbox_irq_status_clr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`regs0_mailbox_irq_status_clr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Regs0MailboxIrqStatusClrSpec;
impl crate::RegisterSpec for Regs0MailboxIrqStatusClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regs0_mailbox_irq_status_clr::R`](R) reader structure"]
impl crate::Readable for Regs0MailboxIrqStatusClrSpec {}
#[doc = "`write(|w| ..)` method takes [`regs0_mailbox_irq_status_clr::W`](W) writer structure"]
impl crate::Writable for Regs0MailboxIrqStatusClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets REGS0_MAILBOX_IRQ_STATUS_CLR to value 0"]
impl crate::Resettable for Regs0MailboxIrqStatusClrSpec {
