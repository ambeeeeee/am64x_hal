#[doc = "Register `CFG_pll0_CAL_CTRL` reader"]
pub type R = crate::R<CfgPll0CalCtrlSpec>;
#[doc = "Register `CFG_pll0_CAL_CTRL` writer"]
pub type W = crate::W<CfgPll0CalCtrlSpec>;
...
Calibration input When cal_byp is 1'b0, this represents the initial condition for calibration. When cal_byp is 1'b1, this is the override value for calibration. Value is a signed integer with positive values delaying the faster path reset and negative values delaying the slower path reset."]
    #[inline(always)]
    #[must_use]
    pub fn cal_in(&mut self) -> CalInW<CfgPll0CalCtrlSpec> {
        CalInW::new(self, 0)
    }
    #[doc = "Bit 15 - 15:15\\]
Calibration bypass 1'b0 - Use the calibration output to set the phase correction 1'b1 - Use the cal_in input value to set the phase correction"]
    #[inline(always)]
    #[must_use]
    pub fn cal_byp(&mut self) -> CalBypW<CfgPll0CalCtrlSpec> {
        CalBypW::new(self, 15)
    }
    #[doc = "Bits 16:18 - 18:16\\]
Calibration loop programmable counter. Selects the number of PFD edges to wait after each calibration step defined by 2**cal_cnt"]
    #[inline(always)]
    #[must_use]
    pub fn cal_cnt(&mut self) -> CalCntW<CfgPll0CalCtrlSpec> {
        CalCntW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Fast calibration enabled 1'b0 - Normal operation 1'b1 - Used for initial calibration if initial value is not already known"]
    #[inline(always)]
    #[must_use]
    pub fn fast_cal(&mut self) -> FastCalW<CfgPll0CalCtrlSpec> {
...
Calibration enable to actively adjust for input skew 1'b0 - Disabled. Static phase offset determined by analog matching only 1'b1 - Enabled. Static phase offset adjusted by phase sensing at input"]
    #[inline(always)]
    #[must_use]
    pub fn cal_en(&mut self) -> CalEnW<CfgPll0CalCtrlSpec> {
        CalEnW::new(self, 31)
    }
}
#[doc = "CFG_pll0_CAL_CTRL\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll0_cal_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll0_cal_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll0CalCtrlSpec;
impl crate::RegisterSpec for CfgPll0CalCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll0_cal_ctrl::R`](R) reader structure"]
impl crate::Readable for CfgPll0CalCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll0_cal_ctrl::W`](W) writer structure"]
impl crate::Writable for CfgPll0CalCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll0_CAL_CTRL to value 0x0002_0000"]
impl crate::Resettable for CfgPll0CalCtrlSpec {
