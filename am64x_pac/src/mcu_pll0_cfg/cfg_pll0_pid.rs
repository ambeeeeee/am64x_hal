#[doc = "Register `CFG_pll0_PID` reader"]
pub type R = crate::R<CfgPll0PidSpec>;
#[doc = "Register `CFG_pll0_PID` writer"]
pub type W = crate::W<CfgPll0PidSpec>;
...
Minor revision number"]
    #[inline(always)]
    #[must_use]
    pub fn minor(&mut self) -> MinorW<CfgPll0PidSpec> {
        MinorW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
custom revision number"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<CfgPll0PidSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision number"]
    #[inline(always)]
    #[must_use]
    pub fn major(&mut self) -> MajorW<CfgPll0PidSpec> {
        MajorW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
Misc revision number"]
    #[inline(always)]
    #[must_use]
    pub fn misc(&mut self) -> MiscW<CfgPll0PidSpec> {
        MiscW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module functional identifier"]
    #[inline(always)]
    #[must_use]
    pub fn module(&mut self) -> ModuleW<CfgPll0PidSpec> {
        ModuleW::new(self, 16)
    }
    #[doc = "Bits 28:29 - 29:28\\]
Business Unit - Processors"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<CfgPll0PidSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
PID follows new scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<CfgPll0PidSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "CFG_pll0_PID\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll0_pid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll0_pid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll0PidSpec;
impl crate::RegisterSpec for CfgPll0PidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll0_pid::R`](R) reader structure"]
impl crate::Readable for CfgPll0PidSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll0_pid::W`](W) writer structure"]
impl crate::Writable for CfgPll0PidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll0_PID to value 0x6384_1001"]
impl crate::Resettable for CfgPll0PidSpec {
