...
#[doc = "Field `STRBSEL` reader - 31:24\\]
Select the Four Taps for each of STRB_90 and STRB_180 Outputs. strbsel\\[3:2\\]
selects one of the four for STRB_180 and strbsel\\[1:0\\]
selects the four taps for STRB_90."]
pub type StrbselR = crate::FieldReader;
#[doc = "Field `STRBSEL` writer - 31:24\\]
Select the Four Taps for each of STRB_90 and STRB_180 Outputs. strbsel\\[3:2\\]
selects one of the four for STRB_180 and strbsel\\[1:0\\]
selects the four taps for STRB_90."]
pub type StrbselW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
Input Tap Delay Select. Manual control of the RX clock Tap Delay in the non HS200/HS400 modes."]
    #[inline(always)]
...
selects the four taps for STRB_90."]
    #[inline(always)]
    pub fn strbsel(&self) -> StrbselR {
        StrbselR::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4 - 4:0\\]
...
selects the four taps for STRB_90."]
    #[inline(always)]
    #[must_use]
    pub fn strbsel(&mut self) -> StrbselW<Regs_SsCfg_SscfgPhyCtrl4RegSpec> {
        StrbselW::new(self, 24)
    }
}
