#[doc = "Register `CTI__CFG__CSCTI_CFG_CTIINEN0` reader"]
pub type R = crate::R<Cti_Cfg_CsctiCfgCtiinen0Spec>;
#[doc = "Register `CTI__CFG__CSCTI_CFG_CTIINEN0` writer"]
pub type W = crate::W<Cti_Cfg_CsctiCfgCtiinen0Spec>;
...
set to 1 enables ctitrigin onto channel 0. Writing a 0 to any of the bits in this register disables the ctitrigin signal from generating an event on the respective channel of the CTM. Reading this register returns the programmed value."]
    #[inline(always)]
    #[must_use]
    pub fn triginen(&mut self) -> TriginenW<Cti_Cfg_CsctiCfgCtiinen0Spec> {
        TriginenW::new(self, 0)
    }
}
#[doc = "The CTI Trigger 0 to Channel Enable Register enables the signalling of an event on CTM channels when the core issues a trigger, ctitrigin, to the CTI. Within this register there is one bit for each of the four channels implemented. This register does not affect the application trigger operations.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cti__cfg__cscti_cfg_ctiinen0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cti__cfg__cscti_cfg_ctiinen0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cti_Cfg_CsctiCfgCtiinen0Spec;
impl crate::RegisterSpec for Cti_Cfg_CsctiCfgCtiinen0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cti__cfg__cscti_cfg_ctiinen0::R`](R) reader structure"]
impl crate::Readable for Cti_Cfg_CsctiCfgCtiinen0Spec {}
#[doc = "`write(|w| ..)` method takes [`cti__cfg__cscti_cfg_ctiinen0::W`](W) writer structure"]
impl crate::Writable for Cti_Cfg_CsctiCfgCtiinen0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTI__CFG__CSCTI_CFG_CTIINEN0 to value 0"]
impl crate::Resettable for Cti_Cfg_CsctiCfgCtiinen0Spec {
