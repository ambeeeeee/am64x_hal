#[doc = "Register `PR1_TASKS_MGR_RTU1__PR1_TASKS_MGR_RTU1_MMR__REGS_ts1_gen_cfg1` reader"]
pub type R = crate::R<Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec>;
#[doc = "Register `PR1_TASKS_MGR_RTU1__PR1_TASKS_MGR_RTU1_MMR__REGS_ts1_gen_cfg1` writer"]
pub type W = crate::W<Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec>;
...
TS1 Generic Sub0 MX Select"]
    ...
    pub fn ts1_gen_s0_mx(
        &mut self,
    ) -> Ts1GenS0MxW<Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec> {
...
TS1 Generic Sub1 MX Select"]
    ...
    pub fn ts1_gen_s1_mx(
        &mut self,
    ) -> Ts1GenS1MxW<Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec> {
...
TS1 Generic Sub2 MX Select"]
    ...
    pub fn ts1_gen_s2_mx(
        &mut self,
    ) -> Ts1GenS2MxW<Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec> {
...
TS1 Generic Sub3 MX Select"]
    ...
    pub fn ts1_gen_s3_mx(
        &mut self,
    ) -> Ts1GenS3MxW<Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec> {
...
pub struct Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec;
impl crate::RegisterSpec for Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_tasks_mgr_rtu1__pr1_tasks_mgr_rtu1_mmr__regs_ts1_gen_cfg1::R`](R) reader structure"]
impl crate::Readable for Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_tasks_mgr_rtu1__pr1_tasks_mgr_rtu1_mmr__regs_ts1_gen_cfg1::W`](W) writer structure"]
impl crate::Writable for Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_TASKS_MGR_RTU1__PR1_TASKS_MGR_RTU1_MMR__REGS_ts1_gen_cfg1 to value 0"]
impl crate::Resettable for Pr1TasksMgrRtu1_Pr1TasksMgrRtu1Mmr_RegsTs1GenCfg1Spec {
