#[doc = "Register `FW_REGS_br_SCRP_32b_motor_to_SCRP_32b_miscIO_l0_fw_region_5_permission_1` reader"]
pub type R = crate::R<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec>;
#[doc = "Register `FW_REGS_br_SCRP_32b_motor_to_SCRP_32b_miscIO_l0_fw_region_5_permission_1` writer"]
pub type W = crate::W<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        &mut self,
    ) -> NonsecSupvCacheableW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure user cacheable allowed."]
    ...
    pub fn nonsec_user_cacheable(
        &mut self,
    ) -> NonsecUserCacheableW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
...
Allowed privid."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec> {
        PrivIdW::new(self, 16)
    }
}
#[doc = "The FW Region 5 Permission 1 Register defines the permissions for the slave br_SCRP_32b_motor_to_SCRP_32b_miscIO_l0 region 5 firewall.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fw_regs_br_scrp_32b_motor_to_scrp_32b_misc_io_l0_fw_region_5_permission_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fw_regs_br_scrp_32b_motor_to_scrp_32b_misc_io_l0_fw_region_5_permission_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec;
impl crate::RegisterSpec for FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_br_scrp_32b_motor_to_scrp_32b_misc_io_l0_fw_region_5_permission_1::R`](R) reader structure"]
impl crate::Readable for FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_br_scrp_32b_motor_to_scrp_32b_misc_io_l0_fw_region_5_permission_1::W`](W) writer structure"]
impl crate::Writable for FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_br_SCRP_32b_motor_to_SCRP_32b_miscIO_l0_fw_region_5_permission_1 to value 0"]
impl crate::Resettable for FwRegsBrScrp32bMotorToScrp32bMiscIoL0FwRegion5Permission1Spec {
