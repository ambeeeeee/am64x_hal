#[doc = "Register `FW_REGS_br_SCRP_32b_motor_to_SCRP0_32b_clk4_l0_fw_region_7_control` reader"]
pub type R = crate::R<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec>;
#[doc = "Register `FW_REGS_br_SCRP_32b_motor_to_SCRP0_32b_clk4_l0_fw_region_7_control` writer"]
pub type W = crate::W<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set region values cannot be modified."]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 8 - 8:8\\]
Background enable for region. There can be 1 backgroun region per FW and foreground regions can have overlapping addresses only with the background region."]
    ...
    pub fn background(
        &mut self,
    ) -> BackgroundW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec> {
...
Cache mode for region. Set to 1 to check cache permissions. Set to 0 to ignore cache permissions."]
    ...
    pub fn cache_mode(
        &mut self,
    ) -> CacheModeW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec> {
...
pub struct FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec;
impl crate::RegisterSpec for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_br_scrp_32b_motor_to_scrp0_32b_clk4_l0_fw_region_7_control::R`](R) reader structure"]
impl crate::Readable for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_br_scrp_32b_motor_to_scrp0_32b_clk4_l0_fw_region_7_control::W`](W) writer structure"]
impl crate::Writable for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_br_SCRP_32b_motor_to_SCRP0_32b_clk4_l0_fw_region_7_control to value 0"]
impl crate::Resettable for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion7ControlSpec {
