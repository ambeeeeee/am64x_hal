#[doc = "Register `FW_REGS_br_SCRP_32b_motor_to_SCRP0_32b_clk4_l0_fw_region_1_permission_2` reader"]
pub type R = crate::R<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec>;
#[doc = "Register `FW_REGS_br_SCRP_32b_motor_to_SCRP0_32b_clk4_l0_fw_region_1_permission_2` writer"]
pub type W = crate::W<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        &mut self,
    ) -> NonsecSupvCacheableW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure user cacheable allowed."]
    ...
    pub fn nonsec_user_cacheable(
        &mut self,
    ) -> NonsecUserCacheableW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
...
Allowed privid."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec> {
        PrivIdW::new(self, 16)
    }
}
...
pub struct FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec;
impl crate::RegisterSpec for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_br_scrp_32b_motor_to_scrp0_32b_clk4_l0_fw_region_1_permission_2::R`](R) reader structure"]
impl crate::Readable for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_br_scrp_32b_motor_to_scrp0_32b_clk4_l0_fw_region_1_permission_2::W`](W) writer structure"]
impl crate::Writable for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_br_SCRP_32b_motor_to_SCRP0_32b_clk4_l0_fw_region_1_permission_2 to value 0"]
impl crate::Resettable for FwRegsBrScrp32bMotorToScrp0_32bClk4L0FwRegion1Permission2Spec {
