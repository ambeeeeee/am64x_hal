#[doc = "Register `REGS1_MAILBOX_IRQ_ENABLE_CLR` reader"]
pub type R = crate::R<Regs1MailboxIrqEnableClrSpec>;
#[doc = "Register `REGS1_MAILBOX_IRQ_ENABLE_CLR` writer"]
pub type W = crate::W<Regs1MailboxIrqEnableClrSpec>;
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb0(&mut self) -> Newmsgenablemb0W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb0(&mut self) -> Notfullenablemb0W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb1(&mut self) -> Newmsgenablemb1W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb1(&mut self) -> Notfullenablemb1W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb2(&mut self) -> Newmsgenablemb2W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb2(&mut self) -> Notfullenablemb2W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb3(&mut self) -> Newmsgenablemb3W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb3(&mut self) -> Notfullenablemb3W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb4(&mut self) -> Newmsgenablemb4W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb4(&mut self) -> Notfullenablemb4W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb5(&mut self) -> Newmsgenablemb5W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb5(&mut self) -> Notfullenablemb5W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb6(&mut self) -> Newmsgenablemb6W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb6(&mut self) -> Notfullenablemb6W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb7(&mut self) -> Newmsgenablemb7W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb7(&mut self) -> Notfullenablemb7W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb8(&mut self) -> Newmsgenablemb8W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb8(&mut self) -> Notfullenablemb8W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb9(&mut self) -> Newmsgenablemb9W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb9(&mut self) -> Notfullenablemb9W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb10(&mut self) -> Newmsgenablemb10W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb10(&mut self) -> Notfullenablemb10W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb11(&mut self) -> Newmsgenablemb11W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb11(&mut self) -> Notfullenablemb11W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb12(&mut self) -> Newmsgenablemb12W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb12(&mut self) -> Notfullenablemb12W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb13(&mut self) -> Newmsgenablemb13W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb13(&mut self) -> Notfullenablemb13W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb14(&mut self) -> Newmsgenablemb14W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb14(&mut self) -> Notfullenablemb14W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn newmsgenablemb15(&mut self) -> Newmsgenablemb15W<Regs1MailboxIrqEnableClrSpec> {
...
Read value is current enable state for this interrupt. Write 1 disables the interrupt. Write 0 does nothing."]
    #[inline(always)]
    #[must_use]
    pub fn notfullenablemb15(&mut self) -> Notfullenablemb15W<Regs1MailboxIrqEnableClrSpec> {
        Notfullenablemb15W::new(self, 31)
    }
}
#[doc = "The interrupt enable register allows software to mask/unmask the module internal source of interrupt for the user \\[a\\]. Read value is the current enable bits for each interrupt sourc. Write 1 to a bit disables an interrupt source. Write 0 has no effect.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`regs1_mailbox_irq_enable_clr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`regs1_mailbox_irq_enable_clr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Regs1MailboxIrqEnableClrSpec;
impl crate::RegisterSpec for Regs1MailboxIrqEnableClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regs1_mailbox_irq_enable_clr::R`](R) reader structure"]
impl crate::Readable for Regs1MailboxIrqEnableClrSpec {}
#[doc = "`write(|w| ..)` method takes [`regs1_mailbox_irq_enable_clr::W`](W) writer structure"]
impl crate::Writable for Regs1MailboxIrqEnableClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets REGS1_MAILBOX_IRQ_ENABLE_CLR to value 0"]
impl crate::Resettable for Regs1MailboxIrqEnableClrSpec {
