...
Raw Timeout Error Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<CfgErrRawSpec> {
        TimeoutW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Raw Unexpected Error Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn unexp(&mut self) -> UnexpW<CfgErrRawSpec> {
        UnexpW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Raw Command Error Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cmd(&mut self) -> CmdW<CfgErrRawSpec> {
        CmdW::new(self, 2)
    }
}
