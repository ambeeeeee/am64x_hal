#[doc = "Register `PKTDMA_GCFG_REVISION` reader"]
pub type R = crate::R<PktdmaGcfgRevisionSpec>;
#[doc = "Register `PKTDMA_GCFG_REVISION` writer"]
pub type W = crate::W<PktdmaGcfgRevisionSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn revmin(&mut self) -> RevminW<PktdmaGcfgRevisionSpec> {
        RevminW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<PktdmaGcfgRevisionSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn revmaj(&mut self) -> RevmajW<PktdmaGcfgRevisionSpec> {
        RevmajW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release."]
    #[inline(always)]
    #[must_use]
    pub fn revrtl(&mut self) -> RevrtlW<PktdmaGcfgRevisionSpec> {
        RevrtlW::new(self, 11)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Module ID field"]
    #[inline(always)]
    #[must_use]
    pub fn modid(&mut self) -> ModidW<PktdmaGcfgRevisionSpec> {
        ModidW::new(self, 16)
    }
}
#[doc = "The Revision Register contains the major and minor revisions for the module.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pktdma_gcfg_revision::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pktdma_gcfg_revision::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PktdmaGcfgRevisionSpec;
impl crate::RegisterSpec for PktdmaGcfgRevisionSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pktdma_gcfg_revision::R`](R) reader structure"]
impl crate::Readable for PktdmaGcfgRevisionSpec {}
#[doc = "`write(|w| ..)` method takes [`pktdma_gcfg_revision::W`](W) writer structure"]
impl crate::Writable for PktdmaGcfgRevisionSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PKTDMA_GCFG_REVISION to value 0x4101"]
impl crate::Resettable for PktdmaGcfgRevisionSpec {
    const RESET_VALUE: u32 = 0x4101;
}
