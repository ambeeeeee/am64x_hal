#[doc = "Register `BCDMA_BCHANRT_TRT_STATUS2` reader"]
pub type R = crate::R<BcdmaBchanrtTrtStatus2Spec>;
#[doc = "Register `BCDMA_BCHANRT_TRT_STATUS2` writer"]
pub type W = crate::W<BcdmaBchanrtTrtStatus2Spec>;
...
The channel is trying to schedule an error event"]
    #[inline(always)]
    #[must_use]
    pub fn err_event_reqs(&mut self) -> ErrEventReqsW<BcdmaBchanrtTrtStatus2Spec> {
...
The channel is sending a schedule request"]
    #[inline(always)]
    #[must_use]
    pub fn rx_reqs(&mut self) -> RxReqsW<BcdmaBchanrtTrtStatus2Spec> {
        RxReqsW::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
A teardown message is pending"]
    #[inline(always)]
    #[must_use]
    pub fn tdown_msg_pend(&mut self) -> TdownMsgPendW<BcdmaBchanrtTrtStatus2Spec> {
...
The fifo for the channel has space to place a burst size entry"]
    #[inline(always)]
    #[must_use]
    pub fn wavail(&mut self) -> WavailW<BcdmaBchanrtTrtStatus2Spec> {
        WavailW::new(self, 21)
    }
    #[doc = "Bit 22 - 22:22\\]
The channel is ready to be scheduled"]
    #[inline(always)]
    #[must_use]
    pub fn ok(&mut self) -> OkW<BcdmaBchanrtTrtStatus2Spec> {
        OkW::new(self, 22)
    }
    #[doc = "Bit 23 - 23:23\\]
The channel is currently in a packet"]
    #[inline(always)]
    #[must_use]
    pub fn in_packet(&mut self) -> InPacketW<BcdmaBchanrtTrtStatus2Spec> {
...
The channel has an outstanding transaction"]
    #[inline(always)]
    #[must_use]
    pub fn transbusy(&mut self) -> TransbusyW<BcdmaBchanrtTrtStatus2Spec> {
...
The channel is busy"]
    #[inline(always)]
    #[must_use]
    pub fn busy(&mut self) -> BusyW<BcdmaBchanrtTrtStatus2Spec> {
        BusyW::new(self, 25)
    }
    #[doc = "Bit 28 - 28:28\\]
There is an outstanding pktid for the channel"]
    #[inline(always)]
    #[must_use]
    pub fn pktid_busy(&mut self) -> PktidBusyW<BcdmaBchanrtTrtStatus2Spec> {
...
The channel has an available packet id"]
    #[inline(always)]
    #[must_use]
    pub fn pktid_avail(&mut self) -> PktidAvailW<BcdmaBchanrtTrtStatus2Spec> {
...
The channel fifo is available"]
    #[inline(always)]
    #[must_use]
    pub fn rxq_pend(&mut self) -> RxqPendW<BcdmaBchanrtTrtStatus2Spec> {
...
The channel ring has a descriptor"]
    #[inline(always)]
    #[must_use]
    pub fn rring_pend(&mut self) -> RringPendW<BcdmaBchanrtTrtStatus2Spec> {
        RringPendW::new(self, 31)
    }
}
#[doc = "The Status Register provides a read only view of channel status bits.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bcdma_bchanrt_trt_status2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bcdma_bchanrt_trt_status2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BcdmaBchanrtTrtStatus2Spec;
impl crate::RegisterSpec for BcdmaBchanrtTrtStatus2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bcdma_bchanrt_trt_status2::R`](R) reader structure"]
impl crate::Readable for BcdmaBchanrtTrtStatus2Spec {}
#[doc = "`write(|w| ..)` method takes [`bcdma_bchanrt_trt_status2::W`](W) writer structure"]
impl crate::Writable for BcdmaBchanrtTrtStatus2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BCDMA_BCHANRT_TRT_STATUS2 to value 0"]
impl crate::Resettable for BcdmaBchanrtTrtStatus2Spec {
