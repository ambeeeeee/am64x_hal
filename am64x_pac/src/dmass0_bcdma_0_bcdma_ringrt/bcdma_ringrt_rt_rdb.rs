#[doc = "Register `BCDMA_RINGRT_RT_RDB` reader"]
pub type R = crate::R<BcdmaRingrtRtRdbSpec>;
#[doc = "Register `BCDMA_RINGRT_RT_RDB` writer"]
pub type W = crate::W<BcdmaRingrtRtRdbSpec>;
...
Signed number of entries by which to increment the ring occupancy. For normal Tx Ring operation, this value should be a positive number. This occ value for the ring is increased by this value each time the doorbell register is written (occ absolute value will increase or decrease based on the sign of the tentry_cnt)."]
    #[inline(always)]
    #[must_use]
    pub fn entry_cnt(&mut self) -> EntryCntW<BcdmaRingrtRtRdbSpec> {
...
This bit is set to 1 to ackowledge (and clear) the tdown_complete bit in the corresponding Ring N Occupancy Register. this bit is only valid on the reverse rings (rings consumed by the Host SW)"]
    #[inline(always)]
    #[must_use]
    pub fn tdown_ack(&mut self) -> TdownAckW<BcdmaRingrtRtRdbSpec> {
        TdownAckW::new(self, 31)
    }
}
#[doc = "The Ring N Doorbell Register is written by software to increment or decrement the number of entries on a Ring. One or more entries as specified by the entry_cnt field can be added to a ring with a single write operation.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bcdma_ringrt_rt_rdb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bcdma_ringrt_rt_rdb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BcdmaRingrtRtRdbSpec;
impl crate::RegisterSpec for BcdmaRingrtRtRdbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bcdma_ringrt_rt_rdb::R`](R) reader structure"]
impl crate::Readable for BcdmaRingrtRtRdbSpec {}
#[doc = "`write(|w| ..)` method takes [`bcdma_ringrt_rt_rdb::W`](W) writer structure"]
impl crate::Writable for BcdmaRingrtRtRdbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BCDMA_RINGRT_RT_RDB to value 0"]
impl crate::Resettable for BcdmaRingrtRtRdbSpec {
