#[doc = "Register `APBADDR_PMU_CPU0_PMINTENCLR_EL1` reader"]
pub type R = crate::R<ApbaddrPmuCpu0PmintenclrEl1Spec>;
#[doc = "Register `APBADDR_PMU_CPU0_PMINTENCLR_EL1` writer"]
pub type W = crate::W<ApbaddrPmuCpu0PmintenclrEl1Spec>;
...
are RAZ/WI.Possible values are: 0 When read, means that the PMEVCNTR&lt;x>_EL0 event counter interrupt request is disabled. When written, has no effect. 1 When read, means that the PMEVCNTR&lt;x>_EL0 event counter interrupt request is enabled. When written, disables the PMEVCNTR&lt;x>_EL0 interrupt request."]
    #[inline(always)]
    #[must_use]
    pub fn p_x(&mut self) -> PXW<ApbaddrPmuCpu0PmintenclrEl1Spec> {
        PXW::new(self, 0)
    }
    #[doc = "Bit 31 - 31:31\\]
PMCCNTR_EL0 overflow interrupt request disable bit. Possible values are: 0 When read, means the cycle counter overflow interrupt request is disabled. When written, has no effect. 1 When read, means the cycle counter overflow interrupt request is enabled. When written, disables the cycle count overflow interrupt request."]
    #[inline(always)]
    #[must_use]
    pub fn c(&mut self) -> CW<ApbaddrPmuCpu0PmintenclrEl1Spec> {
        CW::new(self, 31)
    }
}
#[doc = "Performance Monitors Interrupt Enable Clear Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_pmu_cpu0_pmintenclr_el1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_pmu_cpu0_pmintenclr_el1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrPmuCpu0PmintenclrEl1Spec;
impl crate::RegisterSpec for ApbaddrPmuCpu0PmintenclrEl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu0_pmintenclr_el1::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu0PmintenclrEl1Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu0_pmintenclr_el1::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu0PmintenclrEl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU0_PMINTENCLR_EL1 to value 0"]
impl crate::Resettable for ApbaddrPmuCpu0PmintenclrEl1Spec {
