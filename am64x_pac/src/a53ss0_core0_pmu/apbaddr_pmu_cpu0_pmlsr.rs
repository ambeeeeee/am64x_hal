#[doc = "Register `APBADDR_PMU_CPU0_PMLSR` reader"]
pub type R = crate::R<ApbaddrPmuCpu0PmlsrSpec>;
#[doc = "Register `APBADDR_PMU_CPU0_PMLSR` writer"]
pub type W = crate::W<ApbaddrPmuCpu0PmlsrSpec>;
...
Software lock implemented. For an access to LSR that is not a memory-mapped access, this field is RAZ. For memory-mapped accesses, the value of this field is IMPLEMENTATION DEFINED. Permitted values are: 0 Software lock not implemented or not memory-mapped access. 1 Software lock implemented and memory-mapped access."]
    #[inline(always)]
    #[must_use]
    pub fn sli(&mut self) -> SliW<ApbaddrPmuCpu0PmlsrSpec> {
        SliW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software lock status for this component. For an access to LSR that is not a memory-mapped access, or when the software lock is not implemented, this field is RES0.For memory-mapped accesses when the software lock is implemented, possible values of this field are: 0 Lock clear. Writes are permitted to this component's registers. 1 Lock set. Writes to this component's registers are ignored, and reads have no side effects."]
    #[inline(always)]
    #[must_use]
    pub fn slk(&mut self) -> SlkW<ApbaddrPmuCpu0PmlsrSpec> {
        SlkW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Not thirty-two bit access required. RAZ."]
    #[inline(always)]
    #[must_use]
    pub fn ntt(&mut self) -> NttW<ApbaddrPmuCpu0PmlsrSpec> {
        NttW::new(self, 2)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_pmlsr_31_3(&mut self) -> Res0Pmlsr31_3W<ApbaddrPmuCpu0PmlsrSpec> {
        Res0Pmlsr31_3W::new(self, 3)
    }
}
#[doc = "Performance Monitors Lock Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_pmu_cpu0_pmlsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_pmu_cpu0_pmlsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrPmuCpu0PmlsrSpec;
impl crate::RegisterSpec for ApbaddrPmuCpu0PmlsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu0_pmlsr::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu0PmlsrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu0_pmlsr::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu0PmlsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU0_PMLSR to value 0x03"]
impl crate::Resettable for ApbaddrPmuCpu0PmlsrSpec {
