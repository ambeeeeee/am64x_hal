#[doc = "Register `APBADDR_PMU_CPU0_PMDEVARCH` reader"]
pub type R = crate::R<ApbaddrPmuCpu0PmdevarchSpec>;
#[doc = "Register `APBADDR_PMU_CPU0_PMDEVARCH` writer"]
pub type W = crate::W<ApbaddrPmuCpu0PmdevarchSpec>;
...
are the architecture part number, 0xA16.This corresponds to Performance Monitors architecture version PMUv3."]
    #[inline(always)]
    #[must_use]
    pub fn archid(&mut self) -> ArchidW<ApbaddrPmuCpu0PmdevarchSpec> {
        ArchidW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Defines the architecture revision. For architectures defined by ARM this is the minor revision.For Performance Monitors, the revision defined by v8-A is 0x0.All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrPmuCpu0PmdevarchSpec> {
...
When set to 1, indicates that the DEVARCH is present.This field is 1 in v8-A."]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PresentW<ApbaddrPmuCpu0PmdevarchSpec> {
...
are the JEP 106 ID code, 0x3B."]
    #[inline(always)]
    #[must_use]
    pub fn architect(&mut self) -> ArchitectW<ApbaddrPmuCpu0PmdevarchSpec> {
...
pub struct ApbaddrPmuCpu0PmdevarchSpec;
impl crate::RegisterSpec for ApbaddrPmuCpu0PmdevarchSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu0_pmdevarch::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu0PmdevarchSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu0_pmdevarch::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu0PmdevarchSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU0_PMDEVARCH to value 0xae31_0774"]
impl crate::Resettable for ApbaddrPmuCpu0PmdevarchSpec {
