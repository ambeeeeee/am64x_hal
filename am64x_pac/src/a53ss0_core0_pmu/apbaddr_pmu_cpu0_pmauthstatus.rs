#[doc = "Register `APBADDR_PMU_CPU0_PMAUTHSTATUS` reader"]
pub type R = crate::R<ApbaddrPmuCpu0PmauthstatusSpec>;
#[doc = "Register `APBADDR_PMU_CPU0_PMAUTHSTATUS` writer"]
pub type W = crate::W<ApbaddrPmuCpu0PmauthstatusSpec>;
...
Reserved, RES0."]
    ...
    pub fn res0_pmauthstatus_1_0(
        &mut self,
    ) -> Res0Pmauthstatus1_0W<ApbaddrPmuCpu0PmauthstatusSpec> {
...
Holds the same value as DBGAUTHSTATUS_EL1.NSNID."]
    #[inline(always)]
    #[must_use]
    pub fn nsnid(&mut self) -> NsnidW<ApbaddrPmuCpu0PmauthstatusSpec> {
        NsnidW::new(self, 2)
    }
    #[doc = "Bits 4:5 - 5:4\\]
Reserved, RES0."]
    ...
    pub fn res0_pmauthstatus_5_4(
        &mut self,
    ) -> Res0Pmauthstatus5_4W<ApbaddrPmuCpu0PmauthstatusSpec> {
...
Holds the same value as DBGAUTHSTATUS_EL1.SNID."]
    #[inline(always)]
    #[must_use]
    pub fn snid(&mut self) -> SnidW<ApbaddrPmuCpu0PmauthstatusSpec> {
        SnidW::new(self, 6)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Reserved, RES0."]
    ...
    pub fn res0_pmauthstatus_31_8(
        &mut self,
    ) -> Res0Pmauthstatus31_8W<ApbaddrPmuCpu0PmauthstatusSpec> {
        Res0Pmauthstatus31_8W::new(self, 8)
    }
}
#[doc = "Performance Monitors Authentication Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_pmu_cpu0_pmauthstatus::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_pmu_cpu0_pmauthstatus::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrPmuCpu0PmauthstatusSpec;
impl crate::RegisterSpec for ApbaddrPmuCpu0PmauthstatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_pmu_cpu0_pmauthstatus::R`](R) reader structure"]
impl crate::Readable for ApbaddrPmuCpu0PmauthstatusSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_pmu_cpu0_pmauthstatus::W`](W) writer structure"]
impl crate::Writable for ApbaddrPmuCpu0PmauthstatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_PMU_CPU0_PMAUTHSTATUS to value 0x88"]
impl crate::Resettable for ApbaddrPmuCpu0PmauthstatusSpec {
