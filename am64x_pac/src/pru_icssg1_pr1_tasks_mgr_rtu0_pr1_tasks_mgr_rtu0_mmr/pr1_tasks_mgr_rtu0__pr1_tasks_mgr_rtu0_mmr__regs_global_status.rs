#[doc = "Register `PR1_TASKS_MGR_RTU0__PR1_TASKS_MGR_RTU0_MMR__REGS_global_status` reader"]
pub type R = crate::R<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec>;
#[doc = "Register `PR1_TASKS_MGR_RTU0__PR1_TASKS_MGR_RTU0_MMR__REGS_global_status` writer"]
pub type W = crate::W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec>;
...
Task1 State"]
    ...
    pub fn ts1_state(
        &mut self,
    ) -> Ts1StateW<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task2 State"]
    ...
    pub fn ts2_state(
        &mut self,
    ) -> Ts2StateW<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task1 Sub0 Pend State"]
    ...
    pub fn ts1_sub_pend_0(
        &mut self,
    ) -> Ts1SubPend0W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task1 Sub1 Pend State"]
    ...
    pub fn ts1_sub_pend_1(
        &mut self,
    ) -> Ts1SubPend1W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task1 Sub2 Pend State"]
    ...
    pub fn ts1_sub_pend_2(
        &mut self,
    ) -> Ts1SubPend2W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task1 Sub3 Pend State"]
    ...
    pub fn ts1_sub_pend_3(
        &mut self,
    ) -> Ts1SubPend3W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task1 Sub4 Pend State"]
    ...
    pub fn ts1_sub_pend_4(
        &mut self,
    ) -> Ts1SubPend4W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task2 Sub0 Pend State"]
    ...
    pub fn ts2_sub_pend_0(
        &mut self,
    ) -> Ts2SubPend0W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task2 Sub1 Pend State"]
    ...
    pub fn ts2_sub_pend_1(
        &mut self,
    ) -> Ts2SubPend1W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task2 Sub2 Pend State"]
    ...
    pub fn ts2_sub_pend_2(
        &mut self,
    ) -> Ts2SubPend2W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task2 Sub3 Pend State"]
    ...
    pub fn ts2_sub_pend_3(
        &mut self,
    ) -> Ts2SubPend3W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
Task2 Sub4 Pend State"]
    ...
    pub fn ts2_sub_pend_4(
        &mut self,
    ) -> Ts2SubPend4W<Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec> {
...
pub struct Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec;
impl crate::RegisterSpec for Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_tasks_mgr_rtu0__pr1_tasks_mgr_rtu0_mmr__regs_global_status::R`](R) reader structure"]
impl crate::Readable for Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`pr1_tasks_mgr_rtu0__pr1_tasks_mgr_rtu0_mmr__regs_global_status::W`](W) writer structure"]
impl crate::Writable for Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_TASKS_MGR_RTU0__PR1_TASKS_MGR_RTU0_MMR__REGS_global_status to value 0"]
impl crate::Resettable for Pr1TasksMgrRtu0_Pr1TasksMgrRtu0Mmr_RegsGlobalStatusSpec {
