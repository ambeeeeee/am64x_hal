#[doc = "Register `REGS2_MAILBOX_IRQ_EOI` reader"]
pub type R = crate::R<Regs2MailboxIrqEoiSpec>;
#[doc = "Register `REGS2_MAILBOX_IRQ_EOI` writer"]
pub type W = crate::W<Regs2MailboxIrqEoiSpec>;
...
Software EOI signal for the user 0 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi0(&mut self) -> Eoi0W<Regs2MailboxIrqEoiSpec> {
        Eoi0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software EOI signal for the user 1 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi1(&mut self) -> Eoi1W<Regs2MailboxIrqEoiSpec> {
        Eoi1W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Software EOI signal for the user 2 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi2(&mut self) -> Eoi2W<Regs2MailboxIrqEoiSpec> {
        Eoi2W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Software EOI signal for the user 3 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi3(&mut self) -> Eoi3W<Regs2MailboxIrqEoiSpec> {
        Eoi3W::new(self, 3)
    }
}
#[doc = "This is the EOI register with which the software is enabled to do the interrupt clearance.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`regs2_mailbox_irq_eoi::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`regs2_mailbox_irq_eoi::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Regs2MailboxIrqEoiSpec;
impl crate::RegisterSpec for Regs2MailboxIrqEoiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regs2_mailbox_irq_eoi::R`](R) reader structure"]
impl crate::Readable for Regs2MailboxIrqEoiSpec {}
#[doc = "`write(|w| ..)` method takes [`regs2_mailbox_irq_eoi::W`](W) writer structure"]
impl crate::Writable for Regs2MailboxIrqEoiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets REGS2_MAILBOX_IRQ_EOI to value 0"]
impl crate::Resettable for Regs2MailboxIrqEoiSpec {
