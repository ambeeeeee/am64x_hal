#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel1_pru0` reader"]
pub type R = crate::R<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec>;
#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel1_pru0` writer"]
pub type W = crate::W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec>;
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel4(
        &mut self,
    ) -> RxRateSrcSel4W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec> {
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel5(
        &mut self,
    ) -> RxRateSrcSel5W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec> {
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel6(
        &mut self,
    ) -> RxRateSrcSel6W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec> {
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel7(
        &mut self,
    ) -> RxRateSrcSel7W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec> {
        RxRateSrcSel7W::new(self, 24)
    }
}
#[doc = "PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel1_pru0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel1_pru0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel1_pru0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec;
impl crate::RegisterSpec for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel1_pru0::R`](R) reader structure"]
impl crate::Readable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel1_pru0::W`](W) writer structure"]
impl crate::Writable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel1_pru0 to value 0"]
impl crate::Resettable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel1Pru0Spec {
