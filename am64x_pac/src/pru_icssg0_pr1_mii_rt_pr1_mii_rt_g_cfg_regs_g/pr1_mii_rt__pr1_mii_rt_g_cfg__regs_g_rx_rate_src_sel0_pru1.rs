#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel0_pru1` reader"]
pub type R = crate::R<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec>;
#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel0_pru1` writer"]
pub type W = crate::W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec>;
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel0(
        &mut self,
    ) -> RxRateSrcSel0W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec> {
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel1(
        &mut self,
    ) -> RxRateSrcSel1W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec> {
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel2(
        &mut self,
    ) -> RxRateSrcSel2W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec> {
...
Map which filter/flag/class hit that rate logic uses, see table for mapping"]
    ...
    pub fn rx_rate_src_sel3(
        &mut self,
    ) -> RxRateSrcSel3W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec> {
        RxRateSrcSel3W::new(self, 24)
    }
}
#[doc = "PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel0_pru1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel0_pru1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel0_pru1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec;
impl crate::RegisterSpec for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel0_pru1::R`](R) reader structure"]
impl crate::Readable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_rate_src_sel0_pru1::W`](W) writer structure"]
impl crate::Writable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_rate_src_sel0_pru1 to value 0"]
impl crate::Resettable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxRateSrcSel0Pru1Spec {
