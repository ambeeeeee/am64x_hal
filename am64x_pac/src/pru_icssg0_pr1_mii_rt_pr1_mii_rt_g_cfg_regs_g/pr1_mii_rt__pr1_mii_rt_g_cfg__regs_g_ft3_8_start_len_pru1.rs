#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_ft3_8_start_len_pru1` reader"]
pub type R = crate::R<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec>;
#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_ft3_8_start_len_pru1` writer"]
pub type W = crate::W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec>;
...
operation it will start on the next byte after FT3_T completes if set to zero"]
    #[inline(always)]
    #[must_use]
    pub fn ft3_offset(&mut self) -> Ft3OffsetW<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec> {
...
to start the compare"]
    ...
    pub fn ft3_offset_start(
        &mut self,
    ) -> Ft3OffsetStartW<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec> {
...
to end the compare at set the Valid flag, rule ft3_offset_end >= ft3_offset_start To disable pattern compare set start and end to zero"]
    ...
    pub fn ft3_offset_end(
        &mut self,
    ) -> Ft3OffsetEndW<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec> {
...
pub struct Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec;
impl crate::RegisterSpec for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_ft3_8_start_len_pru1::R`](R) reader structure"]
impl crate::Readable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_ft3_8_start_len_pru1::W`](W) writer structure"]
impl crate::Writable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_ft3_8_start_len_pru1 to value 0"]
impl crate::Resettable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_8StartLenPru1Spec {
