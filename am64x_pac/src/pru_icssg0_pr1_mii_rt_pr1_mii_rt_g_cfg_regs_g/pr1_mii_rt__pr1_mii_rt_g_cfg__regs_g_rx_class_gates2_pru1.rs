#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_class_gates2_pru1` reader"]
pub type R = crate::R<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec>;
#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_class_gates2_pru1` writer"]
pub type W = crate::W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec>;
...
defines which rx_rate will gate rx_class"]
    ...
    pub fn rx_rate_gate_sel2(
        &mut self,
    ) -> RxRateGateSel2W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec> {
...
time phase mask 0: unmask 1: mask"]
    ...
    pub fn rx_phase_mask2(
        &mut self,
    ) -> RxPhaseMask2W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec> {
...
class raw mask 0: unmask 1: mask"]
    ...
    pub fn rx_class_raw_mask2(
        &mut self,
    ) -> RxClassRawMask2W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec> {
...
allow mask 0: unmask 1: mask"]
    ...
    pub fn rx_allow_mask2(
        &mut self,
    ) -> RxAllowMask2W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec> {
...
red phase neable 0: disable 1: enable"]
    ...
    pub fn rx_red_phase_en2(
        &mut self,
    ) -> RxRedPhaseEn2W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec> {
...
pub struct Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec;
impl crate::RegisterSpec for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_class_gates2_pru1::R`](R) reader structure"]
impl crate::Readable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_rx_class_gates2_pru1::W`](W) writer structure"]
impl crate::Writable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_rx_class_gates2_pru1 to value 0x70"]
impl crate::Resettable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGRxClassGates2Pru1Spec {
