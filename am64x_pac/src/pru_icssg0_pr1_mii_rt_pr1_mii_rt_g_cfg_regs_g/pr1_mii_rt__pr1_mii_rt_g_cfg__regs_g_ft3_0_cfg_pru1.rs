#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_ft3_0_cfg_pru1` reader"]
pub type R = crate::R<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec>;
#[doc = "Register `PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_ft3_0_cfg_pru1` writer"]
pub type W = crate::W<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec>;
...
0: Disabled 1: EQ 2: GT 3: LT"]
    #[inline(always)]
    #[must_use]
    pub fn ft3_0cfg(&mut self) -> Ft3_0cfgW<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec> {
...
0: Disabled 1: Enable"]
    ...
    pub fn ft3_0_vlan_skip_en(
        &mut self,
    ) -> Ft3_0VlanSkipEnW<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec> {
...
Trigger ft3 select for auto skip enable, if one or more set the function is enabled note you can not slect the same ft3 only others"]
    ...
    pub fn ft3_0_trig_or_en(
        &mut self,
    ) -> Ft3_0TrigOrEnW<Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec> {
...
pub struct Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec;
impl crate::RegisterSpec for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_ft3_0_cfg_pru1::R`](R) reader structure"]
impl crate::Readable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec {}
#[doc = "`write(|w| ..)` method takes [`pr1_mii_rt__pr1_mii_rt_g_cfg__regs_g_ft3_0_cfg_pru1::W`](W) writer structure"]
impl crate::Writable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_MII_RT__PR1_MII_RT_G_CFG__REGS_G_ft3_0_cfg_pru1 to value 0x05"]
impl crate::Resettable for Pr1MiiRt_Pr1MiiRtGCfg_RegsGFt3_0CfgPru1Spec {
