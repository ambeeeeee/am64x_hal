#[doc = "Register `OSPI0__OSPI_CFG_VBUSP__MMR__MMRVBP__REGS_PID` reader"]
pub type R = crate::R<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec>;
#[doc = "Register `OSPI0__OSPI_CFG_VBUSP__MMR__MMRVBP__REGS_PID` writer"]
pub type W = crate::W<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn minor(&mut self) -> MinorW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
        MinorW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn major(&mut self) -> MajorW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
        MajorW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release."]
    #[inline(always)]
    #[must_use]
    pub fn rtl(&mut self) -> RtlW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
        RtlW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn module_id(&mut self) -> ModuleIdW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
...
Business Unit: 10 = Processors"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
PID register scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "The Revision Register contains the major and minor revisions for the module.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ospi0__ospi_cfg_vbusp__mmr__mmrvbp__regs_pid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ospi0__ospi_cfg_vbusp__mmr__mmrvbp__regs_pid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec;
impl crate::RegisterSpec for Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ospi0__ospi_cfg_vbusp__mmr__mmrvbp__regs_pid::R`](R) reader structure"]
impl crate::Readable for Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec {}
#[doc = "`write(|w| ..)` method takes [`ospi0__ospi_cfg_vbusp__mmr__mmrvbp__regs_pid::W`](W) writer structure"]
impl crate::Writable for Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets OSPI0__OSPI_CFG_VBUSP__MMR__MMRVBP__REGS_PID to value 0x6164_a900"]
impl crate::Resettable for Ospi0_OspiCfgVbusp_Mmr_Mmrvbp_RegsPidSpec {
    const RESET_VALUE: u32 = 0x6164_a900;
}
