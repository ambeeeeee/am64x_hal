...
Interrupt Pending Status for tpcf0_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn tpcf0_ramecc_pend(&mut self) -> Tpcf0RameccPendW<RegsSecStatusReg0Spec> {
...
Interrupt Pending Status for tpcf1_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn tpcf1_ramecc_pend(&mut self) -> Tpcf1RameccPendW<RegsSecStatusReg0Spec> {
...
Interrupt Pending Status for rpcf0_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn rpcf0_ramecc_pend(&mut self) -> Rpcf0RameccPendW<RegsSecStatusReg0Spec> {
...
Interrupt Pending Status for rpcf1_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn rpcf1_ramecc_pend(&mut self) -> Rpcf1RameccPendW<RegsSecStatusReg0Spec> {
