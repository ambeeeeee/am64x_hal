#[doc = "Register `REGS3_MAILBOX_ID` reader"]
pub type R = crate::R<Regs3MailboxIdSpec>;
#[doc = "Register `REGS3_MAILBOX_ID` writer"]
pub type W = crate::W<Regs3MailboxIdSpec>;
...
Minor revision. Y of X.Y.R.Z"]
    #[inline(always)]
    #[must_use]
    pub fn minor_rev(&mut self) -> MinorRevW<Regs3MailboxIdSpec> {
...
Special version number"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<Regs3MailboxIdSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision. X of X.Y.R.Z"]
    #[inline(always)]
    #[must_use]
    pub fn major_rev(&mut self) -> MajorRevW<Regs3MailboxIdSpec> {
...
RTL version. R of X.Y.R.Z"]
    #[inline(always)]
    #[must_use]
    pub fn rtl_ver(&mut self) -> RtlVerW<Regs3MailboxIdSpec> {
        RtlVerW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module family."]
    #[inline(always)]
    #[must_use]
    pub fn function(&mut self) -> FunctionW<Regs3MailboxIdSpec> {
...
BU identifier"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<Regs3MailboxIdSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
Used to distinguish which ID numbering scheme is used."]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<Regs3MailboxIdSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "This is the standard TI peripheral ID register that exists at address 0 in the peripheral space\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`regs3_mailbox_id::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`regs3_mailbox_id::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Regs3MailboxIdSpec;
impl crate::RegisterSpec for Regs3MailboxIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regs3_mailbox_id::R`](R) reader structure"]
impl crate::Readable for Regs3MailboxIdSpec {}
#[doc = "`write(|w| ..)` method takes [`regs3_mailbox_id::W`](W) writer structure"]
impl crate::Writable for Regs3MailboxIdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets REGS3_MAILBOX_ID to value 0x7788_b900"]
impl crate::Resettable for Regs3MailboxIdSpec {
