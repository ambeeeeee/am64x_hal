#[doc = "Register `CFG_CH3STAT` reader"]
pub type R = crate::R<CfgCh3statSpec>;
#[doc = "Register `CFG_CH3STAT` writer"]
pub type W = crate::W<CfgCh3statSpec>;
...
Channel i Receiver Register Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxs(&mut self) -> RxsW<CfgCh3statSpec> {
        RxsW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Channel i Transmitter Register Status"]
    #[inline(always)]
    #[must_use]
    pub fn txs(&mut self) -> TxsW<CfgCh3statSpec> {
        TxsW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Channel i End of transfer Status The definitions of beginning and end of transfer vary with master versus slave and the transfer format \\[Transmit/Receive modes, Turbo mode\\]
See dedicated chapters for details"]
    #[inline(always)]
    #[must_use]
    pub fn eot(&mut self) -> EotW<CfgCh3statSpec> {
        EotW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Channel i FIFO Transmit Buffer Empty Status"]
    #[inline(always)]
    #[must_use]
    pub fn txffe(&mut self) -> TxffeW<CfgCh3statSpec> {
        TxffeW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Channel i FIFO Transmit Buffer Full Status"]
    #[inline(always)]
    #[must_use]
    pub fn txfff(&mut self) -> TxfffW<CfgCh3statSpec> {
        TxfffW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Channel i FIFO Receive Buffer Empty Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxffe(&mut self) -> RxffeW<CfgCh3statSpec> {
        RxffeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Channel i FIFO Receive Buffer Full Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxfff(&mut self) -> RxfffW<CfgCh3statSpec> {
        RxfffW::new(self, 6)
    }
}
#[doc = "This register provides status information about transmitter and receiver registers of channel 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_ch3stat::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_ch3stat::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgCh3statSpec;
impl crate::RegisterSpec for CfgCh3statSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_ch3stat::R`](R) reader structure"]
impl crate::Readable for CfgCh3statSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_ch3stat::W`](W) writer structure"]
impl crate::Writable for CfgCh3statSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_CH3STAT to value 0"]
impl crate::Resettable for CfgCh3statSpec {
