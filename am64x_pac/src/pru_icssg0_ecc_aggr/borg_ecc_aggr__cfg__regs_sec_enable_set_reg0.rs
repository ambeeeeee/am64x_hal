#[doc = "Register `BORG_ECC_AGGR__CFG__REGS_sec_enable_set_reg0` reader"]
pub type R = crate::R<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec>;
#[doc = "Register `BORG_ECC_AGGR__CFG__REGS_sec_enable_set_reg0` writer"]
pub type W = crate::W<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec>;
...
Interrupt Enable Set Register for pr1_dram0_pend"]
    ...
    pub fn pr1_dram0_enable_set(
        &mut self,
    ) -> Pr1Dram0EnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_dram1_pend"]
    ...
    pub fn pr1_dram1_enable_set(
        &mut self,
    ) -> Pr1Dram1EnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_pdsp0_iram_pend"]
    ...
    pub fn pr1_pdsp0_iram_enable_set(
        &mut self,
    ) -> Pr1Pdsp0IramEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_pdsp1_iram_pend"]
    ...
    pub fn pr1_pdsp1_iram_enable_set(
        &mut self,
    ) -> Pr1Pdsp1IramEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_ram_pend"]
    ...
    pub fn pr1_ram_enable_set(
        &mut self,
    ) -> Pr1RamEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_rtu0_iram_ecc_pend"]
    ...
    pub fn pr1_rtu0_iram_ecc_enable_set(
        &mut self,
    ) -> Pr1Rtu0IramEccEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_rtu1_iram_ecc_pend"]
    ...
    pub fn pr1_rtu1_iram_ecc_enable_set(
        &mut self,
    ) -> Pr1Rtu1IramEccEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_pdsp_tx0_iram_pend"]
    ...
    pub fn pr1_pdsp_tx0_iram_enable_set(
        &mut self,
    ) -> Pr1PdspTx0IramEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for pr1_pdsp_tx1_iram_pend"]
    ...
    pub fn pr1_pdsp_tx1_iram_enable_set(
        &mut self,
    ) -> Pr1PdspTx1IramEnableSetW<BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec> {
        Pr1PdspTx1IramEnableSetW::new(self, 8)
    }
}
#[doc = "Interrupt Enable Set Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`borg_ecc_aggr__cfg__regs_sec_enable_set_reg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`borg_ecc_aggr__cfg__regs_sec_enable_set_reg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec;
impl crate::RegisterSpec for BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`borg_ecc_aggr__cfg__regs_sec_enable_set_reg0::R`](R) reader structure"]
impl crate::Readable for BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`borg_ecc_aggr__cfg__regs_sec_enable_set_reg0::W`](W) writer structure"]
impl crate::Writable for BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BORG_ECC_AGGR__CFG__REGS_sec_enable_set_reg0 to value 0"]
impl crate::Resettable for BorgEccAggr_Cfg_RegsSecEnableSetReg0Spec {
