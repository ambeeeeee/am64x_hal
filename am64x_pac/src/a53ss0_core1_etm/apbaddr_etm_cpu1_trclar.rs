#[doc = "Register `APBADDR_ETM_CPU1_TRCLAR` reader"]
pub type R = crate::R<ApbaddrEtmCpu1TrclarSpec>;
#[doc = "Register `APBADDR_ETM_CPU1_TRCLAR` writer"]
pub type W = crate::W<ApbaddrEtmCpu1TrclarSpec>;
...
Writing the key value 0xC5ACCE55 to this field clears the lock, enabling write accesses to this component's registers through a memory-mapped interface.Writing any other value to this register sets the lock, disabling write accesses to this component's registers through a memory mapped interface.Software can use the Software Lock to prevent accidental modification of the trace unit registers by software being debugged. For example, software that accidentally initializes an incorrect region of memory might disable the trace unit and make it impossible to trace the software."]
    #[inline(always)]
    #[must_use]
    pub fn key(&mut self) -> KeyW<ApbaddrEtmCpu1TrclarSpec> {
        KeyW::new(self, 0)
    }
}
#[doc = "Software Lock Access Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu1_trclar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu1_trclar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu1TrclarSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu1TrclarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu1_trclar::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu1TrclarSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu1_trclar::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu1TrclarSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU1_TRCLAR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu1TrclarSpec {
