#[doc = "Register `APBADDR_ETM_CPU1_TRCPDSR` reader"]
pub type R = crate::R<ApbaddrEtmCpu1TrcpdsrSpec>;
#[doc = "Register `APBADDR_ETM_CPU1_TRCPDSR` writer"]
pub type W = crate::W<ApbaddrEtmCpu1TrcpdsrSpec>;
...
Power status bit: 0 The trace unit core power domain is not powered. The trace registers are not accessible and they all return an error response. 1 The trace unit core power domain is powered. The trace registers are accessible."]
    #[inline(always)]
    #[must_use]
    pub fn power(&mut self) -> PowerW<ApbaddrEtmCpu1TrcpdsrSpec> {
        PowerW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Sticky powerdown status bit. Indicates whether the trace register state is valid: 0 If POWER==1 then the state of TRCOSLSR and the trace registers are valid. If POWER==0 then it is UNKNOWN whether the state of TRCOSLSR and the trace registers are valid. 1 The state of TRCOSLSR and the trace registers might not be valid. The trace unit sets this bit to 1 if either the trace unit is reset, or the power to the trace unit core power domain is removed and the trace register state is not valid. After this register is read, if the Software Lock is unlocked and the trace unit core power domain is powered up, then the trace unit sets this bit to 0. The TRCLAR controls whether the Software Lock is locked."]
    #[inline(always)]
    #[must_use]
    pub fn stickypd(&mut self) -> StickypdW<ApbaddrEtmCpu1TrcpdsrSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcpdsr_4_2(&mut self) -> Res0Trcpdsr4_2W<ApbaddrEtmCpu1TrcpdsrSpec> {
...
OS Lock status bit: 0 The OS Lock is unlocked. 1 The OS Lock is locked. The value is UNKNOWN when the trace unit core power domain is powered down, that is, when POWER==0."]
    #[inline(always)]
    #[must_use]
    pub fn locked(&mut self) -> LockedW<ApbaddrEtmCpu1TrcpdsrSpec> {
        LockedW::new(self, 5)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcpdsr_31_6(&mut self) -> Res0Trcpdsr31_6W<ApbaddrEtmCpu1TrcpdsrSpec> {
        Res0Trcpdsr31_6W::new(self, 6)
    }
}
#[doc = "Power Down Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu1_trcpdsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu1_trcpdsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu1TrcpdsrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu1TrcpdsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu1_trcpdsr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu1TrcpdsrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu1_trcpdsr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu1TrcpdsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU1_TRCPDSR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu1TrcpdsrSpec {
