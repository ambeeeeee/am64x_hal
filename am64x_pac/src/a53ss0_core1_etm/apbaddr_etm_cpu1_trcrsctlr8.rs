#[doc = "Register `APBADDR_ETM_CPU1_TRCRSCTLR8` reader"]
pub type R = crate::R<ApbaddrEtmCpu1Trcrsctlr8Spec>;
#[doc = "Register `APBADDR_ETM_CPU1_TRCRSCTLR8` writer"]
pub type W = crate::W<ApbaddrEtmCpu1Trcrsctlr8Spec>;
...
Selects one or more resources from the group that the GROUP field selects. Each bit represents a resource from the selected group.See the GROUP field description for details."]
    #[inline(always)]
    #[must_use]
    pub fn select(&mut self) -> SelectW<ApbaddrEtmCpu1Trcrsctlr8Spec> {
        SelectW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Selects a group of resources. Possible values are: 0000 For SELECT bits 0 to 3, selects external input selector 0 to 3; other bits are reserved. 0001 For SELECT bits 0 to 7, selects processor comparator inputs 0 to 7; other bits are reserved. 0010 For SELECT bits 0 to 3, selects counter at zero 0 to 3; for SELECT bits 4 to 7, selects sequencer states 0 to 3; other bits are reserved. 0011 For SELECT bits 0 to 7, selects single-shot comparator control 0 to 7; other bits are reserved. 0100 For SELECT bits 0 to 15, selects single address comparator 0 to 15. 0101 For SELECT bits 0 to 7, selects address range comparator 0 to 7; other bits are reserved. 0110 For SELECT bits 0 to 7, selects Context ID comparator 0 to 7; other bits are reserved. 0111 For SELECT bits 0 to 7, selects VMID comparator 0 to 7; other bits are reserved. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn group(&mut self) -> GroupW<ApbaddrEtmCpu1Trcrsctlr8Spec> {
        GroupW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Controls whether the resource that GROUP and SELECT selects is inverted: 0 The selected resource is not inverted. 1 The selected resource is inverted."]
    #[inline(always)]
    #[must_use]
    pub fn inv(&mut self) -> InvW<ApbaddrEtmCpu1Trcrsctlr8Spec> {
        InvW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
If n is an even number, controls whether the combined result from a resource pair is inverted: 0 The combined result is not inverted. 1 The combined result is inverted. If n is an odd number, this field is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn pairinv(&mut self) -> PairinvW<ApbaddrEtmCpu1Trcrsctlr8Spec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcrsctlr8_31_22(&mut self) -> Res0Trcrsctlr8_31_22W<ApbaddrEtmCpu1Trcrsctlr8Spec> {
        Res0Trcrsctlr8_31_22W::new(self, 22)
    }
}
#[doc = "Resource Selection Control Registers 8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu1_trcrsctlr8::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu1_trcrsctlr8::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu1Trcrsctlr8Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu1Trcrsctlr8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu1_trcrsctlr8::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu1Trcrsctlr8Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu1_trcrsctlr8::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu1Trcrsctlr8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU1_TRCRSCTLR8 to value 0"]
impl crate::Resettable for ApbaddrEtmCpu1Trcrsctlr8Spec {
