#[doc = "Register `APBADDR_ETM_CPU1_TRCCNTCTLR0` reader"]
pub type R = crate::R<ApbaddrEtmCpu1Trccntctlr0Spec>;
#[doc = "Register `APBADDR_ETM_CPU1_TRCCNTCTLR0` writer"]
pub type W = crate::W<ApbaddrEtmCpu1Trccntctlr0Spec>;
...
Selects an event, that when it occurs causes counter &lt;n> to decrement."]
    #[inline(always)]
    #[must_use]
    pub fn cntevent_n(&mut self) -> CnteventNW<ApbaddrEtmCpu1Trccntctlr0Spec> {
...
Selects an event, that when it occurs causes a reload event for counter &lt;n>."]
    #[inline(always)]
    #[must_use]
    pub fn rldevent_n(&mut self) -> RldeventNW<ApbaddrEtmCpu1Trccntctlr0Spec> {
...
Controls whether a reload event occurs for counter &lt;n>, when counter &lt;n> reaches zero: 0 The trace unit does not generate a reload event. 1 The trace unit generates a reload event for counter &lt;n>, provided that the event resource that CNTEVENT&lt;n> specifies is active."]
    #[inline(always)]
    #[must_use]
    pub fn rldself_n(&mut self) -> RldselfNW<ApbaddrEtmCpu1Trccntctlr0Spec> {
...
For TRCCNTCTLR3 and TRCCNTCTLR1, controls whether counter &lt;n> decrements when a reload event occurs for counter &lt;n-1>: 0 1 For TRCCNTCTLR2 and TRCCNTCTLR0, this bit is RES0."]
    #[inline(always)]
    #[must_use]
    pub fn cntchain_n(&mut self) -> CntchainNW<ApbaddrEtmCpu1Trccntctlr0Spec> {
...
Reserved, RES0."]
    ...
    pub fn res0_trccntctlr0_31_18(
        &mut self,
    ) -> Res0Trccntctlr0_31_18W<ApbaddrEtmCpu1Trccntctlr0Spec> {
        Res0Trccntctlr0_31_18W::new(self, 18)
    }
}
#[doc = "Counter Control Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu1_trccntctlr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu1_trccntctlr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu1Trccntctlr0Spec;
impl crate::RegisterSpec for ApbaddrEtmCpu1Trccntctlr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu1_trccntctlr0::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu1Trccntctlr0Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu1_trccntctlr0::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu1Trccntctlr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU1_TRCCNTCTLR0 to value 0"]
impl crate::Resettable for ApbaddrEtmCpu1Trccntctlr0Spec {
