#[doc = "Register `APBADDR_ETM_CPU1_TRCCCCTLR` reader"]
pub type R = crate::R<ApbaddrEtmCpu1TrcccctlrSpec>;
#[doc = "Register `APBADDR_ETM_CPU1_TRCCCCTLR` writer"]
pub type W = crate::W<ApbaddrEtmCpu1TrcccctlrSpec>;
...
Sets the threshold value for instruction trace cycle counting.The minimum threshold value that can be programmed into THRESHOLD is given in TRCIDR3.CCITMIN.Writing a value of zero might cause UNPREDICTABLE behaviour."]
    #[inline(always)]
    #[must_use]
    pub fn threshold(&mut self) -> ThresholdW<ApbaddrEtmCpu1TrcccctlrSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_trcccctlr_31_12(&mut self) -> Res0Trcccctlr31_12W<ApbaddrEtmCpu1TrcccctlrSpec> {
        Res0Trcccctlr31_12W::new(self, 12)
    }
}
#[doc = "Cycle Count Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu1_trcccctlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu1_trcccctlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu1TrcccctlrSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu1TrcccctlrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu1_trcccctlr::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu1TrcccctlrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu1_trcccctlr::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu1TrcccctlrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU1_TRCCCCTLR to value 0"]
impl crate::Resettable for ApbaddrEtmCpu1TrcccctlrSpec {
