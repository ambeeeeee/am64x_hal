#[doc = "Register `APBADDR_ETM_CPU1_TRCAUTHSTATUS` reader"]
pub type R = crate::R<ApbaddrEtmCpu1TrcauthstatusSpec>;
#[doc = "Register `APBADDR_ETM_CPU1_TRCAUTHSTATUS` writer"]
pub type W = crate::W<ApbaddrEtmCpu1TrcauthstatusSpec>;
...
Indicates whether the trace unit supports Non-secure invasive debug: 00 The trace unit does not support Non-secure invasive debug. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn nsid(&mut self) -> NsidW<ApbaddrEtmCpu1TrcauthstatusSpec> {
        NsidW::new(self, 0)
    }
    #[doc = "Bits 2:3 - 3:2\\]
Indicates whether the system enables the trace unit to support Non-secure non-invasive debug: 00 The trace unit does not implement support for Non-secure non-invasive debug. 01 Reserved. 10 Non-secure non-invasive debug is disabled. 11 Non-secure non-invasive debug is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn nsnid(&mut self) -> NsnidW<ApbaddrEtmCpu1TrcauthstatusSpec> {
        NsnidW::new(self, 2)
    }
    #[doc = "Bits 4:5 - 5:4\\]
Indicates whether the trace unit supports Secure invasive debug: 00 The trace unit does not support Secure invasive debug. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn sid(&mut self) -> SidW<ApbaddrEtmCpu1TrcauthstatusSpec> {
        SidW::new(self, 4)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Indicates whether the system enables the trace unit to support Secure non-invasive debug: 00 The trace unit does not implement support for Secure non-invasive debug. 01 Reserved. 10 Secure non-invasive debug is disabled. 11 Secure non-invasive debug is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn snid(&mut self) -> SnidW<ApbaddrEtmCpu1TrcauthstatusSpec> {
        SnidW::new(self, 6)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Reserved, RES0."]
    ...
    pub fn res0_trcauthstatus_31_8(
        &mut self,
    ) -> Res0Trcauthstatus31_8W<ApbaddrEtmCpu1TrcauthstatusSpec> {
        Res0Trcauthstatus31_8W::new(self, 8)
    }
}
#[doc = "Authentication Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_etm_cpu1_trcauthstatus::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_etm_cpu1_trcauthstatus::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrEtmCpu1TrcauthstatusSpec;
impl crate::RegisterSpec for ApbaddrEtmCpu1TrcauthstatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_etm_cpu1_trcauthstatus::R`](R) reader structure"]
impl crate::Readable for ApbaddrEtmCpu1TrcauthstatusSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_etm_cpu1_trcauthstatus::W`](W) writer structure"]
impl crate::Writable for ApbaddrEtmCpu1TrcauthstatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_ETM_CPU1_TRCAUTHSTATUS to value 0x88"]
impl crate::Resettable for ApbaddrEtmCpu1TrcauthstatusSpec {
