#[doc = "Register `REGS_aggr_revision` reader"]
pub type R = crate::R<RegsAggrRevisionSpec>;
#[doc = "Register `REGS_aggr_revision` writer"]
pub type W = crate::W<RegsAggrRevisionSpec>;
...
Minor version"]
    #[inline(always)]
    #[must_use]
    pub fn revmin(&mut self) -> RevminW<RegsAggrRevisionSpec> {
        RevminW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom version"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<RegsAggrRevisionSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major version"]
    #[inline(always)]
    #[must_use]
    pub fn revmaj(&mut self) -> RevmajW<RegsAggrRevisionSpec> {
        RevmajW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL version"]
    #[inline(always)]
    #[must_use]
    pub fn revrtl(&mut self) -> RevrtlW<RegsAggrRevisionSpec> {
        RevrtlW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn module_id(&mut self) -> ModuleIdW<RegsAggrRevisionSpec> {
...
bu"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<RegsAggrRevisionSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
Scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<RegsAggrRevisionSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "Revision parameters\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`regs_aggr_revision::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`regs_aggr_revision::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RegsAggrRevisionSpec;
impl crate::RegisterSpec for RegsAggrRevisionSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regs_aggr_revision::R`](R) reader structure"]
impl crate::Readable for RegsAggrRevisionSpec {}
#[doc = "`write(|w| ..)` method takes [`regs_aggr_revision::W`](W) writer structure"]
impl crate::Writable for RegsAggrRevisionSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets REGS_aggr_revision to value 0x7696_1201"]
impl crate::Resettable for RegsAggrRevisionSpec {
    const RESET_VALUE: u32 = 0x7696_1201;
}
