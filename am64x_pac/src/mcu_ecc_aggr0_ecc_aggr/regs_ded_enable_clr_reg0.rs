...
Interrupt Enable Clear Register for am64_mcu_cbass_cbass_Islave_safety_gasket_mcu_0_cfg_p2p_bridge_Islave_safety_gasket_mcu_0_cfg_bridge_busecc_pend"]
    #[inline(always)]
    #[must_use]    pub fn am64_mcu_cbass_cbass_islave_safety_gasket_mcu_0_cfg_p2p_bridge_islave_safety_gasket_mcu_0_cfg_bridge_busecc_enable_clr (& mut self) -> Am64McuCbassCbassIslaveSafetyGasketMcu0CfgP2pBridgeIslaveSafetyGasketMcu0CfgBridgeBuseccEnableClrW < RegsDedEnableClrReg0Spec >{
...
Interrupt Enable Clear Register for am64_mcu_cbass_cbass_err_slv_p2p_bridge_err_slv_bridge_busecc_pend"]
    ...
    pub fn am64_mcu_cbass_cbass_err_slv_p2p_bridge_err_slv_bridge_busecc_enable_clr(
        &mut self,
    ) -> Am64McuCbassCbassErrSlvP2pBridgeErrSlvBridgeBuseccEnableClrW<RegsDedEnableClrReg0Spec>
    {
...
Interrupt Enable Clear Register for am64_mcu_cbass_cbass_dmsc_slv_p2p_bridge_dmsc_slv_bridge_busecc_pend"]
    ...
    pub fn am64_mcu_cbass_cbass_dmsc_slv_p2p_bridge_dmsc_slv_bridge_busecc_enable_clr(
        &mut self,
    ) -> Am64McuCbassCbassDmscSlvP2pBridgeDmscSlvBridgeBuseccEnableClrW<RegsDedEnableClrReg0Spec>
    {
...
Interrupt Enable Clear Register for eccagg_pend"]
    #[inline(always)]
    #[must_use]
    pub fn eccagg_enable_clr(&mut self) -> EccaggEnableClrW<RegsDedEnableClrReg0Spec> {
