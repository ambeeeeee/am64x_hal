#[doc = "Register `APBADDR_DBG_CPU1_EDPRCR` reader"]
pub type R = crate::R<ApbaddrDbgCpu1EdprcrSpec>;
#[doc = "Register `APBADDR_DBG_CPU1_EDPRCR` writer"]
pub type W = crate::W<ApbaddrDbgCpu1EdprcrSpec>;
...
Core no powerdown request. Requests emulation of powerdown. Possible values of this bit are: 0 On a powerdown request, the system powers down the Core power domain. 1 On a powerdown request, the system emulates powerdown of the Core power domain. In this emulation mode the Core power domain is not actually powered down."]
    #[inline(always)]
    #[must_use]
    pub fn corenpdrq(&mut self) -> CorenpdrqW<ApbaddrDbgCpu1EdprcrSpec> {
...
== TRUE \\[OS Double Lock is set\\].OSLSR.OSLK == 1 \\[OS lock is locked\\].In an implementation that includes the recommended external debug interface, this bit drives the DBGRSTREQ signal."]
    #[inline(always)]
    #[must_use]
    pub fn cwrr(&mut self) -> CwrrW<ApbaddrDbgCpu1EdprcrSpec> {
        CwrrW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edprcr_2_2(&mut self) -> Res0Edprcr2_2W<ApbaddrDbgCpu1EdprcrSpec> {
...
Core powerup request. Allows a debugger to request that the power controller power up the core, enabling access to the debug register in the Core power domain. The actions on writing to this bit are: 0 No effect. 1 Request the power controller to powerup the core. In an implementation that includes the recommended external debug interface, this bit drives the DBGPWRUPREQ signal.This bit can be read and written when the Core power domain is powered off.The power controller must not allow the Core power domain to switch off while this bit is one."]
    #[inline(always)]
    #[must_use]
    pub fn corepurq(&mut self) -> CorepurqW<ApbaddrDbgCpu1EdprcrSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edprcr_31_4(&mut self) -> Res0Edprcr31_4W<ApbaddrDbgCpu1EdprcrSpec> {
        Res0Edprcr31_4W::new(self, 4)
    }
}
#[doc = "External Debug Power/Reset Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu1_edprcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu1_edprcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu1EdprcrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu1EdprcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu1_edprcr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu1EdprcrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu1_edprcr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu1EdprcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU1_EDPRCR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu1EdprcrSpec {
