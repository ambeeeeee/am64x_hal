#[doc = "Register `APBADDR_DBG_CPU1_EDRCR` reader"]
pub type R = crate::R<ApbaddrDbgCpu1EdrcrSpec>;
#[doc = "Register `APBADDR_DBG_CPU1_EDRCR` writer"]
pub type W = crate::W<ApbaddrDbgCpu1EdrcrSpec>;
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edrcr_1_0(&mut self) -> Res0Edrcr1_0W<ApbaddrDbgCpu1EdrcrSpec> {
...
Clear Sticky Error. Used to clear the EDSCR cumulative error bits to 0. The actions on writing to this bit are: 0 No action. 1 Clear the EDSCR.{TXU, RXO, ERR} bits, and, if the processor is in Debug state, the EDSCR.ITO bit, to 0."]
    #[inline(always)]
    #[must_use]
    pub fn cse(&mut self) -> CseW<ApbaddrDbgCpu1EdrcrSpec> {
        CseW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Clear Sticky Pipeline Advance. This bit is used to clear the EDSCR.PipeAdv bit to 0. The actions on writing to this bit are: 0 No action. 1 Clear the EDSCR.PipeAdv bit to 0."]
    #[inline(always)]
    #[must_use]
    pub fn cspa(&mut self) -> CspaW<ApbaddrDbgCpu1EdrcrSpec> {
        CspaW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Allow imprecise entry to Debug state. The actions on writing to this bit are: 0 No action. 1 Allow imprecise entry to Debug state, for example by canceling pending bus accesses. Setting this bit to 1 allows a debugger to request imprecise entry to Debug state. An External Debug Request debug event must be pending before the debugger sets this bit to 1.This feature is optional. If this feature is not implemented, writes to this bit are ignored."]
    #[inline(always)]
    #[must_use]
    pub fn cbrrq(&mut self) -> CbrrqW<ApbaddrDbgCpu1EdrcrSpec> {
        CbrrqW::new(self, 4)
    }
    #[doc = "Bits 5:31 - 31:5\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edrcr_31_5(&mut self) -> Res0Edrcr31_5W<ApbaddrDbgCpu1EdrcrSpec> {
        Res0Edrcr31_5W::new(self, 5)
    }
}
#[doc = "External Debug Reserve Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu1_edrcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu1_edrcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu1EdrcrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu1EdrcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu1_edrcr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu1EdrcrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu1_edrcr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu1EdrcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU1_EDRCR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu1EdrcrSpec {
