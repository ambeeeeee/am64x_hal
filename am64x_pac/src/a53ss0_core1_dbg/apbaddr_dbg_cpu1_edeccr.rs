#[doc = "Register `APBADDR_DBG_CPU1_EDECCR` reader"]
pub type R = crate::R<ApbaddrDbgCpu1EdeccrSpec>;
#[doc = "Register `APBADDR_DBG_CPU1_EDECCR` writer"]
pub type W = crate::W<ApbaddrDbgCpu1EdeccrSpec>;
...
== FALSE."]
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SeW<ApbaddrDbgCpu1EdeccrSpec> {
        SeW::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
Coarse-grained Non-secure exception catch. Possible values of this field are: 0000 Exception catch debug event disabled for Non-secure exception levels. 0010 Exception catch debug event enabled for Non-secure EL1. 0100 Exception catch debug event enabled for Non-secure EL2. 0110 Exception catch debug event enabled for Non-secure EL1 and EL2. All other values are reserved. Bits \\[7,4\\]
are reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn nse(&mut self) -> NseW<ApbaddrDbgCpu1EdeccrSpec> {
        NseW::new(self, 4)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edeccr_31_8(&mut self) -> Res0Edeccr31_8W<ApbaddrDbgCpu1EdeccrSpec> {
        Res0Edeccr31_8W::new(self, 8)
    }
}
#[doc = "External Debug Exception Catch Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu1_edeccr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu1_edeccr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu1EdeccrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu1EdeccrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu1_edeccr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu1EdeccrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu1_edeccr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu1EdeccrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU1_EDECCR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu1EdeccrSpec {
