#[doc = "Register `APBADDR_DBG_CPU1_EDLSR` reader"]
pub type R = crate::R<ApbaddrDbgCpu1EdlsrSpec>;
#[doc = "Register `APBADDR_DBG_CPU1_EDLSR` writer"]
pub type W = crate::W<ApbaddrDbgCpu1EdlsrSpec>;
...
Software lock implemented. For an access to LSR that is not a memory-mapped access, this field is RAZ. For memory-mapped accesses, the value of this field is IMPLEMENTATION DEFINED. Permitted values are: 0 Software lock not implemented or not memory-mapped access. 1 Software lock implemented and memory-mapped access."]
    #[inline(always)]
    #[must_use]
    pub fn sli(&mut self) -> SliW<ApbaddrDbgCpu1EdlsrSpec> {
        SliW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software lock status for this component. For an access to LSR that is not a memory-mapped access, or when the software lock is not implemented, this field is RES0.For memory-mapped accesses when the software lock is implemented, possible values of this field are: 0 Lock clear. Writes are permitted to this component's registers. 1 Lock set. Writes to this component's registers are ignored, and reads have no side effects."]
    #[inline(always)]
    #[must_use]
    pub fn slk(&mut self) -> SlkW<ApbaddrDbgCpu1EdlsrSpec> {
        SlkW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Not thirty-two bit access required. RAZ."]
    #[inline(always)]
    #[must_use]
    pub fn ntt(&mut self) -> NttW<ApbaddrDbgCpu1EdlsrSpec> {
        NttW::new(self, 2)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edlsr_31_3(&mut self) -> Res0Edlsr31_3W<ApbaddrDbgCpu1EdlsrSpec> {
        Res0Edlsr31_3W::new(self, 3)
    }
}
#[doc = "External Debug Lock Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu1_edlsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu1_edlsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu1EdlsrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu1EdlsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu1_edlsr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu1EdlsrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu1_edlsr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu1EdlsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU1_EDLSR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu1EdlsrSpec {
