#[doc = "Register `APBADDR_DBG_CPU1_EDPIDR1` reader"]
pub type R = crate::R<ApbaddrDbgCpu1Edpidr1Spec>;
#[doc = "Register `APBADDR_DBG_CPU1_EDPIDR1` writer"]
pub type W = crate::W<ApbaddrDbgCpu1Edpidr1Spec>;
...
Part number, most significant nibble."]
    #[inline(always)]
    #[must_use]
    pub fn part_1(&mut self) -> Part1W<ApbaddrDbgCpu1Edpidr1Spec> {
        Part1W::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
Designer, least significant nibble of JEP106 ID code. For ARM Limited, this field is 0b1011."]
    #[inline(always)]
    #[must_use]
    pub fn des_0(&mut self) -> Des0W<ApbaddrDbgCpu1Edpidr1Spec> {
        Des0W::new(self, 4)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edpidr1_31_8(&mut self) -> Res0Edpidr1_31_8W<ApbaddrDbgCpu1Edpidr1Spec> {
        Res0Edpidr1_31_8W::new(self, 8)
    }
}
#[doc = "External Debug Peripheral Identification Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu1_edpidr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu1_edpidr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu1Edpidr1Spec;
impl crate::RegisterSpec for ApbaddrDbgCpu1Edpidr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu1_edpidr1::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu1Edpidr1Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu1_edpidr1::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu1Edpidr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU1_EDPIDR1 to value 0x0113"]
impl crate::Resettable for ApbaddrDbgCpu1Edpidr1Spec {
