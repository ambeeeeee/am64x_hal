#[doc = "Register `CFG_pll0_CFG` reader"]
pub type R = crate::R<CfgPll0CfgSpec>;
#[doc = "Register `CFG_pll0_CFG` writer"]
pub type W = crate::W<CfgPll0CfgSpec>;
...
Indicates PLL type Field values (Others are reserved): 2'b00 - Fractional PLL 2'b01 - FractionalF PLL 2'b10 - De-Skew PLL"]
    #[inline(always)]
    #[must_use]
    pub fn pll_type(&mut self) -> PllTypeW<CfgPll0CfgSpec> {
        PllTypeW::new(self, 0)
    }
    #[doc = "Bit 8 - 8:8\\]
Spread spectrum wave table presence 1'b0 - SSM Wave table is not present 1'b1 - SSM Wave table is present"]
    #[inline(always)]
    #[must_use]
    pub fn ssm_wvtbl(&mut self) -> SsmWvtblW<CfgPll0CfgSpec> {
...
Spread spectrum module presence Field values (Others are reserved): 2'b00 - SSM is not present 2'b01 - SSM is present 2'b10 - Reserved 2'b11 - Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn ssm_type(&mut self) -> SsmTypeW<CfgPll0CfgSpec> {
...
are connected to the PLL FOUTPOSTDIV output clock"]
    #[inline(always)]
    #[must_use]
    pub fn hsdiv_prsnt(&mut self) -> HsdivPrsntW<CfgPll0CfgSpec> {
        HsdivPrsntW::new(self, 16)
    }
}
#[doc = "CFG_pll0_CFG\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll0_cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll0_cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll0CfgSpec;
impl crate::RegisterSpec for CfgPll0CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll0_cfg::R`](R) reader structure"]
impl crate::Readable for CfgPll0CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll0_cfg::W`](W) writer structure"]
impl crate::Writable for CfgPll0CfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll0_CFG to value 0x1023_0801"]
impl crate::Resettable for CfgPll0CfgSpec {
    const RESET_VALUE: u32 = 0x1023_0801;
}
