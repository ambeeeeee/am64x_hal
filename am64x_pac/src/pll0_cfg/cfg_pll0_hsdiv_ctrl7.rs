#[doc = "Register `CFG_pll0_HSDIV_CTRL7` reader"]
pub type R = crate::R<CfgPll0HsdivCtrl7Spec>;
#[doc = "Register `CFG_pll0_HSDIV_CTRL7` writer"]
pub type W = crate::W<CfgPll0HsdivCtrl7Spec>;
...
CLKOUT0 divider value (HSDIV1+1) Allowed values are 0-127"]
    #[inline(always)]
    #[must_use]
    pub fn hsdiv(&mut self) -> HsdivW<CfgPll0HsdivCtrl7Spec> {
        HsdivW::new(self, 0)
    }
    #[doc = "Bit 8 - 8:8\\]
Disable divider synchronization logic 0 - Changes to DIV value synchronized to prevent glitches 1 - Changes are asynchronous"]
    #[inline(always)]
    #[must_use]
    pub fn sync_dis(&mut self) -> SyncDisW<CfgPll0HsdivCtrl7Spec> {
        SyncDisW::new(self, 8)
    }
    #[doc = "Bit 15 - 15:15\\]
CLKOUT1 enable 1'b0 - Synchronously disable CLKOUT1 1'b1 - Synchronously enable CLKOUT1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout_en(&mut self) -> ClkoutEnW<CfgPll0HsdivCtrl7Spec> {
...
SSM reset. When set to 1 the SSM modulator is in resetl"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<CfgPll0HsdivCtrl7Spec> {
        ResetW::new(self, 31)
    }
}
#[doc = "CFG_pll0_HSDIV_CTRL7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll0_hsdiv_ctrl7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll0_hsdiv_ctrl7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll0HsdivCtrl7Spec;
impl crate::RegisterSpec for CfgPll0HsdivCtrl7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll0_hsdiv_ctrl7::R`](R) reader structure"]
impl crate::Readable for CfgPll0HsdivCtrl7Spec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll0_hsdiv_ctrl7::W`](W) writer structure"]
impl crate::Writable for CfgPll0HsdivCtrl7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll0_HSDIV_CTRL7 to value 0"]
impl crate::Resettable for CfgPll0HsdivCtrl7Spec {
