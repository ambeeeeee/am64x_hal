#[doc = "Register `CFG_pll2_HSDIV_CTRL5` reader"]
pub type R = crate::R<CfgPll2HsdivCtrl5Spec>;
#[doc = "Register `CFG_pll2_HSDIV_CTRL5` writer"]
pub type W = crate::W<CfgPll2HsdivCtrl5Spec>;
...
CLKOUT0 divider value (HSDIV1+1) Allowed values are 0-127"]
    #[inline(always)]
    #[must_use]
    pub fn hsdiv(&mut self) -> HsdivW<CfgPll2HsdivCtrl5Spec> {
        HsdivW::new(self, 0)
    }
    #[doc = "Bit 8 - 8:8\\]
Disable divider synchronization logic 0 - Changes to DIV value synchronized to prevent glitches 1 - Changes are asynchronous"]
    #[inline(always)]
    #[must_use]
    pub fn sync_dis(&mut self) -> SyncDisW<CfgPll2HsdivCtrl5Spec> {
        SyncDisW::new(self, 8)
    }
    #[doc = "Bit 15 - 15:15\\]
CLKOUT1 enable 1'b0 - Synchronously disable CLKOUT1 1'b1 - Synchronously enable CLKOUT1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout_en(&mut self) -> ClkoutEnW<CfgPll2HsdivCtrl5Spec> {
...
SSM reset. When set to 1 the SSM modulator is in resetl"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<CfgPll2HsdivCtrl5Spec> {
        ResetW::new(self, 31)
    }
}
#[doc = "CFG_pll2_HSDIV_CTRL5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll2_hsdiv_ctrl5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll2_hsdiv_ctrl5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll2HsdivCtrl5Spec;
impl crate::RegisterSpec for CfgPll2HsdivCtrl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll2_hsdiv_ctrl5::R`](R) reader structure"]
impl crate::Readable for CfgPll2HsdivCtrl5Spec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll2_hsdiv_ctrl5::W`](W) writer structure"]
impl crate::Writable for CfgPll2HsdivCtrl5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll2_HSDIV_CTRL5 to value 0"]
impl crate::Resettable for CfgPll2HsdivCtrl5Spec {
