#[doc = "Register `CFG_pll12_CAL_STAT` reader"]
pub type R = crate::R<CfgPll12CalStatSpec>;
#[doc = "Register `CFG_pll12_CAL_STAT` writer"]
pub type W = crate::W<CfgPll12CalStatSpec>;
...
Output of the calibration block if cal_byp = 1'b0. If cal_byp = 1'b1 it is a buffer version of cal_in\\[11:0\\]. Can be used to read the phase calibration state to for later use as an override value to bypass skew calibration"]
    #[inline(always)]
    #[must_use]
    pub fn cal_out(&mut self) -> CalOutW<CfgPll12CalStatSpec> {
        CalOutW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Reserved for future use"]
    #[inline(always)]
    #[must_use]
    pub fn lock_cnt(&mut self) -> LockCntW<CfgPll12CalStatSpec> {
...
Reserved for future use"]
    #[inline(always)]
    #[must_use]
    pub fn cal_lock(&mut self) -> CalLockW<CfgPll12CalStatSpec> {
        CalLockW::new(self, 31)
    }
}
#[doc = "CFG_pll12_CAL_STAT\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll12_cal_stat::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll12_cal_stat::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll12CalStatSpec;
impl crate::RegisterSpec for CfgPll12CalStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll12_cal_stat::R`](R) reader structure"]
impl crate::Readable for CfgPll12CalStatSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll12_cal_stat::W`](W) writer structure"]
impl crate::Writable for CfgPll12CalStatSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll12_CAL_STAT to value 0"]
impl crate::Resettable for CfgPll12CalStatSpec {
