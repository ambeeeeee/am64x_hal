#[doc = "Register `CFG_pll8_DIV_CTRL` reader"]
pub type R = crate::R<CfgPll8DivCtrlSpec>;
#[doc = "Register `CFG_pll8_DIV_CTRL` writer"]
pub type W = crate::W<CfgPll8DivCtrlSpec>;
...
Reference clock pre-divider. Supports values of 1-63 6'b000000 - Reserved /(do not use/) 6'b000001 - Divide by 1 6'b000010 - Divide by 2 : 6'b111111 - Divide by 63"]
    #[inline(always)]
    #[must_use]
    pub fn ref_div(&mut self) -> RefDivW<CfgPll8DivCtrlSpec> {
        RefDivW::new(self, 0)
    }
    #[doc = "Bits 16:18 - 18:16\\]
Primary post divider. To ensure correct operation, post_div1 must always be programmed to a value equal to or greater that post_div2. Supports values of 1-7i Field values (Others are reserved): 3'b000 - Reserved (do not use) 3'b001 - Divide by 1 3'b010 - Divide by 2 3'b011 - Divide by 3 3'b100 - Divide by 4 3'b101 - Divide by 5 3'b110 - Divide by 6 3'b111 - Divide by 7"]
    #[inline(always)]
    #[must_use]
    pub fn post_div1(&mut self) -> PostDiv1W<CfgPll8DivCtrlSpec> {
...
Secondary post divider. Supports values of 1-7"]
    #[inline(always)]
    #[must_use]
    pub fn post_div2(&mut self) -> PostDiv2W<CfgPll8DivCtrlSpec> {
        PostDiv2W::new(self, 24)
    }
}
#[doc = "CFG_pll8_DIV_CTRL\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll8_div_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll8_div_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll8DivCtrlSpec;
impl crate::RegisterSpec for CfgPll8DivCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll8_div_ctrl::R`](R) reader structure"]
impl crate::Readable for CfgPll8DivCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll8_div_ctrl::W`](W) writer structure"]
impl crate::Writable for CfgPll8DivCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll8_DIV_CTRL to value 0x0102_0001"]
impl crate::Resettable for CfgPll8DivCtrlSpec {
