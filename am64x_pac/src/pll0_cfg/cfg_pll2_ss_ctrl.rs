#[doc = "Register `CFG_pll2_SS_CTRL` reader"]
pub type R = crate::R<CfgPll2SsCtrlSpec>;
#[doc = "Register `CFG_pll2_SS_CTRL` writer"]
pub type W = crate::W<CfgPll2SsCtrlSpec>;
...
Wave pattern select External wave table should only be selected if PLL_CFG_ssm_wvtbl = 1 Field values (Others are reserved): 1'b0 - Use 128 point triangle wave table 1'b1 - Use external wave table"]
    #[inline(always)]
    #[must_use]
    pub fn wave_sel(&mut self) -> WaveSelW<CfgPll2SsCtrlSpec> {
        WaveSelW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Selects center spread or down spread clock variance 1'b0 - Center spread 1'b1 - Down spread"]
    #[inline(always)]
    #[must_use]
    pub fn downspread_en(&mut self) -> DownspreadEnW<CfgPll2SsCtrlSpec> {
...
SSM reset. When set to 1 the SSM modulator is in reset"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<CfgPll2SsCtrlSpec> {
        ResetW::new(self, 15)
    }
    #[doc = "Bits 18:25 - 25:18\\]
Wave table max address. Indicates the maximum number of address bits used to access the external wave table. These bits are not used if PLL_CFG_ssm_wvtbl = 0"]
    #[inline(always)]
    #[must_use]
    pub fn wv_tble_maxaddr(&mut self) -> WvTbleMaxaddrW<CfgPll2SsCtrlSpec> {
...
Bypass the SS modulator. 1'b0 - Spread spectrum modulation is enabled 1'b1 - SSMOD is bypassed. No modulation of PLL frequency"]
    #[inline(always)]
    #[must_use]
    pub fn bypass_en(&mut self) -> BypassEnW<CfgPll2SsCtrlSpec> {
        BypassEnW::new(self, 31)
    }
}
#[doc = "CFG_pll2_SS_CTRL\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_pll2_ss_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_pll2_ss_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgPll2SsCtrlSpec;
impl crate::RegisterSpec for CfgPll2SsCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_pll2_ss_ctrl::R`](R) reader structure"]
impl crate::Readable for CfgPll2SsCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_pll2_ss_ctrl::W`](W) writer structure"]
impl crate::Writable for CfgPll2SsCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_pll2_SS_CTRL to value 0x8000_0000"]
impl crate::Resettable for CfgPll2SsCtrlSpec {
