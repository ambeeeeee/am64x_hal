#[doc = "Register `APBADDR_CTI_CPU0_CTIAUTHSTATUS` reader"]
pub type R = crate::R<ApbaddrCtiCpu0CtiauthstatusSpec>;
#[doc = "Register `APBADDR_CTI_CPU0_CTIAUTHSTATUS` writer"]
pub type W = crate::W<ApbaddrCtiCpu0CtiauthstatusSpec>;
...
If EL3 is not implemented and the processor is Secure, holds the same value as DBGAUTHSTATUS_EL1.SID.Otherwise, holds the same value as DBGAUTHSTATUS_EL1.NSID."]
    #[inline(always)]
    #[must_use]
    pub fn nsid(&mut self) -> NsidW<ApbaddrCtiCpu0CtiauthstatusSpec> {
        NsidW::new(self, 0)
    }
    #[doc = "Bits 2:3 - 3:2\\]
If EL3 is not implemented and the processor is Secure, holds the same value as DBGAUTHSTATUS_EL1.SNID.Otherwise, holds the same value as DBGAUTHSTATUS_EL1.NSNID."]
    #[inline(always)]
    #[must_use]
    pub fn nsnid(&mut self) -> NsnidW<ApbaddrCtiCpu0CtiauthstatusSpec> {
        NsnidW::new(self, 2)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Reserved, RES0."]
    ...
    pub fn res0_ctiauthstatus_31_4(
        &mut self,
    ) -> Res0Ctiauthstatus31_4W<ApbaddrCtiCpu0CtiauthstatusSpec> {
        Res0Ctiauthstatus31_4W::new(self, 4)
    }
}
#[doc = "CTI Authentication Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_cti_cpu0_ctiauthstatus::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_cti_cpu0_ctiauthstatus::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrCtiCpu0CtiauthstatusSpec;
impl crate::RegisterSpec for ApbaddrCtiCpu0CtiauthstatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_cti_cpu0_ctiauthstatus::R`](R) reader structure"]
impl crate::Readable for ApbaddrCtiCpu0CtiauthstatusSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_cti_cpu0_ctiauthstatus::W`](W) writer structure"]
impl crate::Writable for ApbaddrCtiCpu0CtiauthstatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_CTI_CPU0_CTIAUTHSTATUS to value 0x0a"]
impl crate::Resettable for ApbaddrCtiCpu0CtiauthstatusSpec {
