#[doc = "Register `APBADDR_CTI_CPU0_CTILSR` reader"]
pub type R = crate::R<ApbaddrCtiCpu0CtilsrSpec>;
#[doc = "Register `APBADDR_CTI_CPU0_CTILSR` writer"]
pub type W = crate::W<ApbaddrCtiCpu0CtilsrSpec>;
...
Software lock implemented. For an access to LSR that is not a memory-mapped access, this field is RAZ. For memory-mapped accesses, the value of this field is IMPLEMENTATION DEFINED. Permitted values are: 0 Software lock not implemented or not memory-mapped access. 1 Software lock implemented and memory-mapped access."]
    #[inline(always)]
    #[must_use]
    pub fn sli(&mut self) -> SliW<ApbaddrCtiCpu0CtilsrSpec> {
        SliW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software lock status for this component. For an access to LSR that is not a memory-mapped access, or when the software lock is not implemented, this field is RES0.For memory-mapped accesses when the software lock is implemented, possible values of this field are: 0 Lock clear. Writes are permitted to this component's registers. 1 Lock set. Writes to this component's registers are ignored, and reads have no side effects."]
    #[inline(always)]
    #[must_use]
    pub fn slk(&mut self) -> SlkW<ApbaddrCtiCpu0CtilsrSpec> {
        SlkW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Not thirty-two bit access required. RAZ."]
    #[inline(always)]
    #[must_use]
    pub fn ntt(&mut self) -> NttW<ApbaddrCtiCpu0CtilsrSpec> {
        NttW::new(self, 2)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_ctilsr_31_3(&mut self) -> Res0Ctilsr31_3W<ApbaddrCtiCpu0CtilsrSpec> {
        Res0Ctilsr31_3W::new(self, 3)
    }
}
#[doc = "CTI Lock Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_cti_cpu0_ctilsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_cti_cpu0_ctilsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrCtiCpu0CtilsrSpec;
impl crate::RegisterSpec for ApbaddrCtiCpu0CtilsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_cti_cpu0_ctilsr::R`](R) reader structure"]
impl crate::Readable for ApbaddrCtiCpu0CtilsrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_cti_cpu0_ctilsr::W`](W) writer structure"]
impl crate::Writable for ApbaddrCtiCpu0CtilsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_CTI_CPU0_CTILSR to value 0"]
impl crate::Resettable for ApbaddrCtiCpu0CtilsrSpec {
