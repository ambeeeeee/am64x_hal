#[doc = "Register `APBADDR_CTI_CPU0_CTIDEVARCH` reader"]
pub type R = crate::R<ApbaddrCtiCpu0CtidevarchSpec>;
#[doc = "Register `APBADDR_CTI_CPU0_CTIDEVARCH` writer"]
pub type W = crate::W<ApbaddrCtiCpu0CtidevarchSpec>;
...
are the architecture part number, 0xA14.This corresponds to CTI architecture version CTIv2."]
    #[inline(always)]
    #[must_use]
    pub fn archid(&mut self) -> ArchidW<ApbaddrCtiCpu0CtidevarchSpec> {
        ArchidW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Defines the architecture revision. For architectures defined by ARM this is the minor revision.For CTI, the revision defined by v8-A is 0x0.All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrCtiCpu0CtidevarchSpec> {
...
When set to 1, indicates that the DEVARCH is present.This field is 1 in v8-A."]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PresentW<ApbaddrCtiCpu0CtidevarchSpec> {
...
are the JEP 106 ID code, 0x3B."]
    #[inline(always)]
    #[must_use]
    pub fn architect(&mut self) -> ArchitectW<ApbaddrCtiCpu0CtidevarchSpec> {
        ArchitectW::new(self, 21)
    }
}
#[doc = "CTI Device Architecture Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_cti_cpu0_ctidevarch::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_cti_cpu0_ctidevarch::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrCtiCpu0CtidevarchSpec;
impl crate::RegisterSpec for ApbaddrCtiCpu0CtidevarchSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_cti_cpu0_ctidevarch::R`](R) reader structure"]
impl crate::Readable for ApbaddrCtiCpu0CtidevarchSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_cti_cpu0_ctidevarch::W`](W) writer structure"]
impl crate::Writable for ApbaddrCtiCpu0CtidevarchSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_CTI_CPU0_CTIDEVARCH to value 0xae30_6676"]
impl crate::Resettable for ApbaddrCtiCpu0CtidevarchSpec {
