#[doc = "Register `APBADDR_CTI_CPU1_CTIDEVID` reader"]
pub type R = crate::R<ApbaddrCtiCpu1CtidevidSpec>;
#[doc = "Register `APBADDR_CTI_CPU1_CTIDEVID` writer"]
pub type W = crate::W<ApbaddrCtiCpu1CtidevidSpec>;
...
Maximum number of external triggers available for multiplexing into the CTI. This relates only to additional external triggers outside those defined for v8-A."]
    #[inline(always)]
    #[must_use]
    pub fn extmuxnum(&mut self) -> ExtmuxnumW<ApbaddrCtiCpu1CtidevidSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_ctidevid_7_5(&mut self) -> Res0Ctidevid7_5W<ApbaddrCtiCpu1CtidevidSpec> {
...
implemented.All other values are reserved. If the Trace Extension is implemented, this field must be at least 001000. There is no guarantee that any of the implemented triggers, including the highest numbered, are connected to any components."]
    #[inline(always)]
    #[must_use]
    pub fn numtrig(&mut self) -> NumtrigW<ApbaddrCtiCpu1CtidevidSpec> {
        NumtrigW::new(self, 8)
    }
    #[doc = "Bits 14:15 - 15:14\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_ctidevid_15_14(&mut self) -> Res0Ctidevid15_14W<ApbaddrCtiCpu1CtidevidSpec> {
...
implemented.All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn numchan(&mut self) -> NumchanW<ApbaddrCtiCpu1CtidevidSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_ctidevid_23_22(&mut self) -> Res0Ctidevid23_22W<ApbaddrCtiCpu1CtidevidSpec> {
...
Input/output options. Indicates presence of the input gate. If the CTM is not implemented, this field is RAZ. 00 CTIGATE does not mask propagation of input events from external channels. 01 CTIGATE masks propagation of input events from external channels. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn inout(&mut self) -> InoutW<ApbaddrCtiCpu1CtidevidSpec> {
        InoutW::new(self, 24)
    }
    #[doc = "Bits 26:31 - 31:26\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_ctidevid_31_26(&mut self) -> Res0Ctidevid31_26W<ApbaddrCtiCpu1CtidevidSpec> {
        Res0Ctidevid31_26W::new(self, 26)
    }
}
#[doc = "CTI Device ID Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_cti_cpu1_ctidevid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_cti_cpu1_ctidevid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrCtiCpu1CtidevidSpec;
impl crate::RegisterSpec for ApbaddrCtiCpu1CtidevidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_cti_cpu1_ctidevid::R`](R) reader structure"]
impl crate::Readable for ApbaddrCtiCpu1CtidevidSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_cti_cpu1_ctidevid::W`](W) writer structure"]
impl crate::Writable for ApbaddrCtiCpu1CtidevidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_CTI_CPU1_CTIDEVID to value 0x0104_0800"]
impl crate::Resettable for ApbaddrCtiCpu1CtidevidSpec {
