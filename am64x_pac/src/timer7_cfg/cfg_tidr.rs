#[doc = "Register `CFG_TIDR` reader"]
pub type R = crate::R<CfgTidrSpec>;
#[doc = "Register `CFG_TIDR` writer"]
pub type W = crate::W<CfgTidrSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn minor(&mut self) -> MinorW<CfgTidrSpec> {
        MinorW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<CfgTidrSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn major(&mut self) -> MajorW<CfgTidrSpec> {
        MajorW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release."]
    #[inline(always)]
    #[must_use]
    pub fn rtl(&mut self) -> RtlW<CfgTidrSpec> {
        RtlW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn module_id(&mut self) -> ModuleIdW<CfgTidrSpec> {
...
Business Unit"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<CfgTidrSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
PID register scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<CfgTidrSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "CFG_TIDR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_tidr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_tidr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgTidrSpec;
impl crate::RegisterSpec for CfgTidrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_tidr::R`](R) reader structure"]
impl crate::Readable for CfgTidrSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_tidr::W`](W) writer structure"]
impl crate::Writable for CfgTidrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_TIDR to value 0x5000_3900"]
impl crate::Resettable for CfgTidrSpec {
    const RESET_VALUE: u32 = 0x5000_3900;
}
