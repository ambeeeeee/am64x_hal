#[doc = "Register `GLB_REGS_exception_logging_data2` reader"]
pub type R = crate::R<GlbRegsExceptionLoggingData2Spec>;
#[doc = "Register `GLB_REGS_exception_logging_data2` writer"]
pub type W = crate::W<GlbRegsExceptionLoggingData2Spec>;
...
Priv ID."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<GlbRegsExceptionLoggingData2Spec> {
        PrivIdW::new(self, 0)
    }
    #[doc = "Bit 8 - 8:8\\]
Secure."]
    #[inline(always)]
    #[must_use]
    pub fn secure(&mut self) -> SecureW<GlbRegsExceptionLoggingData2Spec> {
        SecureW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Priv."]
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PrivW<GlbRegsExceptionLoggingData2Spec> {
        PrivW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Cacheable."]
    #[inline(always)]
    #[must_use]
    pub fn cacheable(&mut self) -> CacheableW<GlbRegsExceptionLoggingData2Spec> {
...
Debug."]
    #[inline(always)]
    #[must_use]
    pub fn debug(&mut self) -> DebugW<GlbRegsExceptionLoggingData2Spec> {
        DebugW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Read."]
    #[inline(always)]
    #[must_use]
    pub fn read(&mut self) -> ReadW<GlbRegsExceptionLoggingData2Spec> {
        ReadW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Write."]
    #[inline(always)]
    #[must_use]
    pub fn write(&mut self) -> WriteW<GlbRegsExceptionLoggingData2Spec> {
        WriteW::new(self, 13)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Route ID."]
    #[inline(always)]
    #[must_use]
    pub fn routeid(&mut self) -> RouteidW<GlbRegsExceptionLoggingData2Spec> {
        RouteidW::new(self, 16)
    }
}
#[doc = "The Exception Logging Data 2 Register contains the third word of the data.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`glb_regs_exception_logging_data2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`glb_regs_exception_logging_data2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GlbRegsExceptionLoggingData2Spec;
impl crate::RegisterSpec for GlbRegsExceptionLoggingData2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`glb_regs_exception_logging_data2::R`](R) reader structure"]
impl crate::Readable for GlbRegsExceptionLoggingData2Spec {}
#[doc = "`write(|w| ..)` method takes [`glb_regs_exception_logging_data2::W`](W) writer structure"]
impl crate::Writable for GlbRegsExceptionLoggingData2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GLB_REGS_exception_logging_data2 to value 0"]
impl crate::Resettable for GlbRegsExceptionLoggingData2Spec {
