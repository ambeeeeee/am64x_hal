#[doc = "Register `SDHC_WRAP__CTL_CFG__CTLCFG_preset_value3` reader"]
pub type R = crate::R<SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec>;
#[doc = "Register `SDHC_WRAP__CTL_CFG__CTLCFG_preset_value3` writer"]
pub type W = crate::W<SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec>;
...
10-bit preset value to set SDCLK Frequency Select in the Clock Control Register is described by a host system."]
    #[inline(always)]
    #[must_use]
    pub fn sdclk_frqsel(&mut self) -> SdclkFrqselW<SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec> {
...
This bit is effective when Host Controller supports programmable clock '0' Host Controller Ver2.00 Compatible Clock Generator '1' Programmable Clock Generator"]
    #[inline(always)]
    #[must_use]
    pub fn clock_gensel(&mut self) -> ClockGenselW<SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec> {
...
Driver Strength is supported by 1.8V signaling bus speed modes. This field is meaningless for 3.3V signaling."]
    ...
    pub fn driver_strength_sel(
        &mut self,
    ) -> DriverStrengthSelW<SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec> {
        DriverStrengthSelW::new(self, 14)
    }
}
#[doc = "This register is used to read the SDCLK Frequency Select Value,Clock Generator Select Value,Driver Strength Select Value\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sdhc_wrap__ctl_cfg__ctlcfg_preset_value3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sdhc_wrap__ctl_cfg__ctlcfg_preset_value3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec;
impl crate::RegisterSpec for SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sdhc_wrap__ctl_cfg__ctlcfg_preset_value3::R`](R) reader structure"]
impl crate::Readable for SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec {}
#[doc = "`write(|w| ..)` method takes [`sdhc_wrap__ctl_cfg__ctlcfg_preset_value3::W`](W) writer structure"]
impl crate::Writable for SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets SDHC_WRAP__CTL_CFG__CTLCFG_preset_value3 to value 0x04"]
impl crate::Resettable for SdhcWrap_CtlCfg_CtlcfgPresetValue3Spec {
