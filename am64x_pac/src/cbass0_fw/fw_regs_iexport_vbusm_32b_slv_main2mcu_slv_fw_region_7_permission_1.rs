#[doc = "Register `FW_REGS_Iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1` reader"]
pub type R = crate::R<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec>;
#[doc = "Register `FW_REGS_Iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1` writer"]
pub type W = crate::W<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        &mut self,
    ) -> NonsecSupvCacheableW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure user cacheable allowed."]
    ...
    pub fn nonsec_user_cacheable(
        &mut self,
    ) -> NonsecUserCacheableW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
...
Allowed privid."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec> {
        PrivIdW::new(self, 16)
    }
}
#[doc = "The FW Region 7 Permission 1 Register defines the permissions for the slave Iexport_vbusm_32b_slv_main2mcu.slv region 7 firewall.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fw_regs_iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fw_regs_iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec;
impl crate::RegisterSpec for FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1::R`](R) reader structure"]
impl crate::Readable for FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1::W`](W) writer structure"]
impl crate::Writable for FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Iexport_vbusm_32b_slv_main2mcu_slv_fw_region_7_permission_1 to value 0"]
impl crate::Resettable for FwRegsIexportVbusm32bSlvMain2mcuSlvFwRegion7Permission1Spec {
