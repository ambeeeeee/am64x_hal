#[doc = "Register `FW_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_3_start_address_l` reader"]
pub type R = crate::R<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec>;
#[doc = "Register `FW_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_3_start_address_l` writer"]
pub type W = crate::W<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec>;
...
Start address bits 11 to 0 are forced to 0 as address must be 4KB aligned."]
    ...
    pub fn start_address_lsb(
        &mut self,
    ) -> StartAddressLsbW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec>
    {
...
Start address bits 31 to 12. Lowest 12 bits are forced to 0 as address must be 4KB aligned."]
    ...
    pub fn start_address_l(
        &mut self,
    ) -> StartAddressLW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec>
    {
...
pub struct FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec;
impl crate::RegisterSpec
    for FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec
{
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_3_start_address_l::R`](R) reader structure"]
impl crate::Readable
    for FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec
{
}
#[doc = "`write(|w| ..)` method takes [`fw_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_3_start_address_l::W`](W) writer structure"]
impl crate::Writable
    for FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion3StartAddressLSpec
{
...
#[doc = "`reset()` method sets FW_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_3_start_address_l to value 0"]
