#[doc = "Register `FW_REGS_Imsram32kx64e_main_5_slv_fw_region_2_start_address_l` reader"]
pub type R = crate::R<FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec>;
#[doc = "Register `FW_REGS_Imsram32kx64e_main_5_slv_fw_region_2_start_address_l` writer"]
pub type W = crate::W<FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec>;
...
Start address bits 11 to 0 are forced to 0 as address must be 4KB aligned."]
    ...
    pub fn start_address_lsb(
        &mut self,
    ) -> StartAddressLsbW<FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec> {
...
Start address bits 31 to 12. Lowest 12 bits are forced to 0 as address must be 4KB aligned."]
    ...
    pub fn start_address_l(
        &mut self,
    ) -> StartAddressLW<FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec> {
...
pub struct FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec;
impl crate::RegisterSpec for FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_imsram32kx64e_main_5_slv_fw_region_2_start_address_l::R`](R) reader structure"]
impl crate::Readable for FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_imsram32kx64e_main_5_slv_fw_region_2_start_address_l::W`](W) writer structure"]
impl crate::Writable for FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Imsram32kx64e_main_5_slv_fw_region_2_start_address_l to value 0"]
impl crate::Resettable for FwRegsImsram32kx64eMain5SlvFwRegion2StartAddressLSpec {
