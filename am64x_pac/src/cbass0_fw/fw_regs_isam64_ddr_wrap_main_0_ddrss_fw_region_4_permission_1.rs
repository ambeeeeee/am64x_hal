#[doc = "Register `FW_REGS_Isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1` reader"]
pub type R = crate::R<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec>;
#[doc = "Register `FW_REGS_Isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1` writer"]
pub type W = crate::W<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        &mut self,
    ) -> NonsecSupvCacheableW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure user cacheable allowed."]
    ...
    pub fn nonsec_user_cacheable(
        &mut self,
    ) -> NonsecUserCacheableW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
...
Allowed privid."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec> {
        PrivIdW::new(self, 16)
    }
}
#[doc = "The FW Region 4 Permission 1 Register defines the permissions for the slave Isam64_ddr_wrap_main_0.ddrss region 4 firewall.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fw_regs_isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fw_regs_isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec;
impl crate::RegisterSpec for FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1::R`](R) reader structure"]
impl crate::Readable for FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1::W`](W) writer structure"]
impl crate::Writable for FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Isam64_ddr_wrap_main_0_ddrss_fw_region_4_permission_1 to value 0"]
impl crate::Resettable for FwRegsIsam64DdrWrapMain0DdrssFwRegion4Permission1Spec {
