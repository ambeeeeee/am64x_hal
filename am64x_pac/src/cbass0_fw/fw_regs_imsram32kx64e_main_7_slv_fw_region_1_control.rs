#[doc = "Register `FW_REGS_Imsram32kx64e_main_7_slv_fw_region_1_control` reader"]
pub type R = crate::R<FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec>;
#[doc = "Register `FW_REGS_Imsram32kx64e_main_7_slv_fw_region_1_control` writer"]
pub type W = crate::W<FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set region values cannot be modified."]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 8 - 8:8\\]
Background enable for region. There can be 1 backgroun region per FW and foreground regions can have overlapping addresses only with the background region."]
    #[inline(always)]
    #[must_use]
    pub fn background(&mut self) -> BackgroundW<FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec> {
...
Cache mode for region. Set to 1 to check cache permissions. Set to 0 to ignore cache permissions."]
    #[inline(always)]
    #[must_use]
    pub fn cache_mode(&mut self) -> CacheModeW<FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec> {
...
pub struct FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec;
impl crate::RegisterSpec for FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_imsram32kx64e_main_7_slv_fw_region_1_control::R`](R) reader structure"]
impl crate::Readable for FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_imsram32kx64e_main_7_slv_fw_region_1_control::W`](W) writer structure"]
impl crate::Writable for FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Imsram32kx64e_main_7_slv_fw_region_1_control to value 0"]
impl crate::Resettable for FwRegsImsram32kx64eMain7SlvFwRegion1ControlSpec {
