#[doc = "Register `FW_REGS_Imsram32kx64e_main_3_slv_fw_region_3_permission_1` reader"]
pub type R = crate::R<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec>;
#[doc = "Register `FW_REGS_Imsram32kx64e_main_3_slv_fw_region_3_permission_1` writer"]
pub type W = crate::W<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        &mut self,
    ) -> NonsecSupvCacheableW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure user cacheable allowed."]
    ...
    pub fn nonsec_user_cacheable(
        &mut self,
    ) -> NonsecUserCacheableW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
...
Allowed privid."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec> {
        PrivIdW::new(self, 16)
    }
}
#[doc = "The FW Region 3 Permission 1 Register defines the permissions for the slave Imsram32kx64e_main_3.slv region 3 firewall.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fw_regs_imsram32kx64e_main_3_slv_fw_region_3_permission_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fw_regs_imsram32kx64e_main_3_slv_fw_region_3_permission_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec;
impl crate::RegisterSpec for FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_imsram32kx64e_main_3_slv_fw_region_3_permission_1::R`](R) reader structure"]
impl crate::Readable for FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_imsram32kx64e_main_3_slv_fw_region_3_permission_1::W`](W) writer structure"]
impl crate::Writable for FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Imsram32kx64e_main_3_slv_fw_region_3_permission_1 to value 0"]
impl crate::Resettable for FwRegsImsram32kx64eMain3SlvFwRegion3Permission1Spec {
