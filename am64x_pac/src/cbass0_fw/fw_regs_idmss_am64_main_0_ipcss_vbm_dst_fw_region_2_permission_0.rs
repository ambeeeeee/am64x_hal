#[doc = "Register `FW_REGS_Idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0` reader"]
pub type R = crate::R<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec>;
#[doc = "Register `FW_REGS_Idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0` writer"]
pub type W = crate::W<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        &mut self,
    ) -> NonsecSupvCacheableW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure user cacheable allowed."]
    ...
    pub fn nonsec_user_cacheable(
        &mut self,
    ) -> NonsecUserCacheableW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
...
Allowed privid."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec> {
        PrivIdW::new(self, 16)
    }
}
#[doc = "The FW Region 2 Permission 0 Register defines the permissions for the slave Idmss_am64_main_0.ipcss_vbm_dst region 2 firewall.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fw_regs_idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fw_regs_idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec;
impl crate::RegisterSpec for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0::R`](R) reader structure"]
impl crate::Readable for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0::W`](W) writer structure"]
impl crate::Writable for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Idmss_am64_main_0_ipcss_vbm_dst_fw_region_2_permission_0 to value 0"]
impl crate::Resettable for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion2Permission0Spec {
