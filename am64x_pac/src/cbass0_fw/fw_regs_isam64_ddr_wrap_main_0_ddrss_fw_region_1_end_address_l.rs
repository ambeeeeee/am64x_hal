#[doc = "Register `FW_REGS_Isam64_ddr_wrap_main_0_ddrss_fw_region_1_end_address_l` reader"]
pub type R = crate::R<FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec>;
#[doc = "Register `FW_REGS_Isam64_ddr_wrap_main_0_ddrss_fw_region_1_end_address_l` writer"]
pub type W = crate::W<FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec>;
...
End address bits 11 to 0 are forced to 1s as address must be 4KB aligned minus 1."]
    ...
    pub fn end_address_lsb(
        &mut self,
    ) -> EndAddressLsbW<FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec> {
...
End address bits 31 to 12 to include in the match. Lowest 12 bits are forced to 1s as address must be 4KB aligned."]
    ...
    pub fn end_address_l(
        &mut self,
    ) -> EndAddressLW<FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec> {
...
pub struct FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec;
impl crate::RegisterSpec for FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_isam64_ddr_wrap_main_0_ddrss_fw_region_1_end_address_l::R`](R) reader structure"]
impl crate::Readable for FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_isam64_ddr_wrap_main_0_ddrss_fw_region_1_end_address_l::W`](W) writer structure"]
impl crate::Writable for FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Isam64_ddr_wrap_main_0_ddrss_fw_region_1_end_address_l to value 0x4095"]
impl crate::Resettable for FwRegsIsam64DdrWrapMain0DdrssFwRegion1EndAddressLSpec {
