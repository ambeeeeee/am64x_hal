#[doc = "Register `FW_REGS_Imsram32kx64e_main_6_slv_fw_region_2_end_address_l` reader"]
pub type R = crate::R<FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec>;
#[doc = "Register `FW_REGS_Imsram32kx64e_main_6_slv_fw_region_2_end_address_l` writer"]
pub type W = crate::W<FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec>;
...
End address bits 11 to 0 are forced to 1s as address must be 4KB aligned minus 1."]
    ...
    pub fn end_address_lsb(
        &mut self,
    ) -> EndAddressLsbW<FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec> {
...
End address bits 31 to 12 to include in the match. Lowest 12 bits are forced to 1s as address must be 4KB aligned."]
    ...
    pub fn end_address_l(
        &mut self,
    ) -> EndAddressLW<FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec> {
...
pub struct FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec;
impl crate::RegisterSpec for FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_imsram32kx64e_main_6_slv_fw_region_2_end_address_l::R`](R) reader structure"]
impl crate::Readable for FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_imsram32kx64e_main_6_slv_fw_region_2_end_address_l::W`](W) writer structure"]
impl crate::Writable for FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Imsram32kx64e_main_6_slv_fw_region_2_end_address_l to value 0x4095"]
impl crate::Resettable for FwRegsImsram32kx64eMain6SlvFwRegion2EndAddressLSpec {
