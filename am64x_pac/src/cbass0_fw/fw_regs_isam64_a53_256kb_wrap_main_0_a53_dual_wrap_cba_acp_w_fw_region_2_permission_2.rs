#[doc = "Register `FW_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2` reader"]
pub type R = crate::R<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>;
#[doc = "Register `FW_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2` writer"]
pub type W = crate::W<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>;
...
Secure supervisor write allowed."]
    ...
    pub fn sec_supv_write(
        &mut self,
    ) -> SecSupvWriteW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure supervisor read allowed."]
    ...
    pub fn sec_supv_read(
        &mut self,
    ) -> SecSupvReadW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure supervisor cacheable allowed."]
    ...
    pub fn sec_supv_cacheable(
        &mut self,
    ) -> SecSupvCacheableW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure supervisor debug allowed."]
    ...
    pub fn sec_supv_debug(
        &mut self,
    ) -> SecSupvDebugW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure user write allowed."]
    ...
    pub fn sec_user_write(
        &mut self,
    ) -> SecUserWriteW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure user read allowed."]
    ...
    pub fn sec_user_read(
        &mut self,
    ) -> SecUserReadW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure user cacheable allowed."]
    ...
    pub fn sec_user_cacheable(
        &mut self,
    ) -> SecUserCacheableW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Secure user debug allowed."]
    ...
    pub fn sec_user_debug(
        &mut self,
    ) -> SecUserDebugW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Non-secure supervisor write allowed."]
    ...
    pub fn nonsec_supv_write(
        &mut self,
    ) -> NonsecSupvWriteW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Non-secure supervisor read allowed."]
    ...
    pub fn nonsec_supv_read(
        &mut self,
    ) -> NonsecSupvReadW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Non-secure supervisor cacheable allowed."]
    ...
    pub fn nonsec_supv_cacheable(
        ...
        FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec,
    > {
...
Non-secure supervisor debug allowed."]
    ...
    pub fn nonsec_supv_debug(
        &mut self,
    ) -> NonsecSupvDebugW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Non-secure user write allowed."]
    ...
    pub fn nonsec_user_write(
        &mut self,
    ) -> NonsecUserWriteW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Non-secure user read allowed."]
    ...
    pub fn nonsec_user_read(
        &mut self,
    ) -> NonsecUserReadW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Non-secure user debug allowed."]
    ...
    pub fn nonsec_user_debug(
        &mut self,
    ) -> NonsecUserDebugW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec>
    {
...
Allowed privid."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec> {
        PrivIdW::new(self, 16)
    }
}
#[doc = "The FW Region 2 Permission 2 Register defines the permissions for the slave Isam64_a53_256kb_wrap_main_0.a53_dual_wrap_cba_acp_w region 2 firewall.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fw_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fw_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec;
impl crate::RegisterSpec
    for FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec
{
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2::R`](R) reader structure"]
impl crate::Readable for FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2::W`](W) writer structure"]
impl crate::Writable for FwRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAcpWFwRegion2Permission2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_acp_w_fw_region_2_permission_2 to value 0"]
