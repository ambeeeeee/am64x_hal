#[doc = "Register `FW_REGS_Idmss_am64_main_0_ipcss_vbm_dst_fw_region_0_end_address_l` reader"]
pub type R = crate::R<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec>;
#[doc = "Register `FW_REGS_Idmss_am64_main_0_ipcss_vbm_dst_fw_region_0_end_address_l` writer"]
pub type W = crate::W<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec>;
...
End address bits 11 to 0 are forced to 1s as address must be 4KB aligned minus 1."]
    ...
    pub fn end_address_lsb(
        &mut self,
    ) -> EndAddressLsbW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec> {
...
End address bits 31 to 12 to include in the match. Lowest 12 bits are forced to 1s as address must be 4KB aligned."]
    ...
    pub fn end_address_l(
        &mut self,
    ) -> EndAddressLW<FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec> {
...
pub struct FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec;
impl crate::RegisterSpec for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fw_regs_idmss_am64_main_0_ipcss_vbm_dst_fw_region_0_end_address_l::R`](R) reader structure"]
impl crate::Readable for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec {}
#[doc = "`write(|w| ..)` method takes [`fw_regs_idmss_am64_main_0_ipcss_vbm_dst_fw_region_0_end_address_l::W`](W) writer structure"]
impl crate::Writable for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FW_REGS_Idmss_am64_main_0_ipcss_vbm_dst_fw_region_0_end_address_l to value 0x4095"]
impl crate::Resettable for FwRegsIdmssAm64Main0IpcssVbmDstFwRegion0EndAddressLSpec {
