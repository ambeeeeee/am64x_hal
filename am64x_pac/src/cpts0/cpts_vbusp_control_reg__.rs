#[doc = "Register `CPTS_VBUSP_CONTROL_REG__` reader"]
pub type R = crate::R<CptsVbuspControlReg_Spec>;
#[doc = "Register `CPTS_VBUSP_CONTROL_REG__` writer"]
...
#[doc = "Time Stamp ESTF Generate Function Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpts_vbusp_control_reg__::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpts_vbusp_control_reg__::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CptsVbuspControlReg_Spec;
impl crate::RegisterSpec for CptsVbuspControlReg_Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpts_vbusp_control_reg__::R`](R) reader structure"]
impl crate::Readable for CptsVbuspControlReg_Spec {}
#[doc = "`write(|w| ..)` method takes [`cpts_vbusp_control_reg__::W`](W) writer structure"]
impl crate::Writable for CptsVbuspControlReg_Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPTS_VBUSP_CONTROL_REG__ to value 0"]
