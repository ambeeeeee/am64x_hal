#[doc = "Register `CFG_I2C_STAT` reader"]
pub type R = crate::R<CfgI2cStatSpec>;
#[doc = "Register `CFG_I2C_STAT` writer"]
pub type W = crate::W<CfgI2cStatSpec>;
...
Arbitration lost IRQ status This bit is automatically set by the hardware when it loses the Arbitration in master transmit mode, an interrupt is signaled to MPUSS During reads, it always returns 0"]
    #[inline(always)]
    #[must_use]
    pub fn al(&mut self) -> AlW<CfgI2cStatSpec> {
        AlW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
No acknowledgement IRQ status Bit is set when No Acknowledge has been received, an interrupt is signaled to MPUSS Write '1' to clear this bit"]
    #[inline(always)]
    #[must_use]
    pub fn nack(&mut self) -> NackW<CfgI2cStatSpec> {
        NackW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Register access ready IRQ status When set to '1' it indicates that previous access has been performed and registers are ready to be accessed again An interrupt is signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn ardy(&mut self) -> ArdyW<CfgI2cStatSpec> {
        ArdyW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Receive data ready IRQ status Set to '1' by core when receiver mode, a new data is able to be read When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn rrdy(&mut self) -> RrdyW<CfgI2cStatSpec> {
        RrdyW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Transmit data ready IRQ status Set to '1' by core when transmitter and when new data is requested When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn xrdy(&mut self) -> XrdyW<CfgI2cStatSpec> {
        XrdyW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
General call IRQ status Set to '1' by core when General call address detected and interrupt signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn gc(&mut self) -> GcW<CfgI2cStatSpec> {
        GcW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Start Condition IRQ status"]
    #[inline(always)]
    #[must_use]
    pub fn stc(&mut self) -> StcW<CfgI2cStatSpec> {
        StcW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Access Error IRQ status"]
    #[inline(always)]
    #[must_use]
    pub fn aerr(&mut self) -> AerrW<CfgI2cStatSpec> {
        AerrW::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Bus Free IRQ status"]
    #[inline(always)]
    #[must_use]
    pub fn bf(&mut self) -> BfW<CfgI2cStatSpec> {
        BfW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Address recognized as slave IRQ status"]
    #[inline(always)]
    #[must_use]
    pub fn aas(&mut self) -> AasW<CfgI2cStatSpec> {
        AasW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Transmit underflow statusWriting into this bit has no effect"]
    #[inline(always)]
    #[must_use]
    pub fn xudf(&mut self) -> XudfW<CfgI2cStatSpec> {
        XudfW::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Receive overrun statusWriting into this bit has no effect"]
    #[inline(always)]
    #[must_use]
    pub fn rovr(&mut self) -> RovrW<CfgI2cStatSpec> {
        RovrW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Bus busy statusWriting into this bit has no effect"]
    #[inline(always)]
    #[must_use]
    pub fn bb(&mut self) -> BbW<CfgI2cStatSpec> {
        BbW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Receive draining IRQ status"]
    #[inline(always)]
    #[must_use]
    pub fn rdr(&mut self) -> RdrW<CfgI2cStatSpec> {
        RdrW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Transmit draining IRQ status"]
    #[inline(always)]
    #[must_use]
    pub fn xdr(&mut self) -> XdrW<CfgI2cStatSpec> {
        XdrW::new(self, 14)
    }
}
#[doc = "I2C interrupt status vector (legacy).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_i2c_stat::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_i2c_stat::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgI2cStatSpec;
impl crate::RegisterSpec for CfgI2cStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_i2c_stat::R`](R) reader structure"]
impl crate::Readable for CfgI2cStatSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_i2c_stat::W`](W) writer structure"]
impl crate::Writable for CfgI2cStatSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_I2C_STAT to value 0"]
impl crate::Resettable for CfgI2cStatSpec {
