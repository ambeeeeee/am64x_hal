#[doc = "Register `CFG_I2C_IRQSTATUS` reader"]
pub type R = crate::R<CfgI2cIrqstatusSpec>;
#[doc = "Register `CFG_I2C_IRQSTATUS` writer"]
pub type W = crate::W<CfgI2cIrqstatusSpec>;
#[doc = "Field `AL` reader - 0:0\\]
Arbitration lost IRQ enabled status This bit is automatically set by the hardware when it loses the Arbitration in master transmit mode, an interrupt is signaled to MPUSS During reads, it always returns 0"]
pub type AlR = crate::BitReader;
#[doc = "Field `AL` writer - 0:0\\]
Arbitration lost IRQ enabled status This bit is automatically set by the hardware when it loses the Arbitration in master transmit mode, an interrupt is signaled to MPUSS During reads, it always returns 0"]
pub type AlW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NACK` reader - 1:1\\]
No acknowledgement IRQ enabled status Bit is set when No Acknowledge has been received, an interrupt is signaled to MPUSS Write '1' to clear this bit"]
...
Register access ready IRQ enabled status When set to '1' it indicates that previous access has been performed and registers are ready to be accessed again An interrupt is signaled to MPUSS Write '1' to clear"]
...
Receive data ready IRQ enabled status Set to '1' by core when receiver mode, a new data is able to be read When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
...
Transmit data ready IRQ enabled status Set to '1' by core when transmitter and when new data is requested When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
pub type XrdyR = crate::BitReader;
#[doc = "Field `XRDY` writer - 4:4\\]
Transmit data ready IRQ enabled status Set to '1' by core when transmitter and when new data is requested When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
pub type XrdyW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GC` reader - 5:5\\]
General call IRQ enabled status Set to '1' by core when General call address detected and interrupt signaled to MPUSS Write '1' to clear"]
...
Transmit underflow enabled statusWriting into this bit has no effect"]
...
Receive overrun enabled statusWriting into this bit has no effect"]
...
Bus busy enabled statusWriting into this bit has no effect"]
...
Arbitration lost IRQ enabled status This bit is automatically set by the hardware when it loses the Arbitration in master transmit mode, an interrupt is signaled to MPUSS During reads, it always returns 0"]
    #[inline(always)]
    #[must_use]
    pub fn al(&mut self) -> AlW<CfgI2cIrqstatusSpec> {
        AlW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
No acknowledgement IRQ enabled status Bit is set when No Acknowledge has been received, an interrupt is signaled to MPUSS Write '1' to clear this bit"]
    #[inline(always)]
    #[must_use]
    pub fn nack(&mut self) -> NackW<CfgI2cIrqstatusSpec> {
        NackW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Register access ready IRQ enabled status When set to '1' it indicates that previous access has been performed and registers are ready to be accessed again An interrupt is signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn ardy(&mut self) -> ArdyW<CfgI2cIrqstatusSpec> {
        ArdyW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Receive data ready IRQ enabled status Set to '1' by core when receiver mode, a new data is able to be read When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn rrdy(&mut self) -> RrdyW<CfgI2cIrqstatusSpec> {
        RrdyW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Transmit data ready IRQ enabled status Set to '1' by core when transmitter and when new data is requested When set to '1' by core, an interrupt is signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn xrdy(&mut self) -> XrdyW<CfgI2cIrqstatusSpec> {
        XrdyW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
General call IRQ enabled status Set to '1' by core when General call address detected and interrupt signaled to MPUSS Write '1' to clear"]
    #[inline(always)]
    #[must_use]
    pub fn gc(&mut self) -> GcW<CfgI2cIrqstatusSpec> {
        GcW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Start Condition IRQ enabled status"]
    #[inline(always)]
    #[must_use]
    pub fn stc(&mut self) -> StcW<CfgI2cIrqstatusSpec> {
        StcW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Access Error IRQ enabled status"]
    #[inline(always)]
    #[must_use]
    pub fn aerr(&mut self) -> AerrW<CfgI2cIrqstatusSpec> {
        AerrW::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Bus Free IRQ enabled status"]
    #[inline(always)]
    #[must_use]
    pub fn bf(&mut self) -> BfW<CfgI2cIrqstatusSpec> {
        BfW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Address recognized as slave IRQ enabled status"]
    #[inline(always)]
    #[must_use]
    pub fn aas(&mut self) -> AasW<CfgI2cIrqstatusSpec> {
        AasW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Transmit underflow enabled statusWriting into this bit has no effect"]
    #[inline(always)]
    #[must_use]
    pub fn xudf(&mut self) -> XudfW<CfgI2cIrqstatusSpec> {
        XudfW::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Receive overrun enabled statusWriting into this bit has no effect"]
    #[inline(always)]
    #[must_use]
    pub fn rovr(&mut self) -> RovrW<CfgI2cIrqstatusSpec> {
        RovrW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Bus busy enabled statusWriting into this bit has no effect"]
    #[inline(always)]
    #[must_use]
    pub fn bb(&mut self) -> BbW<CfgI2cIrqstatusSpec> {
        BbW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Receive draining IRQ enabled status"]
    #[inline(always)]
    #[must_use]
    pub fn rdr(&mut self) -> RdrW<CfgI2cIrqstatusSpec> {
        RdrW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Transmit draining IRQ enabled status"]
    #[inline(always)]
    #[must_use]
    pub fn xdr(&mut self) -> XdrW<CfgI2cIrqstatusSpec> {
        XdrW::new(self, 14)
    }
}
#[doc = "Per-event enabled interrupt status vector\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_i2c_irqstatus::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_i2c_irqstatus::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgI2cIrqstatusSpec;
impl crate::RegisterSpec for CfgI2cIrqstatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_i2c_irqstatus::R`](R) reader structure"]
impl crate::Readable for CfgI2cIrqstatusSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_i2c_irqstatus::W`](W) writer structure"]
impl crate::Writable for CfgI2cIrqstatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_I2C_IRQSTATUS to value 0"]
impl crate::Resettable for CfgI2cIrqstatusSpec {
