...
pub struct RegisterBlock {
    ...
    regs__ss_cfg__sscfg_ctl_cfg_14_reg: Regs_SsCfg_SscfgCtlCfg14Reg,
    _reserved15: [u8; 0x18],
...
impl RegisterBlock {
    ...
    #[doc = "0x44 - The Controller Config 14 Register contains various fields to control the configuration ports on the Arasan eMMC/SD Controller. For detailed functionality of the Arasan eMMC/SD Controller configuration ports please refer to its specification listed in Section 1.2. This register sets the fields in the Preset Values Register for HS400 inside the Arasan eMMC/SD Controller."]
    #[inline(always)]
    pub const fn regs__ss_cfg__sscfg_ctl_cfg_14_reg(&self) -> &Regs_SsCfg_SscfgCtlCfg14Reg {
        &self.regs__ss_cfg__sscfg_ctl_cfg_14_reg
    }
...
#[doc = "REGS__SS_CFG__SSCFG_CTL_CFG_14_REG (rw) register accessor: The Controller Config 14 Register contains various fields to control the configuration ports on the Arasan eMMC/SD Controller. For detailed functionality of the Arasan eMMC/SD Controller configuration ports please refer to its specification listed in Section 1.2. This register sets the fields in the Preset Values Register for HS400 inside the Arasan eMMC/SD Controller.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`regs__ss_cfg__sscfg_ctl_cfg_14_reg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`regs__ss_cfg__sscfg_ctl_cfg_14_reg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@regs__ss_cfg__sscfg_ctl_cfg_14_reg`]
module"]
#[doc(alias = "REGS__SS_CFG__SSCFG_CTL_CFG_14_REG")]
pub type Regs_SsCfg_SscfgCtlCfg14Reg =
    crate::Reg<regs__ss_cfg__sscfg_ctl_cfg_14_reg::Regs_SsCfg_SscfgCtlCfg14RegSpec>;
...
pub mod regs__ss_cfg__sscfg_ctl_cfg_14_reg;
