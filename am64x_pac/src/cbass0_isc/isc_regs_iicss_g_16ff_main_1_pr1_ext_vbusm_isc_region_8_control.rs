#[doc = "Register `ISC_REGS_Iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control` reader"]
pub type R = crate::R<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec>;
#[doc = "Register `ISC_REGS_Iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control` writer"]
pub type W = crate::W<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set the region values cannot be modified."]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Enable channel mode to match region to a chanid value. Otherwise use address mode to match region to an address range."]
    #[inline(always)]
    #[must_use]
    pub fn ch_mode(&mut self) -> ChModeW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        ChModeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Default region indication. The default region is used when all other regions do not match."]
    #[inline(always)]
    #[must_use]
    pub fn def(&mut self) -> DefW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        DefW::new(self, 6)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priv ID."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        PrivIdW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Make outgoing secure. A value of 0xA enables, others disable."]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Make outgoing non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn nonsec(&mut self) -> NonsecW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        NonsecW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
No privID replacement, pass through value."]
    #[inline(always)]
    #[must_use]
    pub fn pass(&mut self) -> PassW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        PassW::new(self, 21)
    }
    #[doc = "Bits 24:25 - 25:24\\]
Set outgoing priv attribute. If each bit is set then the outgoing priv bit is set."]
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PrivW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        PrivW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 27:26\\]
Clear output priv attribute. If each bit is set then the outgoing priv bit is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn nopriv(&mut self) -> NoprivW<IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec> {
        NoprivW::new(self, 26)
    }
}
#[doc = "The ISC Region 8 Control Register defines the control fields for the master Iicss_g_16ff_main_1.pr1_ext_vbusm region 8 ISC.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isc_regs_iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`isc_regs_iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec;
impl crate::RegisterSpec for IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control::R`](R) reader structure"]
impl crate::Readable for IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec {}
#[doc = "`write(|w| ..)` method takes [`isc_regs_iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control::W`](W) writer structure"]
impl crate::Writable for IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ISC_REGS_Iicss_g_16ff_main_1_pr1_ext_vbusm_isc_region_8_control to value 0x0001_3700"]
impl crate::Resettable for IscRegsIicssG16ffMain1Pr1ExtVbusmIscRegion8ControlSpec {
