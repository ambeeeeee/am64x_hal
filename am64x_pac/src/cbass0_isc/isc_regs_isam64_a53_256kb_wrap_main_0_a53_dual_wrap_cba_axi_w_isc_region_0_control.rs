#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_w_isc_region_0_control` reader"]
pub type R = crate::R<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec>;
#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_w_isc_region_0_control` writer"]
pub type W = crate::W<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    ...
    pub fn enable(
        &mut self,
    ) -> EnableW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set the region values cannot be modified."]
    ...
    pub fn lock(
        &mut self,
    ) -> LockW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Enable channel mode to match region to a chanid value. Otherwise use address mode to match region to an address range."]
    ...
    pub fn ch_mode(
        &mut self,
    ) -> ChModeW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        ChModeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Default region indication. The default region is used when all other regions do not match."]
    ...
    pub fn def(
        &mut self,
    ) -> DefW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        DefW::new(self, 6)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priv ID."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        PrivIdW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Make outgoing secure. A value of 0xA enables, others disable."]
    ...
    pub fn sec(
        &mut self,
    ) -> SecW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Make outgoing non-secure."]
    ...
    pub fn nonsec(
        &mut self,
    ) -> NonsecW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        NonsecW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
No privID replacement, pass through value."]
    ...
    pub fn pass(
        &mut self,
    ) -> PassW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        PassW::new(self, 21)
    }
    #[doc = "Bits 24:25 - 25:24\\]
Set outgoing priv attribute. If each bit is set then the outgoing priv bit is set."]
    ...
    pub fn priv_(
        &mut self,
    ) -> PrivW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        PrivW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 27:26\\]
Clear output priv attribute. If each bit is set then the outgoing priv bit is cleared."]
    ...
    pub fn nopriv(
        &mut self,
    ) -> NoprivW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec> {
        NoprivW::new(self, 26)
    }
}
...
pub struct IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec;
impl crate::RegisterSpec
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec
{
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_w_isc_region_0_control::R`](R) reader structure"]
impl crate::Readable for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec {}
#[doc = "`write(|w| ..)` method takes [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_w_isc_region_0_control::W`](W) writer structure"]
impl crate::Writable for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_w_isc_region_0_control to value 0x0400"]
impl crate::Resettable for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiWIscRegion0ControlSpec {
