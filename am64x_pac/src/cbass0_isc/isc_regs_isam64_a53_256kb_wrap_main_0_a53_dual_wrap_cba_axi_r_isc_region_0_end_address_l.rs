#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_end_address_l` reader"]
pub type R = crate::R<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec>;
#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_end_address_l` writer"]
pub type W = crate::W<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec>;
...
End address bits 11 to 0 are forced to Fs as address must be 4KB aligned."]
    ...
    pub fn end_address_lsb(
        &mut self,
    ) -> EndAddressLsbW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec>
    {
...
End address bits 31 to 12 to include in the match."]
    ...
    pub fn end_address_l(
        &mut self,
    ) -> EndAddressLW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec>
    {
...
pub struct IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec;
impl crate::RegisterSpec
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec
{
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_end_address_l::R`](R) reader structure"]
impl crate::Readable
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec
{
}
#[doc = "`write(|w| ..)` method takes [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_end_address_l::W`](W) writer structure"]
impl crate::Writable
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0EndAddressLSpec
{
...
#[doc = "`reset()` method sets ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_end_address_l to value 0x4095"]
