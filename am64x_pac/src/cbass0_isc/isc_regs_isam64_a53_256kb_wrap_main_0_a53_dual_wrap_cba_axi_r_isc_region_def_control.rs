#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_def_control` reader"]
pub type R = crate::R<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec>;
#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_def_control` writer"]
pub type W = crate::W<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    ...
    pub fn enable(
        &mut self,
    ) -> EnableW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set, the region values cannot be modified."]
    ...
    pub fn lock(
        &mut self,
    ) -> LockW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Enable channel mode to match region to a chanid value. Otherwise use address mode to match region to an address range."]
    ...
    pub fn ch_mode(
        &mut self,
    ) -> ChModeW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        ChModeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Default region indication. The default region is used when all other regions do not match."]
    ...
    pub fn def(
        &mut self,
    ) -> DefW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        DefW::new(self, 6)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priv ID value to use if pass is 0."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        PrivIdW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Make outgoing secure. A value of 0xA forces secure set, others do nothing. Do not set both sec and nonsec."]
    ...
    pub fn sec(
        &mut self,
    ) -> SecW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Make outgoing non-secure. A value of 1 forces secure clear, others do nothing. Do not set both sec and nonsec."]
    ...
    pub fn nonsec(
        &mut self,
    ) -> NonsecW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        NonsecW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
No privID replacement. A value of 1 will pass through privid value. A value of 0 will replace privid with priv_id field value."]
    ...
    pub fn pass(
        &mut self,
    ) -> PassW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        PassW::new(self, 21)
    }
    #[doc = "Bits 24:25 - 25:24\\]
Set outgoing priv attribute. If each bit is set then the outgoing priv bit is set, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    ...
    pub fn priv_(
        &mut self,
    ) -> PrivW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        PrivW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 27:26\\]
Clear output priv attribute. If each bit is set then the outgoing priv bit is cleared, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    ...
    pub fn nopriv(
        &mut self,
    ) -> NoprivW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec> {
        NoprivW::new(self, 26)
    }
}
...
pub struct IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec;
impl crate::RegisterSpec
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec
{
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_def_control::R`](R) reader structure"]
impl crate::Readable for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec {}
#[doc = "`write(|w| ..)` method takes [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_def_control::W`](W) writer structure"]
impl crate::Writable for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegionDefControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_def_control to value 0x0450"]
