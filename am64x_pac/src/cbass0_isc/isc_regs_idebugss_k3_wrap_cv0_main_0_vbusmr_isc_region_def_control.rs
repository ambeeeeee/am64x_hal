#[doc = "Register `ISC_REGS_Idebugss_k3_wrap_cv0_main_0_vbusmr_isc_region_def_control` reader"]
pub type R = crate::R<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec>;
#[doc = "Register `ISC_REGS_Idebugss_k3_wrap_cv0_main_0_vbusmr_isc_region_def_control` writer"]
pub type W = crate::W<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    ...
    pub fn enable(
        &mut self,
    ) -> EnableW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set, the region values cannot be modified."]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Enable channel mode to match region to a chanid value. Otherwise use address mode to match region to an address range."]
    ...
    pub fn ch_mode(
        &mut self,
    ) -> ChModeW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        ChModeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Default region indication. The default region is used when all other regions do not match."]
    #[inline(always)]
    #[must_use]
    pub fn def(&mut self) -> DefW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        DefW::new(self, 6)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priv ID value to use if pass is 0."]
    ...
    pub fn priv_id(
        &mut self,
    ) -> PrivIdW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        PrivIdW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Make outgoing secure. A value of 0xA forces secure set, others do nothing. Do not set both sec and nonsec."]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Make outgoing non-secure. A value of 1 forces secure clear, others do nothing. Do not set both sec and nonsec."]
    ...
    pub fn nonsec(
        &mut self,
    ) -> NonsecW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        NonsecW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
No privID replacement. A value of 1 will pass through privid value. A value of 0 will replace privid with priv_id field value."]
    #[inline(always)]
    #[must_use]
    pub fn pass(&mut self) -> PassW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        PassW::new(self, 21)
    }
    #[doc = "Bits 24:25 - 25:24\\]
Set outgoing priv attribute. If each bit is set then the outgoing priv bit is set, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PrivW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        PrivW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 27:26\\]
Clear output priv attribute. If each bit is set then the outgoing priv bit is cleared, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    ...
    pub fn nopriv(
        &mut self,
    ) -> NoprivW<IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec> {
        NoprivW::new(self, 26)
    }
}
...
pub struct IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec;
impl crate::RegisterSpec for IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_idebugss_k3_wrap_cv0_main_0_vbusmr_isc_region_def_control::R`](R) reader structure"]
impl crate::Readable for IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec {}
#[doc = "`write(|w| ..)` method takes [`isc_regs_idebugss_k3_wrap_cv0_main_0_vbusmr_isc_region_def_control::W`](W) writer structure"]
impl crate::Writable for IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ISC_REGS_Idebugss_k3_wrap_cv0_main_0_vbusmr_isc_region_def_control to value 0x0001_7750"]
impl crate::Resettable for IscRegsIdebugssK3WrapCv0Main0VbusmrIscRegionDefControlSpec {
