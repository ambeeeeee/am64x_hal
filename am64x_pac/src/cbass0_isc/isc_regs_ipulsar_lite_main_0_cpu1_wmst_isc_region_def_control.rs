#[doc = "Register `ISC_REGS_Ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control` reader"]
pub type R = crate::R<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec>;
#[doc = "Register `ISC_REGS_Ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control` writer"]
pub type W = crate::W<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set, the region values cannot be modified."]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Enable channel mode to match region to a chanid value. Otherwise use address mode to match region to an address range."]
    #[inline(always)]
    #[must_use]
    pub fn ch_mode(&mut self) -> ChModeW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        ChModeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Default region indication. The default region is used when all other regions do not match."]
    #[inline(always)]
    #[must_use]
    pub fn def(&mut self) -> DefW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        DefW::new(self, 6)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priv ID value to use if pass is 0."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        PrivIdW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Make outgoing secure. A value of 0xA forces secure set, others do nothing. Do not set both sec and nonsec."]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Make outgoing non-secure. A value of 1 forces secure clear, others do nothing. Do not set both sec and nonsec."]
    #[inline(always)]
    #[must_use]
    pub fn nonsec(&mut self) -> NonsecW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        NonsecW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
No privID replacement. A value of 1 will pass through privid value. A value of 0 will replace privid with priv_id field value."]
    #[inline(always)]
    #[must_use]
    pub fn pass(&mut self) -> PassW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        PassW::new(self, 21)
    }
    #[doc = "Bits 24:25 - 25:24\\]
Set outgoing priv attribute. If each bit is set then the outgoing priv bit is set, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PrivW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        PrivW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 27:26\\]
Clear output priv attribute. If each bit is set then the outgoing priv bit is cleared, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    #[inline(always)]
    #[must_use]
    pub fn nopriv(&mut self) -> NoprivW<IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec> {
        NoprivW::new(self, 26)
    }
}
#[doc = "The ISC Default Region Control Register defines the control fields for the master Ipulsar_lite_main_0.cpu1_wmst region 1 ISC.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isc_regs_ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`isc_regs_ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec;
impl crate::RegisterSpec for IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control::R`](R) reader structure"]
impl crate::Readable for IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec {}
#[doc = "`write(|w| ..)` method takes [`isc_regs_ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control::W`](W) writer structure"]
impl crate::Writable for IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ISC_REGS_Ipulsar_lite_main_0_cpu1_wmst_isc_region_def_control to value 0x0002_1350"]
impl crate::Resettable for IscRegsIpulsarLiteMain0Cpu1WmstIscRegionDefControlSpec {
