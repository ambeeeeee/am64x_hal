#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_start_address_l` reader"]
pub type R = crate::R<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec>;
#[doc = "Register `ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_start_address_l` writer"]
pub type W = crate::W<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec>;
...
Start address bits 11 to 0 must be 0 as address must be 4KB aligned in address mode. Can also be channel number in channel mode."]
    ...
    pub fn start_address_lsb(
        ...
        IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec,
    > {
...
Start address bits 31 to 12."]
    ...
    pub fn start_address_l(
        &mut self,
    ) -> StartAddressLW<IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec>
    {
...
pub struct IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec;
impl crate::RegisterSpec
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec
{
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_start_address_l::R`](R) reader structure"]
impl crate::Readable
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec
{
}
#[doc = "`write(|w| ..)` method takes [`isc_regs_isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_start_address_l::W`](W) writer structure"]
impl crate::Writable
    for IscRegsIsam64A53_256kbWrapMain0A53DualWrapCbaAxiRIscRegion0StartAddressLSpec
{
...
#[doc = "`reset()` method sets ISC_REGS_Isam64_a53_256kb_wrap_main_0_a53_dual_wrap_cba_axi_r_isc_region_0_start_address_l to value 0"]
