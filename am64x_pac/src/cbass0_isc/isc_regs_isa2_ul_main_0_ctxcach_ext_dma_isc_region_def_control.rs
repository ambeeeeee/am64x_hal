#[doc = "Register `ISC_REGS_Isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control` reader"]
pub type R = crate::R<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec>;
#[doc = "Register `ISC_REGS_Isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control` writer"]
pub type W = crate::W<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec>;
...
Enable region. A value of 0xA enables, others disable."]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Lock region. Once set, the region values cannot be modified."]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        LockW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Enable channel mode to match region to a chanid value. Otherwise use address mode to match region to an address range."]
    #[inline(always)]
    #[must_use]
    pub fn ch_mode(&mut self) -> ChModeW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        ChModeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Default region indication. The default region is used when all other regions do not match."]
    #[inline(always)]
    #[must_use]
    pub fn def(&mut self) -> DefW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        DefW::new(self, 6)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priv ID value to use if pass is 0."]
    #[inline(always)]
    #[must_use]
    pub fn priv_id(&mut self) -> PrivIdW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        PrivIdW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Make outgoing secure. A value of 0xA forces secure set, others do nothing. Do not set both sec and nonsec."]
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SecW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        SecW::new(self, 16)
    }
    #[doc = "Bit 20 - 20:20\\]
Make outgoing non-secure. A value of 1 forces secure clear, others do nothing. Do not set both sec and nonsec."]
    #[inline(always)]
    #[must_use]
    pub fn nonsec(&mut self) -> NonsecW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        NonsecW::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
No privID replacement. A value of 1 will pass through privid value. A value of 0 will replace privid with priv_id field value."]
    #[inline(always)]
    #[must_use]
    pub fn pass(&mut self) -> PassW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        PassW::new(self, 21)
    }
    #[doc = "Bits 24:25 - 25:24\\]
Set outgoing priv attribute. If each bit is set then the outgoing priv bit is set, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PrivW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        PrivW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 27:26\\]
Clear output priv attribute. If each bit is set then the outgoing priv bit is cleared, else the bit is unchanged. Do not set both priv and nopriv for the same bit."]
    #[inline(always)]
    #[must_use]
    pub fn nopriv(&mut self) -> NoprivW<IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec> {
        NoprivW::new(self, 26)
    }
}
#[doc = "The ISC Default Region Control Register defines the control fields for the master Isa2_ul_main_0.ctxcach_ext_dma region 1 ISC.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isc_regs_isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`isc_regs_isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec;
impl crate::RegisterSpec for IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isc_regs_isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control::R`](R) reader structure"]
impl crate::Readable for IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec {}
#[doc = "`write(|w| ..)` method takes [`isc_regs_isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control::W`](W) writer structure"]
impl crate::Writable for IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ISC_REGS_Isa2_ul_main_0_ctxcach_ext_dma_isc_region_def_control to value 0x0001_5250"]
impl crate::Resettable for IscRegsIsa2UlMain0CtxcachExtDmaIscRegionDefControlSpec {
    const RESET_VALUE: u32 = 0x0001_5250;
}
