#[doc = "Register `PKTDMA_RING_SIZE` reader"]
pub type R = crate::R<PktdmaRingSizeSpec>;
#[doc = "Register `PKTDMA_RING_SIZE` writer"]
pub type W = crate::W<PktdmaRingSizeSpec>;
...
Tx Ring element count. This field configures the size of the ring in elements."]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SizeW<PktdmaRingSizeSpec> {
        SizeW::new(self, 0)
    }
    #[doc = "Bits 24:26"]
    #[inline(always)]
    #[must_use]
    pub fn ring_elsize(&mut self) -> RingElsizeW<PktdmaRingSizeSpec> {
...
Defines the mode for this ring or queue."]
    #[inline(always)]
    #[must_use]
    pub fn qmode(&mut self) -> QmodeW<PktdmaRingSizeSpec> {
        QmodeW::new(self, 29)
    }
}
#[doc = "The Ring Size Register contains the element count for the ring which is used to hand off pending work for the channel from the Host. A write to this register will reset the associated ring to clear the occupancies and reset the pointers.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pktdma_ring_size::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pktdma_ring_size::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PktdmaRingSizeSpec;
impl crate::RegisterSpec for PktdmaRingSizeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pktdma_ring_size::R`](R) reader structure"]
impl crate::Readable for PktdmaRingSizeSpec {}
#[doc = "`write(|w| ..)` method takes [`pktdma_ring_size::W`](W) writer structure"]
impl crate::Writable for PktdmaRingSizeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PKTDMA_RING_SIZE to value 0x2100_0000"]
impl crate::Resettable for PktdmaRingSizeSpec {
