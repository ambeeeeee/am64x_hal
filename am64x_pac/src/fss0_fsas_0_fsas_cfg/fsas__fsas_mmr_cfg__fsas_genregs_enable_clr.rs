#[doc = "Register `FSAS__FSAS_MMR_CFG__FSAS_GENREGS_ENABLE_CLR` reader"]
pub type R = crate::R<Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec>;
#[doc = "Register `FSAS__FSAS_MMR_CFG__FSAS_GENREGS_ENABLE_CLR` writer"]
pub type W = crate::W<Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec>;
...
ECC error on 1 bits. correctable"]
    #[inline(always)]
    #[must_use]
    pub fn ecc_error_1bit(&mut self) -> EccError1bitW<Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec> {
...
ECC error on 2 bits. Not correctable"]
    #[inline(always)]
    #[must_use]
    pub fn ecc_error_2bit(&mut self) -> EccError2bitW<Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec> {
...
Write is not aligned to 32B boundary or not a multiple of 32B"]
    ...
    pub fn ecc_write_nonalign(
        &mut self,
    ) -> EccWriteNonalignW<Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec> {
        EccWriteNonalignW::new(self, 2)
    }
}
#[doc = "The IRQ_ENABLE_CLR register allows the interrupt sources to be manually disabled when writing a 1 to a specific bit. Write 0: No action Write 1: Disable event Read 0: Event is disabled Read 1: Event is enabled\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fsas__fsas_mmr_cfg__fsas_genregs_enable_clr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fsas__fsas_mmr_cfg__fsas_genregs_enable_clr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec;
impl crate::RegisterSpec for Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fsas__fsas_mmr_cfg__fsas_genregs_enable_clr::R`](R) reader structure"]
impl crate::Readable for Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec {}
#[doc = "`write(|w| ..)` method takes [`fsas__fsas_mmr_cfg__fsas_genregs_enable_clr::W`](W) writer structure"]
impl crate::Writable for Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FSAS__FSAS_MMR_CFG__FSAS_GENREGS_ENABLE_CLR to value 0"]
impl crate::Resettable for Fsas_FsasMmrCfg_FsasGenregsEnableClrSpec {
