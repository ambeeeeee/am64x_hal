#[doc = "Register `APBADDR_DBG_CPU0_EDVIDSR` reader"]
pub type R = crate::R<ApbaddrDbgCpu0EdvidsrSpec>;
#[doc = "Register `APBADDR_DBG_CPU0_EDVIDSR` writer"]
pub type W = crate::W<ApbaddrDbgCpu0EdvidsrSpec>;
...
VMID sample. The value of VTTBR_EL2.VMID associated with the most recent EDPCSR sample. If EDVIDSR.NS == 0 or EDVIDSR.E2 == 1, this field is RAZ."]
    #[inline(always)]
    #[must_use]
    pub fn vmid(&mut self) -> VmidW<ApbaddrDbgCpu0EdvidsrSpec> {
        VmidW::new(self, 0)
    }
    #[doc = "Bits 8:27 - 27:8\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edvidsr_27_8(&mut self) -> Res0Edvidsr27_8W<ApbaddrDbgCpu0EdvidsrSpec> {
...
is RAZ."]
    #[inline(always)]
    #[must_use]
    pub fn hv(&mut self) -> HvW<ApbaddrDbgCpu0EdvidsrSpec> {
        HvW::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Exception level 3 status sample. Indicates whether the most recent EDPCSR sample was associated with AArch64 EL3. If EDVIDSR.NS == 1 or the processor was in AArch32 state when EDPCSR was read, this bit is 0."]
    #[inline(always)]
    #[must_use]
    pub fn e3(&mut self) -> E3W<ApbaddrDbgCpu0EdvidsrSpec> {
        E3W::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
Exception level 2 status sample. Indicates whether the most recent EDPCSR sample was associated with EL2. If EDVIDSR.NS == 0, this bit is 0."]
    #[inline(always)]
    #[must_use]
    pub fn e2(&mut self) -> E2W<ApbaddrDbgCpu0EdvidsrSpec> {
        E2W::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Non-secure state sample. Indicates the security state associated with the most recent EDPCSR sample."]
    #[inline(always)]
    #[must_use]
    pub fn ns(&mut self) -> NsW<ApbaddrDbgCpu0EdvidsrSpec> {
        NsW::new(self, 31)
    }
}
#[doc = "External Debug Virtual Context Sample Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu0_edvidsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu0_edvidsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu0EdvidsrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu0EdvidsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu0_edvidsr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu0EdvidsrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu0_edvidsr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu0EdvidsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU0_EDVIDSR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu0EdvidsrSpec {
