#[doc = "Register `APBADDR_DBG_CPU0_EDDEVARCH` reader"]
pub type R = crate::R<ApbaddrDbgCpu0EddevarchSpec>;
#[doc = "Register `APBADDR_DBG_CPU0_EDDEVARCH` writer"]
pub type W = crate::W<ApbaddrDbgCpu0EddevarchSpec>;
...
are the architecture part number, 0xA15.This corresponds to debug architecture version v8-A."]
    #[inline(always)]
    #[must_use]
    pub fn archid(&mut self) -> ArchidW<ApbaddrDbgCpu0EddevarchSpec> {
        ArchidW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Defines the architecture revision. For architectures defined by ARM this is the minor revision.For debug, the revision defined by v8-A is 0x0.All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrDbgCpu0EddevarchSpec> {
...
When set to 1, indicates that the DEVARCH is present.This field is 1 in v8-A."]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PresentW<ApbaddrDbgCpu0EddevarchSpec> {
...
are the JEP 106 ID code, 0x3B."]
    #[inline(always)]
    #[must_use]
    pub fn architect(&mut self) -> ArchitectW<ApbaddrDbgCpu0EddevarchSpec> {
        ArchitectW::new(self, 21)
    }
}
#[doc = "External Debug Device Architecture Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu0_eddevarch::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu0_eddevarch::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu0EddevarchSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu0EddevarchSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu0_eddevarch::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu0EddevarchSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu0_eddevarch::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu0EddevarchSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU0_EDDEVARCH to value 0xae32_7157"]
impl crate::Resettable for ApbaddrDbgCpu0EddevarchSpec {
