#[doc = "Register `APBADDR_DBG_CPU0_EDECR` reader"]
pub type R = crate::R<ApbaddrDbgCpu0EdecrSpec>;
#[doc = "Register `APBADDR_DBG_CPU0_EDECR` writer"]
pub type W = crate::W<ApbaddrDbgCpu0EdecrSpec>;
...
OS unlock catch enabled. Possible values of this field are: 0 OS unlock catch debug event disabled. 1 OS unlock catch debug event enabled."]
    #[inline(always)]
    #[must_use]
    pub fn osuce(&mut self) -> OsuceW<ApbaddrDbgCpu0EdecrSpec> {
        OsuceW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Reset catch enable. Possible values of this field are: 0 Reset catch debug event disabled. 1 Reset catch debug event enabled."]
    #[inline(always)]
    #[must_use]
    pub fn rce(&mut self) -> RceW<ApbaddrDbgCpu0EdecrSpec> {
        RceW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Halting step enable. Possible values of this field are: 0 Halting step debug event disabled. 1 Halting step debug event enabled. If the value of EDECR.SS is changed when the processor is in Non-debug state, the resulting value of EDECR.SS is UNKNOWN."]
    #[inline(always)]
    #[must_use]
    pub fn ss(&mut self) -> SsW<ApbaddrDbgCpu0EdecrSpec> {
        SsW::new(self, 2)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edecr_31_3(&mut self) -> Res0Edecr31_3W<ApbaddrDbgCpu0EdecrSpec> {
        Res0Edecr31_3W::new(self, 3)
    }
}
#[doc = "External Debug Execution Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu0_edecr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu0_edecr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu0EdecrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu0EdecrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu0_edecr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu0EdecrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu0_edecr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu0EdecrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU0_EDECR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu0EdecrSpec {
