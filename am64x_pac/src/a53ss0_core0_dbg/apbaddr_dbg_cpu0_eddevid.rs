#[doc = "Register `APBADDR_DBG_CPU0_EDDEVID` reader"]
pub type R = crate::R<ApbaddrDbgCpu0EddevidSpec>;
#[doc = "Register `APBADDR_DBG_CPU0_EDDEVID` writer"]
pub type W = crate::W<ApbaddrDbgCpu0EddevidSpec>;
...
Indicates the level of Sample-based profiling support using external debug registers 40 through 43. Permitted values of this field in v8-A are: 0000 Architecture-defined form of Sample-based profiling not implemented. 0010 EDPCSR and EDCIDSR are implemented \\[only permitted if EL3 and EL2 are not implemented\\]. 0011 EDPCSR, EDCIDSR, and EDVIDSR are implemented. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn pcsample(&mut self) -> PcsampleW<ApbaddrDbgCpu0EddevidSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_eddevid_23_4(&mut self) -> Res0Eddevid23_4W<ApbaddrDbgCpu0EddevidSpec> {
...
Indicates support for Auxiliary registers. Permitted values for this field are: 0000 None supported. 0001 Support for External Debug Auxiliary Control Register, EDACR. All other values are reserved."]
    #[inline(always)]
    #[must_use]
    pub fn auxregs(&mut self) -> AuxregsW<ApbaddrDbgCpu0EddevidSpec> {
...
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_eddevid_31_28(&mut self) -> Res0Eddevid31_28W<ApbaddrDbgCpu0EddevidSpec> {
        Res0Eddevid31_28W::new(self, 28)
    }
}
#[doc = "External Debug Device ID Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu0_eddevid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu0_eddevid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu0EddevidSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu0EddevidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu0_eddevid::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu0EddevidSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu0_eddevid::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu0EddevidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU0_EDDEVID to value 0x03"]
impl crate::Resettable for ApbaddrDbgCpu0EddevidSpec {
