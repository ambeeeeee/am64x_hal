#[doc = "Register `APBADDR_DBG_CPU0_MIDR_EL1` reader"]
pub type R = crate::R<ApbaddrDbgCpu0MidrEl1Spec>;
#[doc = "Register `APBADDR_DBG_CPU0_MIDR_EL1` writer"]
pub type W = crate::W<ApbaddrDbgCpu0MidrEl1Spec>;
...
An IMPLEMENTATION DEFINED revision number for the device"]
    #[inline(always)]
    #[must_use]
    pub fn revision(&mut self) -> RevisionW<ApbaddrDbgCpu0MidrEl1Spec> {
...
An IMPLEMENTATION DEFINED primary part number for the device. On processors implemented by ARM if the top four bits of the primary part number are 0x0 or 0x7 the variant and architecture are encoded differently"]
    #[inline(always)]
    #[must_use]
    pub fn partnum(&mut self) -> PartnumW<ApbaddrDbgCpu0MidrEl1Spec> {
        PartnumW::new(self, 4)
    }
    #[doc = "Bits 16:19"]
    #[inline(always)]
    #[must_use]
    pub fn architecture(&mut self) -> ArchitectureW<ApbaddrDbgCpu0MidrEl1Spec> {
...
An IMPLEMENTATION DEFINED variant number. Typically this field is used to distinguish between different product variants or major revisions of a product."]
    #[inline(always)]
    #[must_use]
    pub fn variant(&mut self) -> VariantW<ApbaddrDbgCpu0MidrEl1Spec> {
...
The Implementer code. This field must hold an implementer code that has been assigned by ARM."]
    #[inline(always)]
    #[must_use]
    pub fn implementer(&mut self) -> ImplementerW<ApbaddrDbgCpu0MidrEl1Spec> {
        ImplementerW::new(self, 24)
    }
}
#[doc = "Main ID Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu0_midr_el1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu0_midr_el1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu0MidrEl1Spec;
impl crate::RegisterSpec for ApbaddrDbgCpu0MidrEl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu0_midr_el1::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu0MidrEl1Spec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu0_midr_el1::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu0MidrEl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU0_MIDR_EL1 to value 0x6517_3314"]
impl crate::Resettable for ApbaddrDbgCpu0MidrEl1Spec {
