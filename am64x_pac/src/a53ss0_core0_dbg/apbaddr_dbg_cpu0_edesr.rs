#[doc = "Register `APBADDR_DBG_CPU0_EDESR` reader"]
pub type R = crate::R<ApbaddrDbgCpu0EdesrSpec>;
#[doc = "Register `APBADDR_DBG_CPU0_EDESR` writer"]
pub type W = crate::W<ApbaddrDbgCpu0EdesrSpec>;
...
OS unlock debug event pending. Possible values of this field are: 0 Reading this means that an OS unlock catch debug event is not pending. Writing this means no action. 1 Reading this means that an OS unlock catch debug event is pending. Writing this clears the pending OS unlock catch debug event."]
    #[inline(always)]
    #[must_use]
    pub fn osuc(&mut self) -> OsucW<ApbaddrDbgCpu0EdesrSpec> {
        OsucW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Reset catch debug event pending. Possible values of this field are: 0 Reading this means that a Reset catch debug event is not pending. Writing this means no action. 1 Reading this means that a Reset catch debug event is pending. Writing this clears the pending Reset catch debug event."]
    #[inline(always)]
    #[must_use]
    pub fn rc(&mut self) -> RcW<ApbaddrDbgCpu0EdesrSpec> {
        RcW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Halting step debug event pending. Possible values of this field are: 0 Reading this means that a Halting step debug event is not pending. Writing this means no action. 1 Reading this means that a Halting step debug event is pending. Writing this clears the pending Halting step debug event."]
    #[inline(always)]
    #[must_use]
    pub fn ss(&mut self) -> SsW<ApbaddrDbgCpu0EdesrSpec> {
        SsW::new(self, 2)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Reserved, RES0."]
    #[inline(always)]
    #[must_use]
    pub fn res0_edesr_31_3(&mut self) -> Res0Edesr31_3W<ApbaddrDbgCpu0EdesrSpec> {
        Res0Edesr31_3W::new(self, 3)
    }
}
#[doc = "External Debug Event Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apbaddr_dbg_cpu0_edesr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apbaddr_dbg_cpu0_edesr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbaddrDbgCpu0EdesrSpec;
impl crate::RegisterSpec for ApbaddrDbgCpu0EdesrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`apbaddr_dbg_cpu0_edesr::R`](R) reader structure"]
impl crate::Readable for ApbaddrDbgCpu0EdesrSpec {}
#[doc = "`write(|w| ..)` method takes [`apbaddr_dbg_cpu0_edesr::W`](W) writer structure"]
impl crate::Writable for ApbaddrDbgCpu0EdesrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets APBADDR_DBG_CPU0_EDESR to value 0"]
impl crate::Resettable for ApbaddrDbgCpu0EdesrSpec {
