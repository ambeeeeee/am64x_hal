#[doc = "Register `CFG_CH1CONF` reader"]
pub type R = crate::R<CfgCh1confSpec>;
#[doc = "Register `CFG_CH1CONF` writer"]
pub type W = crate::W<CfgCh1confSpec>;
...
pub type Tcs1R = crate::FieldReader;
#[doc = "Field `TCS1` writer - 26:25\\]
Chip Select Time Control This 2-bits field defines the number of interface clock cycles between CS toggling and first or last edge of SPI clock"]
pub type Tcs1W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
Chip Select Time Control This 2-bits field defines the number of interface clock cycles between CS toggling and first or last edge of SPI clock"]
    ...
    pub fn tcs1(&self) -> Tcs1R {
        Tcs1R::new(((self.bits >> 25) & 3) as u8)
    }
    #[doc = "Bit 27 - 27:27\\]
FIFO enabled for Transmit:Only one channel can have this bit field set"]
    #[inline(always)]
...
SPICLK phase"]
    #[inline(always)]
    #[must_use]
    pub fn pha(&mut self) -> PhaW<CfgCh1confSpec> {
        PhaW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
SPICLK polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> PolW<CfgCh1confSpec> {
        PolW::new(self, 1)
    }
    #[doc = "Bits 2:5 - 5:2\\]
Frequency divider for SPICLK \\[only when the module is a Master SPI device\\]
...
is set to 0"]
    #[inline(always)]
    #[must_use]
    pub fn clkd(&mut self) -> ClkdW<CfgCh1confSpec> {
        ClkdW::new(self, 2)
    }
    #[doc = "Bit 6 - 6:6\\]
SPIEN polarity"]
    #[inline(always)]
    #[must_use]
    pub fn epol(&mut self) -> EpolW<CfgCh1confSpec> {
        EpolW::new(self, 6)
    }
    #[doc = "Bits 7:11 - 11:7\\]
SPI word length"]
    #[inline(always)]
    #[must_use]
    pub fn wl(&mut self) -> WlW<CfgCh1confSpec> {
        WlW::new(self, 7)
    }
    #[doc = "Bits 12:13 - 13:12\\]
Transmit/Receive modes"]
    #[inline(always)]
    #[must_use]
    pub fn trm(&mut self) -> TrmW<CfgCh1confSpec> {
        TrmW::new(self, 12)
    }
    #[doc = "Bit 14 - 14:14\\]
DMA Write request The DMA Write request line is asserted when The channel is enabled and the transmitter register of the channel is empty The DMA Write request line is deasserted on load completion of the transmitter register of the channel"]
    #[inline(always)]
    #[must_use]
    pub fn dmaw(&mut self) -> DmawW<CfgCh1confSpec> {
        DmawW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
DMA Read request The DMA Read request line is asserted when the channel is enabled and a new data is available in the receive register of the channel The DMA Read request line is deasserted on read completion of the receive register of the channel"]
    #[inline(always)]
    #[must_use]
    pub fn dmar(&mut self) -> DmarW<CfgCh1confSpec> {
        DmarW::new(self, 15)
    }
    #[doc = "Bit 16 - 16:16\\]
Transmission Enable for data line 0 \\[SPIDATAGZEN\\[0\\]\\]"]
    #[inline(always)]
    #[must_use]
    pub fn dpe0(&mut self) -> Dpe0W<CfgCh1confSpec> {
        Dpe0W::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
Transmission Enable for data line 1 \\[SPIDATAGZEN\\[1\\]\\]"]
    #[inline(always)]
    #[must_use]
    pub fn dpe1(&mut self) -> Dpe1W<CfgCh1confSpec> {
        Dpe1W::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
Input Select"]
    #[inline(always)]
    #[must_use]
    pub fn is(&mut self) -> IsW<CfgCh1confSpec> {
        IsW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
Turbo mode"]
    #[inline(always)]
    #[must_use]
    pub fn turbo(&mut self) -> TurboW<CfgCh1confSpec> {
        TurboW::new(self, 19)
    }
    #[doc = "Bit 20 - 20:20\\]
Manual SPIEN assertion to keep SPIEN active between SPI words \\[single channel master mode only\\]"]
    #[inline(always)]
    #[must_use]
    pub fn force(&mut self) -> ForceW<CfgCh1confSpec> {
        ForceW::new(self, 20)
    }
    #[doc = "Bit 23 - 23:23\\]
Start bit enable for SPI transfer"]
    #[inline(always)]
    #[must_use]
    pub fn sbe(&mut self) -> SbeW<CfgCh1confSpec> {
        SbeW::new(self, 23)
    }
    #[doc = "Bit 24 - 24:24\\]
Start bit polarity"]
    #[inline(always)]
    #[must_use]
    pub fn sbpol(&mut self) -> SbpolW<CfgCh1confSpec> {
        SbpolW::new(self, 24)
    }
    #[doc = "Bits 25:26 - 26:25\\]
Chip Select Time Control This 2-bits field defines the number of interface clock cycles between CS toggling and first or last edge of SPI clock"]
    #[inline(always)]
    #[must_use]
    pub fn tcs1(&mut self) -> Tcs1W<CfgCh1confSpec> {
        Tcs1W::new(self, 25)
    }
    #[doc = "Bit 27 - 27:27\\]
FIFO enabled for Transmit:Only one channel can have this bit field set"]
    #[inline(always)]
    #[must_use]
    pub fn ffew(&mut self) -> FfewW<CfgCh1confSpec> {
        FfewW::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
FIFO enabled for receive:Only one channel can have this bit field set"]
    #[inline(always)]
    #[must_use]
    pub fn ffer(&mut self) -> FferW<CfgCh1confSpec> {
        FferW::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Clock divider granularity This register defines the granularity of channel clock divider: power of two or one clock cycle granularity When this bit is set the register MCSPI_CHCTRL\\[EXTCLK\\]
...
values"]
    #[inline(always)]
    #[must_use]
    pub fn clkg(&mut self) -> ClkgW<CfgCh1confSpec> {
        ClkgW::new(self, 29)
    }
}
#[doc = "This register is dedicated to the configuration of the channel.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_ch1conf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_ch1conf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgCh1confSpec;
impl crate::RegisterSpec for CfgCh1confSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_ch1conf::R`](R) reader structure"]
impl crate::Readable for CfgCh1confSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_ch1conf::W`](W) writer structure"]
impl crate::Writable for CfgCh1confSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_CH1CONF to value 0x0006_0000"]
impl crate::Resettable for CfgCh1confSpec {
