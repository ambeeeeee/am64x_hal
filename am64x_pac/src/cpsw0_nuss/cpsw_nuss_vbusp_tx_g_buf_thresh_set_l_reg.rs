#[doc = "Register `CPSW_NUSS_VBUSP_TX_G_BUF_THRESH_SET_L_REG` reader"]
pub type R = crate::R<CpswNussVbuspTxGBufThreshSetLRegSpec>;
#[doc = "Register `CPSW_NUSS_VBUSP_TX_G_BUF_THRESH_SET_L_REG` writer"]
pub type W = crate::W<CpswNussVbuspTxGBufThreshSetLRegSpec>;
...
Priority Based Flow Control Global Buffer Usage Threshold for Priority 0"]
    #[inline(always)]
    #[must_use]
    pub fn pri0(&mut self) -> Pri0W<CpswNussVbuspTxGBufThreshSetLRegSpec> {
        Pri0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Priority Based Flow Control Global Buffer Usage Threshold for Priority 1"]
    #[inline(always)]
    #[must_use]
    pub fn pri1(&mut self) -> Pri1W<CpswNussVbuspTxGBufThreshSetLRegSpec> {
        Pri1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - 23:16\\]
Priority Based Flow Control Global Buffer Usage Threshold for Priority 2"]
    #[inline(always)]
    #[must_use]
    pub fn pri2(&mut self) -> Pri2W<CpswNussVbuspTxGBufThreshSetLRegSpec> {
        Pri2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
Priority Based Flow Control Global Buffer Usage Threshold for Priority 3"]
    #[inline(always)]
    #[must_use]
    pub fn pri3(&mut self) -> Pri3W<CpswNussVbuspTxGBufThreshSetLRegSpec> {
        Pri3W::new(self, 24)
    }
}
#[doc = "CPSW PFC Global Tx Buffer Threshold Set Low\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpsw_nuss_vbusp_tx_g_buf_thresh_set_l_reg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpsw_nuss_vbusp_tx_g_buf_thresh_set_l_reg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpswNussVbuspTxGBufThreshSetLRegSpec;
impl crate::RegisterSpec for CpswNussVbuspTxGBufThreshSetLRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpsw_nuss_vbusp_tx_g_buf_thresh_set_l_reg::R`](R) reader structure"]
impl crate::Readable for CpswNussVbuspTxGBufThreshSetLRegSpec {}
#[doc = "`write(|w| ..)` method takes [`cpsw_nuss_vbusp_tx_g_buf_thresh_set_l_reg::W`](W) writer structure"]
impl crate::Writable for CpswNussVbuspTxGBufThreshSetLRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPSW_NUSS_VBUSP_TX_G_BUF_THRESH_SET_L_REG to value 0x0257_5755"]
impl crate::Resettable for CpswNussVbuspTxGBufThreshSetLRegSpec {
