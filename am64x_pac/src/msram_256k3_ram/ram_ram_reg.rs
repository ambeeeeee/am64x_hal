#[doc = "Register `RAM_RAM_REG` reader"]
pub type R = crate::R<RamRamRegSpec>;
#[doc = "Register `RAM_RAM_REG` writer"]
pub type W = crate::W<RamRamRegSpec>;
...
This is the LS byte"]
    #[inline(always)]
    #[must_use]
    pub fn byte0(&mut self) -> Byte0W<RamRamRegSpec> {
        Byte0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
This is the LM byte"]
    #[inline(always)]
    #[must_use]
    pub fn byte1(&mut self) -> Byte1W<RamRamRegSpec> {
        Byte1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - 23:16\\]
This is the UM byte"]
    #[inline(always)]
    #[must_use]
    pub fn byte2(&mut self) -> Byte2W<RamRamRegSpec> {
        Byte2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
This is the MS byte"]
    #[inline(always)]
    #[must_use]
    pub fn byte3(&mut self) -> Byte3W<RamRamRegSpec> {
        Byte3W::new(self, 24)
    }
}
#[doc = "The RAM memory words provide memory mapped random access data storage.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram_ram_reg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram_ram_reg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RamRamRegSpec;
impl crate::RegisterSpec for RamRamRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram_ram_reg::R`](R) reader structure"]
impl crate::Readable for RamRamRegSpec {}
#[doc = "`write(|w| ..)` method takes [`ram_ram_reg::W`](W) writer structure"]
impl crate::Writable for RamRamRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM_RAM_REG to value 0"]
impl crate::Resettable for RamRamRegSpec {
