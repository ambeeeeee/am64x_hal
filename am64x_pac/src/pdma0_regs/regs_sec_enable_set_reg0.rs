...
Interrupt Enable Set Register for tpcf0_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn tpcf0_ramecc_enable_set(&mut self) -> Tpcf0RameccEnableSetW<RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for tpcf1_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn tpcf1_ramecc_enable_set(&mut self) -> Tpcf1RameccEnableSetW<RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for rpcf0_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn rpcf0_ramecc_enable_set(&mut self) -> Rpcf0RameccEnableSetW<RegsSecEnableSetReg0Spec> {
...
Interrupt Enable Set Register for rpcf1_ramecc_pend"]
    #[inline(always)]
    #[must_use]
    pub fn rpcf1_ramecc_enable_set(&mut self) -> Rpcf1RameccEnableSetW<RegsSecEnableSetReg0Spec> {
