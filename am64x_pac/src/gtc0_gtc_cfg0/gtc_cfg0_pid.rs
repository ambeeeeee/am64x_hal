#[doc = "Register `GTC_CFG0_PID` reader"]
pub type R = crate::R<GtcCfg0PidSpec>;
#[doc = "Register `GTC_CFG0_PID` writer"]
pub type W = crate::W<GtcCfg0PidSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid_minor(&mut self) -> PidMinorW<GtcCfg0PidSpec> {
        PidMinorW::new(self, 0)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
    #[must_use]
    pub fn pid_custom(&mut self) -> PidCustomW<GtcCfg0PidSpec> {
        PidCustomW::new(self, 6)
    }
    #[doc = "Bits 8:10"]
    #[inline(always)]
    #[must_use]
    pub fn pid_major(&mut self) -> PidMajorW<GtcCfg0PidSpec> {
        PidMajorW::new(self, 8)
    }
    #[doc = "Bits 11:15"]
    #[inline(always)]
    #[must_use]
    pub fn pid_misc(&mut self) -> PidMiscW<GtcCfg0PidSpec> {
        PidMiscW::new(self, 11)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn pid_msb16(&mut self) -> PidMsb16W<GtcCfg0PidSpec> {
        PidMsb16W::new(self, 16)
    }
}
#[doc = "GTC_CFG0_PID\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gtc_cfg0_pid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gtc_cfg0_pid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GtcCfg0PidSpec;
impl crate::RegisterSpec for GtcCfg0PidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gtc_cfg0_pid::R`](R) reader structure"]
impl crate::Readable for GtcCfg0PidSpec {}
#[doc = "`write(|w| ..)` method takes [`gtc_cfg0_pid::W`](W) writer structure"]
impl crate::Writable for GtcCfg0PidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GTC_CFG0_PID to value 0x0209"]
impl crate::Resettable for GtcCfg0PidSpec {
    const RESET_VALUE: u32 = 0x0209;
}
