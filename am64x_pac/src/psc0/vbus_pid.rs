#[doc = "Register `VBUS_PID` reader"]
pub type R = crate::R<VbusPidSpec>;
#[doc = "Register `VBUS_PID` writer"]
pub type W = crate::W<VbusPidSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn minor(&mut self) -> MinorW<VbusPidSpec> {
        MinorW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<VbusPidSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn major(&mut self) -> MajorW<VbusPidSpec> {
        MajorW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release"]
    #[inline(always)]
    #[must_use]
    pub fn rtl(&mut self) -> RtlW<VbusPidSpec> {
        RtlW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<VbusPidSpec> {
        FuncW::new(self, 16)
    }
    #[doc = "Bits 28:29 - 29:28\\]
Business Unit"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<VbusPidSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
PID register scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<VbusPidSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "The peripheral identification register is a constant register that contains the ID and ID revision number for that module. The PID stores version information used to identify the module. All bits within this register are read-only (writes have no effect) meaning that the values within this register should be hard-coded with the appropriate values and must not change from their hard-coded values.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vbus_pid::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vbus_pid::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VbusPidSpec;
impl crate::RegisterSpec for VbusPidSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vbus_pid::R`](R) reader structure"]
impl crate::Readable for VbusPidSpec {}
#[doc = "`write(|w| ..)` method takes [`vbus_pid::W`](W) writer structure"]
impl crate::Writable for VbusPidSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VBUS_PID to value 0x5154_0200"]
impl crate::Resettable for VbusPidSpec {
    const RESET_VALUE: u32 = 0x5154_0200;
}
