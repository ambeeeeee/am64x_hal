#[doc = "Register `__ECCAGGR_CFG__REGS_ded_enable_clr_reg0` reader"]
pub type R = crate::R<_EccaggrCfg_RegsDedEnableClrReg0Spec>;
#[doc = "Register `__ECCAGGR_CFG__REGS_ded_enable_clr_reg0` writer"]
pub type W = crate::W<_EccaggrCfg_RegsDedEnableClrReg0Spec>;
...
Interrupt Enable Clear Register for eccagg_pend"]
    #[inline(always)]
    #[must_use]
    pub fn eccagg_enable_clr(&mut self) -> EccaggEnableClrW<_EccaggrCfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for k3vtm_n16ffc_mmr_edc_ctrl_busecc_pend"]
    ...
    pub fn k3vtm_n16ffc_mmr_edc_ctrl_busecc_enable_clr(
        &mut self,
    ) -> K3vtmN16ffcMmrEdcCtrlBuseccEnableClrW<_EccaggrCfg_RegsDedEnableClrReg0Spec> {
...
Interrupt Enable Clear Register for k3vtm_n16ffc_cfg_cbass_vbusp_p2p_bridge_vbusp_bridge_busecc_pend"]
    ...
    pub fn k3vtm_n16ffc_cfg_cbass_vbusp_p2p_bridge_vbusp_bridge_busecc_enable_clr(
        ...
        _EccaggrCfg_RegsDedEnableClrReg0Spec,
    > {
...
#[doc = "Interrupt Enable Clear Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`__eccaggr_cfg__regs_ded_enable_clr_reg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`__eccaggr_cfg__regs_ded_enable_clr_reg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _EccaggrCfg_RegsDedEnableClrReg0Spec;
impl crate::RegisterSpec for _EccaggrCfg_RegsDedEnableClrReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`__eccaggr_cfg__regs_ded_enable_clr_reg0::R`](R) reader structure"]
impl crate::Readable for _EccaggrCfg_RegsDedEnableClrReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`__eccaggr_cfg__regs_ded_enable_clr_reg0::W`](W) writer structure"]
impl crate::Writable for _EccaggrCfg_RegsDedEnableClrReg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets __ECCAGGR_CFG__REGS_ded_enable_clr_reg0 to value 0"]
impl crate::Resettable for _EccaggrCfg_RegsDedEnableClrReg0Spec {
