#[doc = "Register `__ECCAGGR_CFG__REGS_aggr_revision` reader"]
pub type R = crate::R<_EccaggrCfg_RegsAggrRevisionSpec>;
#[doc = "Register `__ECCAGGR_CFG__REGS_aggr_revision` writer"]
pub type W = crate::W<_EccaggrCfg_RegsAggrRevisionSpec>;
...
Minor version"]
    #[inline(always)]
    #[must_use]
    pub fn revmin(&mut self) -> RevminW<_EccaggrCfg_RegsAggrRevisionSpec> {
        RevminW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom version"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<_EccaggrCfg_RegsAggrRevisionSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major version"]
    #[inline(always)]
    #[must_use]
    pub fn revmaj(&mut self) -> RevmajW<_EccaggrCfg_RegsAggrRevisionSpec> {
        RevmajW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL version"]
    #[inline(always)]
    #[must_use]
    pub fn revrtl(&mut self) -> RevrtlW<_EccaggrCfg_RegsAggrRevisionSpec> {
        RevrtlW::new(self, 11)
    }
    #[doc = "Bits 16:27 - 27:16\\]
Module ID"]
    #[inline(always)]
    #[must_use]
    pub fn module_id(&mut self) -> ModuleIdW<_EccaggrCfg_RegsAggrRevisionSpec> {
...
bu"]
    #[inline(always)]
    #[must_use]
    pub fn bu(&mut self) -> BuW<_EccaggrCfg_RegsAggrRevisionSpec> {
        BuW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 31:30\\]
Scheme"]
    #[inline(always)]
    #[must_use]
    pub fn scheme(&mut self) -> SchemeW<_EccaggrCfg_RegsAggrRevisionSpec> {
        SchemeW::new(self, 30)
    }
}
#[doc = "Revision parameters\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`__eccaggr_cfg__regs_aggr_revision::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`__eccaggr_cfg__regs_aggr_revision::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _EccaggrCfg_RegsAggrRevisionSpec;
impl crate::RegisterSpec for _EccaggrCfg_RegsAggrRevisionSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`__eccaggr_cfg__regs_aggr_revision::R`](R) reader structure"]
impl crate::Readable for _EccaggrCfg_RegsAggrRevisionSpec {}
#[doc = "`write(|w| ..)` method takes [`__eccaggr_cfg__regs_aggr_revision::W`](W) writer structure"]
impl crate::Writable for _EccaggrCfg_RegsAggrRevisionSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets __ECCAGGR_CFG__REGS_aggr_revision to value 0x7696_2a01"]
impl crate::Resettable for _EccaggrCfg_RegsAggrRevisionSpec {
