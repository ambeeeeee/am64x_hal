#[doc = "Register `PR1_IEP1__SLV__REGS_digio_exp_reg` reader"]
pub type R = crate::R<Pr1Iep1_Slv_RegsDigioExpRegSpec>;
#[doc = "Register `PR1_IEP1__SLV__REGS_digio_exp_reg` writer"]
pub type W = crate::W<Pr1Iep1_Slv_RegsDigioExpRegSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sw_data_out_up(&mut self) -> SwDataOutUpW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        SwDataOutUpW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn outvalid_ovr_en(&mut self) -> OutvalidOvrEnW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        OutvalidOvrEnW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn sw_outvalid(&mut self) -> SwOutvalidW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        SwOutvalidW::new(self, 2)
    }
    #[doc = "Bits 4:7"]
    #[inline(always)]
    #[must_use]
    pub fn outvalid_dly(&mut self) -> OutvalidDlyW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        OutvalidDlyW::new(self, 4)
    }
    #[doc = "Bits 8:11"]
    #[inline(always)]
    #[must_use]
    pub fn sof_dly(&mut self) -> SofDlyW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        SofDlyW::new(self, 8)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn sof_sel(&mut self) -> SofSelW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        SofSelW::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn eof_sel(&mut self) -> EofSelW<Pr1Iep1_Slv_RegsDigioExpRegSpec> {
        EofSelW::new(self, 13)
    }
}
...
pub struct Pr1Iep1_Slv_RegsDigioExpRegSpec;
impl crate::RegisterSpec for Pr1Iep1_Slv_RegsDigioExpRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_iep1__slv__regs_digio_exp_reg::R`](R) reader structure"]
impl crate::Readable for Pr1Iep1_Slv_RegsDigioExpRegSpec {}
#[doc = "`write(|w| ..)` method takes [`pr1_iep1__slv__regs_digio_exp_reg::W`](W) writer structure"]
impl crate::Writable for Pr1Iep1_Slv_RegsDigioExpRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_IEP1__SLV__REGS_digio_exp_reg to value 0x20"]
impl crate::Resettable for Pr1Iep1_Slv_RegsDigioExpRegSpec {
