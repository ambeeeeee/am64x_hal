#[doc = "Register `PKTDMA_TCHANRT_TRT_STATUS0` reader"]
pub type R = crate::R<PktdmaTchanrtTrtStatus0Spec>;
#[doc = "Register `PKTDMA_TCHANRT_TRT_STATUS0` writer"]
pub type W = crate::W<PktdmaTchanrtTrtStatus0Spec>;
...
#[doc = "Field `TXQ_PEND` reader - 30:30\\]
The channel fifo is available"]
pub type TxqPendR = crate::BitReader;
#[doc = "Field `TXQ_PEND` writer - 30:30\\]
The channel fifo is available"]
pub type TxqPendW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRING_PEND` reader - 31:31\\]
The channel ring has a descriptor"]
pub type TringPendR = crate::BitReader;
#[doc = "Field `TRING_PEND` writer - 31:31\\]
The channel ring has a descriptor"]
pub type TringPendW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 16 - 16:16\\]
The channel is trying to schedule an error event"]
    #[inline(always)]
...
The channel fifo is available"]
    #[inline(always)]
    pub fn txq_pend(&self) -> TxqPendR {
        TxqPendR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - 31:31\\]
The channel ring has a descriptor"]
    #[inline(always)]
    pub fn tring_pend(&self) -> TringPendR {
        TringPendR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 16 - 16:16\\]
The channel is trying to schedule an error event"]
    #[inline(always)]
    #[must_use]
    pub fn err_event_reqs(&mut self) -> ErrEventReqsW<PktdmaTchanrtTrtStatus0Spec> {
...
The channel is sending a schedule request"]
    #[inline(always)]
    #[must_use]
    pub fn tx_reqs(&mut self) -> TxReqsW<PktdmaTchanrtTrtStatus0Spec> {
        TxReqsW::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
A teardown message is pending"]
    #[inline(always)]
    #[must_use]
    pub fn tdown_msg_pend(&mut self) -> TdownMsgPendW<PktdmaTchanrtTrtStatus0Spec> {
...
The fifo for the channel has space to place a burst size entry"]
    #[inline(always)]
    #[must_use]
    pub fn wavail(&mut self) -> WavailW<PktdmaTchanrtTrtStatus0Spec> {
        WavailW::new(self, 21)
    }
    #[doc = "Bit 22 - 22:22\\]
The channel is ready to be scheduled"]
    #[inline(always)]
    #[must_use]
    pub fn ok(&mut self) -> OkW<PktdmaTchanrtTrtStatus0Spec> {
        OkW::new(self, 22)
    }
    #[doc = "Bit 23 - 23:23\\]
The channel is currently in a packet"]
    #[inline(always)]
    #[must_use]
    pub fn in_packet(&mut self) -> InPacketW<PktdmaTchanrtTrtStatus0Spec> {
...
The channel has an outstanding transaction"]
    #[inline(always)]
    #[must_use]
    pub fn transbusy(&mut self) -> TransbusyW<PktdmaTchanrtTrtStatus0Spec> {
...
The channel is busy"]
    #[inline(always)]
    #[must_use]
    pub fn busy(&mut self) -> BusyW<PktdmaTchanrtTrtStatus0Spec> {
        BusyW::new(self, 25)
    }
    #[doc = "Bit 28 - 28:28\\]
There is an outstanding pktid for the channel"]
    #[inline(always)]
    #[must_use]
    pub fn pktid_busy(&mut self) -> PktidBusyW<PktdmaTchanrtTrtStatus0Spec> {
...
The channel has an available packet id"]
    #[inline(always)]
    #[must_use]
    pub fn pktid_avail(&mut self) -> PktidAvailW<PktdmaTchanrtTrtStatus0Spec> {
...
The channel fifo is available"]
    #[inline(always)]
    #[must_use]
    pub fn txq_pend(&mut self) -> TxqPendW<PktdmaTchanrtTrtStatus0Spec> {
        TxqPendW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
The channel ring has a descriptor"]
    #[inline(always)]
    #[must_use]
    pub fn tring_pend(&mut self) -> TringPendW<PktdmaTchanrtTrtStatus0Spec> {
        TringPendW::new(self, 31)
    }
}
#[doc = "The Status Register provides a read only view of channel status bits.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pktdma_tchanrt_trt_status0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pktdma_tchanrt_trt_status0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PktdmaTchanrtTrtStatus0Spec;
impl crate::RegisterSpec for PktdmaTchanrtTrtStatus0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pktdma_tchanrt_trt_status0::R`](R) reader structure"]
impl crate::Readable for PktdmaTchanrtTrtStatus0Spec {}
#[doc = "`write(|w| ..)` method takes [`pktdma_tchanrt_trt_status0::W`](W) writer structure"]
impl crate::Writable for PktdmaTchanrtTrtStatus0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PKTDMA_TCHANRT_TRT_STATUS0 to value 0"]
impl crate::Resettable for PktdmaTchanrtTrtStatus0Spec {
