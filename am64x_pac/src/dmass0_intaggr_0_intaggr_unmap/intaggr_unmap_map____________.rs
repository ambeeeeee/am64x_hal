#[doc = "Register `INTAGGR_UNMAP_map____________` reader"]
pub type R = crate::R<IntaggrUnmapMap_Spec>;
#[doc = "Register `INTAGGR_UNMAP_map____________` writer"]
...
#[doc = "The Global Event Mapping register controls the egress global event index for this unmapped event. This register may also be optionally used to directly set an interrupt status bit by using the irqmode flag.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intaggr_unmap_map____________::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`intaggr_unmap_map____________::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntaggrUnmapMap_Spec;
impl crate::RegisterSpec for IntaggrUnmapMap_Spec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`intaggr_unmap_map____________::R`](R) reader structure"]
impl crate::Readable for IntaggrUnmapMap_Spec {}
#[doc = "`write(|w| ..)` method takes [`intaggr_unmap_map____________::W`](W) writer structure"]
impl crate::Writable for IntaggrUnmapMap_Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets INTAGGR_UNMAP_map____________ to value 0"]
