#[doc = "Register `INTAGGR_UNMAP_map_____________` reader"]
pub type R = crate::R<IntaggrUnmapMap_Spec>;
#[doc = "Register `INTAGGR_UNMAP_map_____________` writer"]
