#[doc = "Register `CFG_I2C_IRQENABLE_SET` reader"]
pub type R = crate::R<CfgI2cIrqenableSetSpec>;
#[doc = "Register `CFG_I2C_IRQENABLE_SET` writer"]
pub type W = crate::W<CfgI2cIrqenableSetSpec>;
...
No acknowledgement interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[NACK\\]"]
...
Register access ready interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[ARDY\\]"]
...
Receive data ready interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[RRDY\\]"]
...
Transmit data ready interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[XRDY\\]"]
...
Start Condition interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[STC\\]"]
...
Access Error interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[AERR\\]"]
...
Bus Free interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[BF\\]"]
...
Receive Draining interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[RDR\\]"]
...
Transmit Draining interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[XDR\\]"]
...
Arbitration lost interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[AL\\]"]
    #[inline(always)]
    #[must_use]
    pub fn al_ie(&mut self) -> AlIeW<CfgI2cIrqenableSetSpec> {
        AlIeW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
No acknowledgement interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[NACK\\]"]
    #[inline(always)]
    #[must_use]
    pub fn nack_ie(&mut self) -> NackIeW<CfgI2cIrqenableSetSpec> {
        NackIeW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Register access ready interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[ARDY\\]"]
    #[inline(always)]
    #[must_use]
    pub fn ardy_ie(&mut self) -> ArdyIeW<CfgI2cIrqenableSetSpec> {
        ArdyIeW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Receive data ready interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[RRDY\\]"]
    #[inline(always)]
    #[must_use]
    pub fn rrdy_ie(&mut self) -> RrdyIeW<CfgI2cIrqenableSetSpec> {
        RrdyIeW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Transmit data ready interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[XRDY\\]"]
    #[inline(always)]
    #[must_use]
    pub fn xrdy_ie(&mut self) -> XrdyIeW<CfgI2cIrqenableSetSpec> {
        XrdyIeW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
General call Interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[GC\\]"]
    #[inline(always)]
    #[must_use]
    pub fn gc_ie(&mut self) -> GcIeW<CfgI2cIrqenableSetSpec> {
        GcIeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Start Condition interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[STC\\]"]
    #[inline(always)]
    #[must_use]
    pub fn stc_ie(&mut self) -> StcIeW<CfgI2cIrqenableSetSpec> {
        StcIeW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Access Error interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[AERR\\]"]
    #[inline(always)]
    #[must_use]
    pub fn aerr_ie(&mut self) -> AerrIeW<CfgI2cIrqenableSetSpec> {
        AerrIeW::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Bus Free interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[BF\\]"]
    #[inline(always)]
    #[must_use]
    pub fn bf_ie(&mut self) -> BfIeW<CfgI2cIrqenableSetSpec> {
        BfIeW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Addressed as Slave interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[AAS\\]"]
    #[inline(always)]
    #[must_use]
    pub fn ass_ie(&mut self) -> AssIeW<CfgI2cIrqenableSetSpec> {
        AssIeW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Transmit underflow enable set"]
    #[inline(always)]
    #[must_use]
    pub fn xudf(&mut self) -> XudfW<CfgI2cIrqenableSetSpec> {
        XudfW::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Receive overrun enable set"]
    #[inline(always)]
    #[must_use]
    pub fn rovr(&mut self) -> RovrW<CfgI2cIrqenableSetSpec> {
        RovrW::new(self, 11)
    }
    #[doc = "Bit 13 - 13:13\\]
Receive Draining interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[RDR\\]"]
    #[inline(always)]
    #[must_use]
    pub fn rdr_ie(&mut self) -> RdrIeW<CfgI2cIrqenableSetSpec> {
        RdrIeW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Transmit Draining interrupt enable set Mask or unmask the interrupt signaled by bit in I2C_STAT\\[XDR\\]"]
    #[inline(always)]
    #[must_use]
    pub fn xdr_ie(&mut self) -> XdrIeW<CfgI2cIrqenableSetSpec> {
        XdrIeW::new(self, 14)
    }
}
#[doc = "Per-event interrupt enable bit vector.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_i2c_irqenable_set::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_i2c_irqenable_set::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgI2cIrqenableSetSpec;
impl crate::RegisterSpec for CfgI2cIrqenableSetSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_i2c_irqenable_set::R`](R) reader structure"]
impl crate::Readable for CfgI2cIrqenableSetSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_i2c_irqenable_set::W`](W) writer structure"]
impl crate::Writable for CfgI2cIrqenableSetSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_I2C_IRQENABLE_SET to value 0"]
impl crate::Resettable for CfgI2cIrqenableSetSpec {
