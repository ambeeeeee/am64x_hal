#[doc = "Register `CFG_I2C_DMATXWAKE_EN` reader"]
pub type R = crate::R<CfgI2cDmatxwakeEnSpec>;
#[doc = "Register `CFG_I2C_DMATXWAKE_EN` writer"]
pub type W = crate::W<CfgI2cDmatxwakeEnSpec>;
...
Arbitration lost IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn al(&mut self) -> AlW<CfgI2cDmatxwakeEnSpec> {
        AlW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
No acknowledgment IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn nack(&mut self) -> NackW<CfgI2cDmatxwakeEnSpec> {
        NackW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Register access ready IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn ardy(&mut self) -> ArdyW<CfgI2cDmatxwakeEnSpec> {
        ArdyW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Receive/Transmit data ready IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn drdy(&mut self) -> DrdyW<CfgI2cDmatxwakeEnSpec> {
        DrdyW::new(self, 3)
    }
    #[doc = "Bit 5 - 5:5\\]
General call IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn gc(&mut self) -> GcW<CfgI2cDmatxwakeEnSpec> {
        GcW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Start Condition IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn stc(&mut self) -> StcW<CfgI2cDmatxwakeEnSpec> {
        StcW::new(self, 6)
    }
    #[doc = "Bit 8 - 8:8\\]
Bus Free IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn bf(&mut self) -> BfW<CfgI2cDmatxwakeEnSpec> {
        BfW::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Address as slave IRQ wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn aas(&mut self) -> AasW<CfgI2cDmatxwakeEnSpec> {
        AasW::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Transmit underflow wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn xudf(&mut self) -> XudfW<CfgI2cDmatxwakeEnSpec> {
        XudfW::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Receive overrun wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn rovr(&mut self) -> RovrW<CfgI2cDmatxwakeEnSpec> {
        RovrW::new(self, 11)
    }
    #[doc = "Bit 13 - 13:13\\]
Receive Draining wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn rdr(&mut self) -> RdrW<CfgI2cDmatxwakeEnSpec> {
        RdrW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Transmit Draining wakeup set"]
    #[inline(always)]
    #[must_use]
    pub fn xdr(&mut self) -> XdrW<CfgI2cDmatxwakeEnSpec> {
        XdrW::new(self, 14)
    }
}
#[doc = "Per-event DMA TX wakeup enable.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg_i2c_dmatxwake_en::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg_i2c_dmatxwake_en::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CfgI2cDmatxwakeEnSpec;
impl crate::RegisterSpec for CfgI2cDmatxwakeEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg_i2c_dmatxwake_en::R`](R) reader structure"]
impl crate::Readable for CfgI2cDmatxwakeEnSpec {}
#[doc = "`write(|w| ..)` method takes [`cfg_i2c_dmatxwake_en::W`](W) writer structure"]
impl crate::Writable for CfgI2cDmatxwakeEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG_I2C_DMATXWAKE_EN to value 0"]
impl crate::Resettable for CfgI2cDmatxwakeEnSpec {
