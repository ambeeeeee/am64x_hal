#[doc = "Register `PR1_IEP1__SLV__REGS_sync_ctrl_reg` reader"]
pub type R = crate::R<Pr1Iep1_Slv_RegsSyncCtrlRegSpec>;
#[doc = "Register `PR1_IEP1__SLV__REGS_sync_ctrl_reg` writer"]
pub type W = crate::W<Pr1Iep1_Slv_RegsSyncCtrlRegSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sync_en(&mut self) -> SyncEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        SyncEnW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn sync0_en(&mut self) -> Sync0EnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync0EnW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn sync1_en(&mut self) -> Sync1EnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync1EnW::new(self, 2)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn sync0_ack_en(&mut self) -> Sync0AckEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync0AckEnW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn sync0_cyclic_en(&mut self) -> Sync0CyclicEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync0CyclicEnW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn sync1_ack_en(&mut self) -> Sync1AckEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync1AckEnW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn sync1_cyclic_en(&mut self) -> Sync1CyclicEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync1CyclicEnW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn sync1_ind_en(&mut self) -> Sync1IndEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync1IndEnW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn sync0_out_nv_en(&mut self) -> Sync0OutNvEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
        Sync0OutNvEnW::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn sync1_out_nv_en(&mut self) -> Sync1OutNvEnW<Pr1Iep1_Slv_RegsSyncCtrlRegSpec> {
...
pub struct Pr1Iep1_Slv_RegsSyncCtrlRegSpec;
impl crate::RegisterSpec for Pr1Iep1_Slv_RegsSyncCtrlRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pr1_iep1__slv__regs_sync_ctrl_reg::R`](R) reader structure"]
impl crate::Readable for Pr1Iep1_Slv_RegsSyncCtrlRegSpec {}
#[doc = "`write(|w| ..)` method takes [`pr1_iep1__slv__regs_sync_ctrl_reg::W`](W) writer structure"]
impl crate::Writable for Pr1Iep1_Slv_RegsSyncCtrlRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PR1_IEP1__SLV__REGS_sync_ctrl_reg to value 0"]
impl crate::Resettable for Pr1Iep1_Slv_RegsSyncCtrlRegSpec {
