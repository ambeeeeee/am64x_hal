#[doc = "Register `ADCREGS_ENABLE_CLR` reader"]
pub type R = crate::R<AdcregsEnableClrSpec>;
#[doc = "Register `ADCREGS_ENABLE_CLR` writer"]
pub type W = crate::W<AdcregsEnableClrSpec>;
...
eoc from the analog front end missing at expected time after soc"]
    #[inline(always)]
    #[must_use]
    pub fn afe_eoc_missing(&mut self) -> AfeEocMissingW<AdcregsEnableClrSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn endofequence(&mut self) -> EndofequenceW<AdcregsEnableClrSpec> {
...
fifo thresholds met"]
    #[inline(always)]
    #[must_use]
    pub fn fifo0thrs(&mut self) -> Fifo0thrsW<AdcregsEnableClrSpec> {
...
fifo over flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo0ovfl(&mut self) -> Fifo0ovflW<AdcregsEnableClrSpec> {
...
fifo under flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo0unfl(&mut self) -> Fifo0unflW<AdcregsEnableClrSpec> {
...
fifo thresholds met"]
    #[inline(always)]
    #[must_use]
    pub fn fifo1thrs(&mut self) -> Fifo1thrsW<AdcregsEnableClrSpec> {
...
fifo over flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo1ovfl(&mut self) -> Fifo1ovflW<AdcregsEnableClrSpec> {
...
fifo under flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo1unfl(&mut self) -> Fifo1unflW<AdcregsEnableClrSpec> {
...
sample out of range"]
    #[inline(always)]
    #[must_use]
    pub fn outofrange(&mut self) -> OutofrangeW<AdcregsEnableClrSpec> {
        OutofrangeW::new(self, 8)
    }
}
#[doc = "The IRQ_ENABLE_CLR register allows the adc12 interrupt sources to be manually disabled when writing a 1 to a specific bit. Write 0: No action Write 1: Disable event Read 0: Event is disabled Read 1: Event is enabled\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adcregs_enable_clr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adcregs_enable_clr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcregsEnableClrSpec;
impl crate::RegisterSpec for AdcregsEnableClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_enable_clr::R`](R) reader structure"]
impl crate::Readable for AdcregsEnableClrSpec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_enable_clr::W`](W) writer structure"]
impl crate::Writable for AdcregsEnableClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_ENABLE_CLR to value 0"]
impl crate::Resettable for AdcregsEnableClrSpec {
