#[doc = "Register `ADCREGS_REVISION` reader"]
pub type R = crate::R<AdcregsRevisionSpec>;
#[doc = "Register `ADCREGS_REVISION` writer"]
pub type W = crate::W<AdcregsRevisionSpec>;
...
Minor revision"]
    #[inline(always)]
    #[must_use]
    pub fn revmin(&mut self) -> RevminW<AdcregsRevisionSpec> {
        RevminW::new(self, 0)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Custom"]
    #[inline(always)]
    #[must_use]
    pub fn custom(&mut self) -> CustomW<AdcregsRevisionSpec> {
        CustomW::new(self, 6)
    }
    #[doc = "Bits 8:10 - 10:8\\]
Major revision"]
    #[inline(always)]
    #[must_use]
    pub fn revmaj(&mut self) -> RevmajW<AdcregsRevisionSpec> {
        RevmajW::new(self, 8)
    }
    #[doc = "Bits 11:15 - 15:11\\]
RTL revision. Will vary depending on release."]
    #[inline(always)]
    #[must_use]
    pub fn revrtl(&mut self) -> RevrtlW<AdcregsRevisionSpec> {
        RevrtlW::new(self, 11)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Module ID field"]
    #[inline(always)]
    #[must_use]
    pub fn modid(&mut self) -> ModidW<AdcregsRevisionSpec> {
        ModidW::new(self, 16)
    }
}
#[doc = "IP Revision Identifier (X.Y.R) Used by software to track features, bugs, and compatibility\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adcregs_revision::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adcregs_revision::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcregsRevisionSpec;
impl crate::RegisterSpec for AdcregsRevisionSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_revision::R`](R) reader structure"]
impl crate::Readable for AdcregsRevisionSpec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_revision::W`](W) writer structure"]
impl crate::Writable for AdcregsRevisionSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_REVISION to value 0x3900"]
impl crate::Resettable for AdcregsRevisionSpec {
    const RESET_VALUE: u32 = 0x3900;
}
