#[doc = "Register `ADCREGS_FIFO1DATA` reader"]
pub type R = crate::R<AdcregsFifo1dataSpec>;
#[doc = "Register `ADCREGS_FIFO1DATA` writer"]
pub type W = crate::W<AdcregsFifo1dataSpec>;
...
sampled ADC converted data value stored in FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn adcdata(&mut self) -> AdcdataW<AdcregsFifo1dataSpec> {
        AdcdataW::new(self, 0)
    }
    #[doc = "Bits 16:19 - 19:16\\]
Optional ID tag of channel that captured the data. If tag option is disabled, these bits will be 0"]
    #[inline(always)]
    #[must_use]
    pub fn adcchanlid(&mut self) -> AdcchanlidW<AdcregsFifo1dataSpec> {
        AdcchanlidW::new(self, 16)
    }
}
#[doc = "A read from this register will auto increment the FIFO read pointer. If you read when FIFO is empty,it will trigger an underflow interrupt\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adcregs_fifo1data::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adcregs_fifo1data::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcregsFifo1dataSpec;
impl crate::RegisterSpec for AdcregsFifo1dataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_fifo1data::R`](R) reader structure"]
impl crate::Readable for AdcregsFifo1dataSpec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_fifo1data::W`](W) writer structure"]
impl crate::Writable for AdcregsFifo1dataSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_FIFO1DATA to value 0"]
impl crate::Resettable for AdcregsFifo1dataSpec {
