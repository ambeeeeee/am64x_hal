#[doc = "Register `ADCREGS_STEPDELAY_12` reader"]
pub type R = crate::R<AdcregsStepdelay12Spec>;
#[doc = "Register `ADCREGS_STEPDELAY_12` writer"]
pub type W = crate::W<AdcregsStepdelay12Spec>;
...
Program the number of ADC clock cycles to wait after applying the step configuration registers and before sending the start of ADC conversion"]
    #[inline(always)]
    #[must_use]
    pub fn opendelay(&mut self) -> OpendelayW<AdcregsStepdelay12Spec> {
...
number of ADC clock cycles to sample. Any value programmed here will be added to the minimum requirement of 1 clock cycle."]
    #[inline(always)]
    #[must_use]
    pub fn sampledelay(&mut self) -> SampledelayW<AdcregsStepdelay12Spec> {
        SampledelayW::new(self, 24)
    }
}
#[doc = "Controls number of clock periods to sample and delay\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adcregs_stepdelay_12::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adcregs_stepdelay_12::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcregsStepdelay12Spec;
impl crate::RegisterSpec for AdcregsStepdelay12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_stepdelay_12::R`](R) reader structure"]
impl crate::Readable for AdcregsStepdelay12Spec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_stepdelay_12::W`](W) writer structure"]
impl crate::Writable for AdcregsStepdelay12Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_STEPDELAY_12 to value 0"]
impl crate::Resettable for AdcregsStepdelay12Spec {
