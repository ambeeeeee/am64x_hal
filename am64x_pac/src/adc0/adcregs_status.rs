#[doc = "Register `ADCREGS_STATUS` reader"]
pub type R = crate::R<AdcregsStatusSpec>;
#[doc = "Register `ADCREGS_STATUS` writer"]
pub type W = crate::W<AdcregsStatusSpec>;
...
eoc from the analog front end missing at expected time after soc"]
    #[inline(always)]
    #[must_use]
    pub fn afe_eoc_missing(&mut self) -> AfeEocMissingW<AdcregsStatusSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn endofequence(&mut self) -> EndofequenceW<AdcregsStatusSpec> {
...
fifo thresholds met"]
    #[inline(always)]
    #[must_use]
    pub fn fifo0thrs(&mut self) -> Fifo0thrsW<AdcregsStatusSpec> {
...
fifo over flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo0ovfl(&mut self) -> Fifo0ovflW<AdcregsStatusSpec> {
...
fifo under flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo0unfl(&mut self) -> Fifo0unflW<AdcregsStatusSpec> {
...
fifo thresholds met"]
    #[inline(always)]
    #[must_use]
    pub fn fifo1thrs(&mut self) -> Fifo1thrsW<AdcregsStatusSpec> {
...
fifo over flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo1ovfl(&mut self) -> Fifo1ovflW<AdcregsStatusSpec> {
...
fifo under flow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo1unfl(&mut self) -> Fifo1unflW<AdcregsStatusSpec> {
...
sample out of range"]
    #[inline(always)]
    #[must_use]
    pub fn outofrange(&mut self) -> OutofrangeW<AdcregsStatusSpec> {
        OutofrangeW::new(self, 8)
    }
}
#[doc = "The IRQ_STATUS register allows the adc12 interrupt sources to be manually cleared when writing a 1 to a specific bit. Write 0: No action Write 1: Clear event Read 0: No event pending Read 1: Event pending\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adcregs_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adcregs_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcregsStatusSpec;
impl crate::RegisterSpec for AdcregsStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_status::R`](R) reader structure"]
impl crate::Readable for AdcregsStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_status::W`](W) writer structure"]
impl crate::Writable for AdcregsStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_STATUS to value 0"]
impl crate::Resettable for AdcregsStatusSpec {
