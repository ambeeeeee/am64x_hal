#[doc = "Register `ADCREGS_STEPCONFIG_15` reader"]
pub type R = crate::R<AdcregsStepconfig15Spec>;
#[doc = "Register `ADCREGS_STEPCONFIG_15` writer"]
pub type W = crate::W<AdcregsStepconfig15Spec>;
...
00 SW enabled one shot 01 SW enabled continuous 10 HW synchronized one-shot 11 HW synchronized continuous"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<AdcregsStepconfig15Spec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bits 2:4 - 4:2\\]
000 -> no average 001 -> 2 samples average 010 -> 4 samples average 011 -> 8 samples average 100 -> 16 samples average"]
    #[inline(always)]
    #[must_use]
    pub fn averaging(&mut self) -> AveragingW<AdcregsStepconfig15Spec> {
...
SEL_INM pins, negative differential"]
    #[inline(always)]
    #[must_use]
    pub fn sel_inm_swm(&mut self) -> SelInmSwmW<AdcregsStepconfig15Spec> {
...
SEL_INP pins SW configuration"]
    #[inline(always)]
    #[must_use]
    pub fn sel_inp_swc(&mut self) -> SelInpSwcW<AdcregsStepconfig15Spec> {
...
Differential control. Single ended when = 0, differential input when = 1"]
    #[inline(always)]
    #[must_use]
    pub fn diff_cntrl(&mut self) -> DiffCntrlW<AdcregsStepconfig15Spec> {
...
Sampled data will be stored in FIFO0 when = 0, FIFO1 when = 1"]
    #[inline(always)]
    #[must_use]
    pub fn fifosel(&mut self) -> FifoselW<AdcregsStepconfig15Spec> {
...
0 = no range sel 1 = compare ADC data with range"]
    #[inline(always)]
    #[must_use]
    pub fn rangecheck(&mut self) -> RangecheckW<AdcregsStepconfig15Spec> {
        RangecheckW::new(self, 27)
    }
}
#[doc = "The user should write to this register the values of the input pins send to the AFE during step 1. the StepConfig WriteEnable bit should be set to 1 before a write can occur.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adcregs_stepconfig_15::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adcregs_stepconfig_15::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcregsStepconfig15Spec;
impl crate::RegisterSpec for AdcregsStepconfig15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_stepconfig_15::R`](R) reader structure"]
impl crate::Readable for AdcregsStepconfig15Spec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_stepconfig_15::W`](W) writer structure"]
impl crate::Writable for AdcregsStepconfig15Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_STEPCONFIG_15 to value 0x0004_0000"]
impl crate::Resettable for AdcregsStepconfig15Spec {
