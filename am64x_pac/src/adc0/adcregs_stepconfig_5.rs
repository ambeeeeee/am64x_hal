#[doc = "Register `ADCREGS_STEPCONFIG_5` reader"]
pub type R = crate::R<AdcregsStepconfig5Spec>;
#[doc = "Register `ADCREGS_STEPCONFIG_5` writer"]
pub type W = crate::W<AdcregsStepconfig5Spec>;
...
00 SW enabled one shot 01 SW enabled continuous 10 HW synchronized one-shot 11 HW synchronized continuous"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<AdcregsStepconfig5Spec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bits 2:4 - 4:2\\]
000 -> no average 001 -> 2 samples average 010 -> 4 samples average 011 -> 8 samples average 100 -> 16 samples average"]
    #[inline(always)]
    #[must_use]
    pub fn averaging(&mut self) -> AveragingW<AdcregsStepconfig5Spec> {
...
SEL_INM pins, negative differential"]
    #[inline(always)]
    #[must_use]
    pub fn sel_inm_swm(&mut self) -> SelInmSwmW<AdcregsStepconfig5Spec> {
...
SEL_INP pins SW configuration"]
    #[inline(always)]
    #[must_use]
    pub fn sel_inp_swc(&mut self) -> SelInpSwcW<AdcregsStepconfig5Spec> {
...
Differential control. Single ended when = 0, differential input when = 1"]
    #[inline(always)]
    #[must_use]
    pub fn diff_cntrl(&mut self) -> DiffCntrlW<AdcregsStepconfig5Spec> {
...
Sampled data will be stored in FIFO0 when = 0, FIFO1 when = 1"]
    #[inline(always)]
    #[must_use]
    pub fn fifosel(&mut self) -> FifoselW<AdcregsStepconfig5Spec> {
...
0 = no range sel 1 = compare ADC data with range"]
    #[inline(always)]
    #[must_use]
    pub fn rangecheck(&mut self) -> RangecheckW<AdcregsStepconfig5Spec> {
...
pub struct AdcregsStepconfig5Spec;
impl crate::RegisterSpec for AdcregsStepconfig5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_stepconfig_5::R`](R) reader structure"]
impl crate::Readable for AdcregsStepconfig5Spec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_stepconfig_5::W`](W) writer structure"]
impl crate::Writable for AdcregsStepconfig5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_STEPCONFIG_5 to value 0x0004_0000"]
impl crate::Resettable for AdcregsStepconfig5Spec {
