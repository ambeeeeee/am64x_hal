#[doc = "Register `ADCREGS_STEPDELAY_6` reader"]
pub type R = crate::R<AdcregsStepdelay6Spec>;
#[doc = "Register `ADCREGS_STEPDELAY_6` writer"]
pub type W = crate::W<AdcregsStepdelay6Spec>;
...
Program the number of ADC clock cycles to wait after applying the step configuration registers and before sending the start of ADC conversion"]
    #[inline(always)]
    #[must_use]
    pub fn opendelay(&mut self) -> OpendelayW<AdcregsStepdelay6Spec> {
...
number of ADC clock cycles to sample. Any value programmed here will be added to the minimum requirement of 1 clock cycle."]
    #[inline(always)]
    #[must_use]
    pub fn sampledelay(&mut self) -> SampledelayW<AdcregsStepdelay6Spec> {
...
pub struct AdcregsStepdelay6Spec;
impl crate::RegisterSpec for AdcregsStepdelay6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcregs_stepdelay_6::R`](R) reader structure"]
impl crate::Readable for AdcregsStepdelay6Spec {}
#[doc = "`write(|w| ..)` method takes [`adcregs_stepdelay_6::W`](W) writer structure"]
impl crate::Writable for AdcregsStepdelay6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCREGS_STEPDELAY_6 to value 0"]
impl crate::Resettable for AdcregsStepdelay6Spec {
