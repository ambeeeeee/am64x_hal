#[doc = "Register `REGS5_MAILBOX_IRQ_EOI` reader"]
pub type R = crate::R<Regs5MailboxIrqEoiSpec>;
#[doc = "Register `REGS5_MAILBOX_IRQ_EOI` writer"]
pub type W = crate::W<Regs5MailboxIrqEoiSpec>;
...
Software EOI signal for the user 0 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi0(&mut self) -> Eoi0W<Regs5MailboxIrqEoiSpec> {
        Eoi0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software EOI signal for the user 1 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi1(&mut self) -> Eoi1W<Regs5MailboxIrqEoiSpec> {
        Eoi1W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Software EOI signal for the user 2 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi2(&mut self) -> Eoi2W<Regs5MailboxIrqEoiSpec> {
        Eoi2W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Software EOI signal for the user 3 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eoi3(&mut self) -> Eoi3W<Regs5MailboxIrqEoiSpec> {
        Eoi3W::new(self, 3)
    }
}
...
pub struct Regs5MailboxIrqEoiSpec;
impl crate::RegisterSpec for Regs5MailboxIrqEoiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`regs5_mailbox_irq_eoi::R`](R) reader structure"]
impl crate::Readable for Regs5MailboxIrqEoiSpec {}
#[doc = "`write(|w| ..)` method takes [`regs5_mailbox_irq_eoi::W`](W) writer structure"]
impl crate::Writable for Regs5MailboxIrqEoiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets REGS5_MAILBOX_IRQ_EOI to value 0"]
impl crate::Resettable for Regs5MailboxIrqEoiSpec {
